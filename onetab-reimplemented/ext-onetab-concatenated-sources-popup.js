...
const Un = "2.14",
  ...
  Wa = "chrome://",
  Na = "chrome://newtab/",
  Ge = "https://www.one-tab.com",
  Ra = !1,
  Za = !1,
  Qa = !0,
  Ja = !1,
  hs = chrome.runtime.getURL("onetab.html"),
  De = chrome.runtime.getURL(""),
  pi = !0;
async function Ka() {
  return pi
...
function Qe(t) {
  return t && t.indexOf(hs) === 0;
}
function Xa(t) {
  return t && t.indexOf(De) === 0;
}
function Wn(t) {
  let e = t.toLowerCase();
...
function Nn(t) {
  ...
  try {
    for (let i in ps) {
      let s = "." + ps[i];
      if (eo(e, s)) {
        for (e = e.substring(0, e.length - s.length); e.indexOf(".") !== -1; )
...
async function _a(t, e) {
  ...
  return await (await Qn(t, i)).json();
}
async function Qn(t, e) {
  let i = {};
  (e ? ((i.method = "POST"), (i.body = e)) : (i.method = "GET"),
    (i.headers = new Headers()),
    i.headers.append("Content-Type", "text/json"));
  let s = await fetch(t, i);
...
async function Pe(t) {
  let i = [...(await Yn(t))]
    ...
    s = "";
  for (let n = 0; n < 22; n++)
    s += mi[parseInt(i.slice(n * 6, (n + 1) * 6), 2)];
  return s;
}
function wi(t) {
...
function ws(t) {
  return t ? to(t).replace(/[\x00-\x09\x0B-\x1F\x7F-\x9F\uFEFF]/g, "") : "";
}
function xi(t, e) {
  return (t && ce(t)) || e;
}
...
function xs(t, e) {
  ...
  let s = i(t),
    n = i(e);
  if (!s || !n) return NaN;
  let o = Math.max(s.length, n.length);
  for (let a = 0; a < o; a++) {
    let r = s[a] ?? 0,
      l = n[a] ?? 0;
    if (r < l) return -1;
...
function el(t, e, i) {
  return so(t, e) && io(t, i);
}
const il = globalThis.getOneTabDefaultSettings();
function no(t, e, i) {
  (t.parentNode && t.remove(),
    e.insertBefore(
      t,
      i === void 0 || i >= e.children.length || e.children.length === 0
        ? null
        : e.children[Math.max(0, i)],
    ));
}
function oo(t, e) {
...
function U(t, e, i) {
  return Je(void 0, t, e, i);
}
const ro = ["style", "children", "child", "init", "destroy", "dataset"];
function Je(t, e, i, s) {
  let n = e === void 0 ? t : document.createElement(e),
    o = {},
    a = {};
  if (i) {
    (i.style && Object.assign(n.style, i.style),
      i.dataset && Object.assign(n.dataset, i.dataset));
    for (let l of Object.keys(i))
      (ro.includes(l) || (n[l] = i[l]),
        (l === "role" || l === "placeholder") && n.setAttribute(l, i[l]));
    if ((i.p && ((i.children ??= []).p = i.p), i.children)) {
      let l = Object.entries(i.children);
      for (const [h, d] of l)
        d instanceof HTMLElement
          ? n.appendChild(d)
          : (n.appendChild(d?.o?.i ?? d.i),
            d.u && (Object.assign(a, d.u), (a[h] = d)));
      for (const [h, d] of l) ((o[h] = d), (a[h] = d));
    }
  }
  e !== void 0 && t && t.appendChild(n);
  let r = { i: n, u: a };
  return (
    i.destroy && (r.destroy = i.destroy),
    Object.assign(r, o),
    s && Object.assign(r, s),
    i?.init && i.init(r),
    r
...
const bs = "about:reader?url=";
function bt(t) {
  if (!t) return "";
  if (t.startsWith("data:text/html") && t.includes('<div id="placeholderUrl">'))
    return t.match(/<div id="placeholderUrl">(.+)<\/div>/)?.[1];
  if (t.indexOf(":") === -1) return bt("https://" + t);
  if (t.indexOf(bs) === 0) return decodeURIComponent(t.substring(bs.length));
  if (t.startsWith(`${De}placeholder.html?`)) {
  ...
  try {
    let e = new URL(t),
      i = e.toString();
    return !e.hash && !e.search && e.pathname === "/" && i.endsWith("/")
...
function ao(t, e, i) {
  return e && ((t || "").toLowerCase().startsWith("file:") || $s(t))
    ? i
      ? `data:text/html, <html><body><div id="placeholderUrl">${Lt(t)}</div></body></html>`
      : `${De}placeholder.html?url=${encodeURIComponent(t)}`
    : t;
}
async function lo() {
  try {
...
const ys = [...new Array(30)].map((t, e) => parseInt(10 + Math.pow(1.6, e)));
function* co(t) {
  let e = 0;
  for (; ys.slice(0, e).reduce((i, s) => i + s, 0) < t; ) yield ys[e++];
}
...
function ee({
  ...
  return c({
    ...
    ...(h && { className: "hideIfInLastSubsection" }),
    style: {
      ...(e && { display: e }),
      marginTop: i,
      marginBottom: s,
...
const ho = new Intl.RelativeTimeFormat(void 0, { ju: "auto" }),
  gs = [
    { Ye: 60, name: "seconds" },
    { Ye: 60, name: "minutes" },
    { Ye: 24, name: "hours" },
...
function ks(t) {
  ...
  for (let i = 0; i < gs.length; i++) {
    const s = gs[i];
    if (Math.abs(e) < s.Ye) return ho.format(Math.round(e), s.name);
    e /= s.Ye;
  }
}
function Ts(t) {
  const e = (t - new Date()) / 1e3;
  return e > -60 && e < 0 ? p("justNow") : ks(e);
}
function fo(t) {
  const e = (t - new Date()) / 1e3;
  return e < 60 && e > 0 ? p("soon") : ks(e);
}
function Ke(t, e) {
  if (typeof t != typeof e) return !1;
  if (Array.isArray(t)) {
    if (!Array.isArray(e) || t.length !== e.length) return !1;
    for (let i = 0; i < t.length; i++) if (!Ke(t[i], e[i])) return !1;
    return !0;
    ...
    for (let n = 0; n < i.length; n++) if (!Ke(t[i[n]], e[i[n]])) return !1;
    return !0;
  } else return t === e;
}
function Is(t) {
  if (Array.isArray(t)) return t.map((e) => Is(e));
  if (typeof t == "object") {
    let e = [...Object.keys(t)].sort();
    return Object.fromEntries(e.map((i) => [i, Is(t[i])]));
  } else return t;
}
function vs(t) {
  t.splice(0, t.length);
...
function po(t, e, i) {
  ...
  let n = t.length,
    o = s < 0 ? Math.max(n + s, 0) : Math.min(s, n);
  if (!i.length) return;
  let a = i.length;
  t.length = n + a;
  let r = Object.prototype.hasOwnProperty;
  for (let l = n - 1; l >= o; l--)
    r.call(t, l) ? (t[l + a] = t[l]) : delete t[l + a];
  for (let l = 0; l < a; l++) t[o + l] = i[l];
}
function mo(t, e) {
...
function ke(t, ...e) {
  ...
  for (let s = t.length - 1; s >= 0; s--)
    i.has(t[s]) ? t.splice(s, 1) : i.add(t[s]);
  for (let s of e) i.has(s) || (i.add(s), t.push(s));
  return t;
}
function ie(t, e) {
  return e.includes(t);
...
function al(t, e) {
  for (let i = t.length - 1; i >= 0; i--) e(t[i]) || t.splice(i, 1);
  return t;
}
function ll(t, e, i) {
  return (i ? ke(t, e) : bi(t, e), t);
}
function cl(t, e) {
  let i = t.findIndex(e);
  if (i === -1) return;
...
function G(t, e) {
  let i, s;
  return (
    arguments.length === 1 ? ((i = t), (s = i !== void 0)) : ((s = t), (i = e)),
    s ? [i] : []
  );
}
function ul(t, e, i) {
  let s = t.findIndex((n) => n === e && !i--);
  return (s !== -1 && t.splice(s, 1), s);
}
function hl(t, e, i) {
  let s = new Map();
  (e ?? []).forEach((o) => {
    o && !s.has(o.id) && s.set(o.id, o);
  });
  let n = (t ?? []).map((o) => s.get(o));
  return i ? n.filter(i) : n;
}
function dl(t, e) {
  let i = new Set(e);
...
function yi(t, e) {
  let i = t.map((s) => (Array.isArray(s) ? yi(s, e) : s));
  return (
    (i = i.filter((s) => !Array.isArray(s) || s.length > 0)),
    i.filter((s) => Array.isArray(s) || e(s))
  );
}
const Le = (t) => (e) => !t(e);
function we(t, e) {
  return t.reduce(
    ([i, s], n, o) => ((e(n, o) ? i : s).push(n), [i, s]),
    [[], []],
  );
}
function fl(t, e) {
...
async function pl(t, e) {
  let i = await Promise.all(t.map((s, n) => e(s, n)));
  return t.reduce(([s, n], o, a) => ((i[a] ? s : n).push(o), [s, n]), [[], []]);
}
async function As(t) {
...
function $s(t) {
  if (!t || t === "") return !0;
  for (let e of wo) if (t.startsWith(e) && !Wo(t)) return !0;
  return !!dr(t);
}
async function xe(t, e) {
  let i = (await v._e("uncommittedChangesStore")) ?? {},
    s = i[t] ?? {};
  return (
    (s.modifyDate = new Date().getTime()),
    (s.uncommittedChanges = { ...(s.uncommittedChanges ?? {}), ...e }),
    (s.uncommittedChanges = Object.fromEntries(
      Object.entries(s.uncommittedChanges).filter(([n, o]) => o !== void 0),
    )),
    (i[t] = s),
    await v.Ve("uncommittedChangesStore", i),
...
async function xo(t) {
  ...
  (t.forEach((s) => {
    ...
    i && (await v.Ve("uncommittedChangesStore", e)));
}
async function gi(t) {
  return (
    ((await v._e("uncommittedChangesStore")) ?? {})?.[t]?.uncommittedChanges ??
    {}
  );
}
async function bl() {
...
async function bo(t) {
  let e = new Date().getTime() - 12096e5,
    i = (await v._e("uncommittedChangesStore")) ?? {};
  ((i = Object.fromEntries(
    Object.entries(i).filter(([s, n]) => n.modifyDate > e),
  )),
    await v.Ve("uncommittedChangesStore", i),
    t && setTimeout(() => bo(), 1e3 * 3600 * 24 * 7));
}
class yo {
  async remove(e) {
...
const gl = (t) => t === void 0,
  ...
  ht = (t) => t.id === "root",
  jt = (t) => t.id === "trash",
  B = (t) => t.groupType === "folder",
  ue = (t) => t.archived,
  Xe = (t) => t.task,
  Il = (t) => B(t) && !jt(t),
  ki = (t) => t.groupType === "quickList",
  Ti = (t) => B(t) || yt(t),
  at = (t) => t.type === "group",
  dt = (t) => t.groupType === "tabGroup",
  yt = (t) => t.groupType === "window",
  he = (t) => dt(t) || yt(t),
  pt = (t) => t !== "quickList",
  Io = (t) => t.shared && t.shareExpiryDate > +new Date();
function vl(t, e) {
  let i = t.split("PLACEHOLDER");
  return U("span", {
    children: {
      a: U("span", { textContent: i[0] }),
      b: e,
      c: U("span", { textContent: i[1] }),
    },
  });
}
function se(...t) {
  return (e, i) => t.reduce((s, n) => s || n(e, i), 0);
}
function Ii(t) {
  return (e, i) => t(e) - t(i);
}
...
function Ss(t) {
  return (e, i) => t(e).localeCompare(t(i), void 0, { Cu: "base" });
}
function Al(t) {
  return (e, i) => t(e).localeCompare(t(i), void 0, { ju: "true", Cu: "base" });
}
function $l(t, e, i, s) {
  Object.hasOwn(t, i) &&
    (Object.hasOwn(e, i) ? (e[i] = s(t[i], e[i])) : (e[i] = t[i]));
}
function Sl(t, e, i) {
  return t !== void 0 && e !== void 0 ? i(t, e) : (t ?? e);
}
let Ye;
const vi = {},
  Ai = {},
  Ol = (t) => ({
    get(e, i, s) {
      if (i === "then") return e.then?.bind(e);
      let n = t ? `${t}:${i}` : i;
      if (
        ((vi[n] ??= 0),
        vi[n]++,
...
function vo(t, e) {
  let i = new Map();
  return (t.forEach((s) => i.set(e(s), s)), i);
}
function Ml(t, e) {
  let i = new Map();
  return (
...
function Gl(t, e, i) {
  ...
  let s = t.map((n, o) => [n, o]).filter(([n]) => n === e);
  return s.length > i ? s[i][1] : s.pop()[1];
}
class Dl {
  constructor(e, i = []) {
    ((this.key = e), (this.map = {}), this.addAll(i));
  }
  add(e) {
    if (!e[this.key])
...
class Mo {
  async put(e, i) {
    await chrome.storage.session.set({ [e]: i });
  }
  async get(e) {
    return (await chrome.storage.session.get([e]))[e];
  }
  async Lp(e) {
    let i = (await chrome.storage.session.get([e]))[e];
    return (await this.remove(e), i);
  }
  async getAll() {
...
const Do = "undefined-34LKmiHxP3Mu48u8qrDaHf";
function Oi(t, e, i) {
  return Array.isArray(t)
    ? t.map((s) => Oi(s, e, i))
    : typeof t == "object" && t !== null
      ? Object.fromEntries(Object.entries(t).map(([s, n]) => [s, Oi(n, e, i)]))
      : t === e
        ? i
        : t;
}
...
function Cl(t, e) {
  let i = [];
  for (let s = 0; s < t.length; s++)
    (i.push(t[s]), s < t.length - 1 && i.push(e()));
  return i;
}
function Gi(t, e, i) {
  Object.hasOwn(t, e) && i(t[e]);
}
function Eo(t, e) {
  t !== void 0 && e(t);
}
function Hl(t, ...e) {
  ...
  return (
    e.forEach((n) => s.add(n)),
    s.forEach((n) => n && n.trim() && i.push(n.trim())),
    i.join(t) || void 0
  );
}
async function Fo(t) {
...
function Ms({ label: t, oe: e, ei: i, ii: s, No: n = 300 }) {
  if (e?.length) {
    let o = $o({ text: t, ti: e, ei: i, ii: s }),
      a = o.reduce((h, { s: d }) => h + d.length, 0),
      r = Math.max(0, a - n),
      l = o.filter(({ tt: h }) => !h).length;
    for (
      let h = 0;
      h < l &&
      !(r <= 0 || !o.filter(({ s: x, tt: g }) => !g && x.length > 5).length);
      h++
    ) {
      let d = [...o]
          .filter(({ tt: x }) => !x)
          .sort(se(ne(({ s: x }) => x.length))),
        f = d.filter(
          ({ s: x }, g, w) => g === 0 || w[g - 1].s.length === x.length,
        ),
        b = d[f.length],
        y = Math.ceil(r / f.length),
        m = f[0].s.length;
      (b && (y = Math.min(m - b.s.length, y)),
        m - y < 5 && (y = Math.max(0, m - 5)),
        (r -= y * f.length),
        y > 0 &&
          f.forEach((x, g) => {
            x.Ki ??= Math.floor(x.s.length / 2);
            let w = Math.floor(y / 2),
              k = Math.ceil(y / 2);
            ((x.s = x.s.substring(0, x.Ki - w) + x.s.substring(x.Ki + k)),
              (x.Ki = x.Ki - w),
              (x.Hu = !0));
          }));
    }
    return o.flatMap((h) =>
      h.tt
        ...
        : h.Hu
          ? [
              U("span", { textContent: h.s.substring(0, h.Ki) }).i,
              U("span", {
                style: { color: "var(--text-color-extra-weak)" },
                textContent: "…",
              }).i,
              U("span", { textContent: h.s.substring(h.Ki) }).i,
            ]
          : U("span", { textContent: h.s }).i,
    );
  } else {
    let o = document.createElement("span");
    return ((o.textContent = Tn(t, n)), [o]);
  }
}
function Di(t) {
  return gt("tabCount", t);
}
function jo(t) {
  return gt("bookmarkCount", t);
}
function Pi({ label: t, Ro: e, oe: i, ei: s, ii: n, No: o }) {
  e.replaceChildren(...Ms({ label: t, oe: i, ei: s, ii: n, No: o }));
}
function Ee(t, e) {
  return e(t);
}
...
function Co(t, e) {
  if (!t) return t;
  let i = t.indexOf(e);
  return (i !== -1 && (t = t.substring(i + e.length)), t);
}
function oe(t) {
  return Co(t, "://");
}
function _e(t, e) {
  return ((t = oe(t)), (e = oe(e)), t === e);
}
function be(t) {
...
function Gs(t) {
  let e = be(t);
  if (!e) return "";
  let i = e.includes("://") ? e : `https://${e}`,
    s = bt(i);
  return (s.endsWith("/") && (s = s.substring(0, s.length - 1)), oe(s));
}
function Ds(t, e) {
  let i = be(t),
    s = be(e);
  return !i || !s ? !1 : _e(i, s) ? !0 : Gs(i) === Gs(s);
}
function Ho(t) {
  try {
    let e = new URL(bt(t)).hostname.toLowerCase();
    return (
      e === "youtube.com" ||
...
function qo(t, e, i) {
  ...
  return !n || Ds(n, e)
    ? !0
    : Ho(e) && n.toLowerCase() === "youtube"
      ? s.toLowerCase() !== "youtube" && !Ds(s, e)
      : !1;
}
function Te(t) {
  let e = bt(t);
  if (!["javascript:"].some((i) => e.toLowerCase().startsWith(i))) return e;
}
function Uo(t) {
  if (t == null) return "";
  let e = String(t);
...
async function Ps(t) {
  ...
  let s = new Map((await chrome.tabs.query({})).map((o) => [o.url, o.title])),
    n;
  {
    let o = [];
    [...i.querySelectorAll("a")].forEach((r) => {
      let l = r.href,
        h = Te(r.href),
        d = ce(s.get(l) ?? r.textContent);
      (_e(d, h) && (d = oe(d)), h && d && o.push({ url: l, kt: h, title: d }));
    });
    let a = o.reduce((r, l) => ((r[l.kt] ??= []).push(l), r), {});
    n = Object.values(a).map(
      (r) =>
        r.sort(
          se(
            Ii((l) => _e(l.title, l.url)),
            ne((l) => l.title.length),
          ),
        )[0],
    );
  }
  if (n.some((o) => !_e(o.url, o.title))) return [n];
  {
    let o = [
      "address",
      "article",
      ...
      [...m.childNodes].reduce(
        (x, g) =>
          g.nodeType === 3
            ? `${x}${g.textContent}`
            : `${x}${
                o.some((w) => w.toUpperCase() === g.tagName?.toUpperCase())
                  ? `
${a(g)}`
                  : a(g)
              }`,
...
`,
          ...
          .map((x) => ce(x))
          .forEach((x) => {
            if (!x.trim()) m[m.length - 1].length && m.push([]);
            else {
              let g = x.match(l);
              if (g) {
                let w = Te(g.groups.url);
                if (w) {
                  let k = g.groups.title || s.get(g.groups.url) || oe(w),
                    u = { kt: w, title: k };
                  m[m.length - 1].push(u);
                }
              }
        ...
        return m.filter((x) => x.length);
    }
    let d = /^(?![A-Za-z]:[\\/])[a-zA-Z][a-zA-Z0-9+.-]*:(?:\/\/)?\S+$/,
      f = [];
    for (let m = 0; m < h.length; m++) {
      ...
      if (d.test(x)) {
        ...
        k && !d.test(k)
          ? ((w.title = k), g?.Zo.pop())
          : (w.title = s.get(x) || oe(w.kt));
      } else g?.Zo.push(x);
    }
    f.forEach((m) => {
      ((m.Ja = m.Zo.filter((x) => x).join(`
`)),
        m.Ja || delete m.Ja);
    });
    let b = /(?<url>(?![A-Za-z]:[\\/])[a-zA-Z][a-zA-Z0-9+.-]*:(?:\/\/)?\S+)/g,
      y = h
        .flatMap((m) => [...m.matchAll(b)].map((x) => Te(Bo(x.groups.url))))
        .filter((m) => m);
    return (
      (y = [...new Set(y)]),
      y.length > f.length ? [y.map((m) => ({ kt: m, title: oe(m) }))] : [f]
    );
  }
}
function Lt(t) {
...
class Es {
  constructor({ listener: e, Ka: i, Bs: s }) {
    ((this.listener = e), (this.Bs = s), i(e));
  }
  remove() {
    if (!this.listener) {
...
function Bt({ itemId: t, Fe: e, zt: i }) {
  return {
    itemId: t,
    ...(e && { sourceParentId: e }),
    ...(i !== void 0 && { occurrence: i }),
  };
}
class zo {
  constructor(e) {
...
function Wo(t) {
  return t?.startsWith(`${De}placeholder.html?`);
}
function No({ tab: t, Uu: e, excludedDomains: i = [] }) {
  let s = bt(t.url ?? t.pendingUrl);
  return Qe(s) || (t.pinned && !e) || i.includes(ge(s));
}
function zl(t, e = (i) => i) {
  let i = e(t[0]);
  return t.every((s) => e(s) === i);
}
function Wl(t) {
  if (!t) return "";
  const e = {
...
const Fe = [
  ...
  Ql = /^https:\/\/(?:[A-Za-z0-9-]+\.)*one-tab\.com\/page\/.*$/;
function Jl({ Ep: t = 1e3, Fp: e, jp: i, Bp: s }) {
  return e.flatMap((n) => {
    if (i(n).length <= t) return [n];
    const o = [];
    let a = i(n).length;
    for (let r = 0; r < a; r += t)
      o.push(s({ Cp: r, entry: n, Hp: i(n).slice(r, r + t) }));
    return o;
  });
}
function Zo(t) {
...
let Cs = !1;
Cs && globalThis.document && (document.documentElement.dir = "rtl");
function Ko() {
  return Cs || ["ar", "he", "fa", "ps", "ur"].indexOf(Ei()) >= 0
    ? "rtl"
    : "ltr";
}
let Hs = Ko();
...
function gt(t, e) {
  let i = Ei(),
    s = Us[i];
  s || ((s = new Intl.PluralRules(i)), (Us[i] = s));
  const n = s.select(e);
  let o = chrome.i18n.getMessage(`${t}_${n}`);
  o || (o = chrome.i18n.getMessage(`${t}_other`));
  let a = e;
  return (
    typeof e == "number" && (a = Number(e).toLocaleString()),
    o ? o.replace("{COUNT}", a) : ""
  );
}
async function Kl({ h: t, itemId: e, Qo: i }) {
  return (await t.Hn(e, i))
    .slice(1)
    .map((n) => je({ groupId: n.id, h: t, l: n }))
    .join(`  ${st() ? "➝" : "⭠"}  `);
}
function Xo({ groupId: t, h: e, l: i }) {
  t ??= i?.id;
  let s = i || e.v(t);
  return [ji({ h: e, l: s }), Fi({ h: e, l: s })];
}
function je({ groupId: t, h: e, l: i }) {
  t ??= i?.id;
  let s = i || e.v(t);
  return ji({ h: e, l: s }) || Fi({ h: e, l: s });
}
function Fi({ groupId: t, h: e, l: i }) {
  t ??= i?.id;
  let s = i || e.v(t);
  if (ht(s)) return p("all");
  if (jt(s)) return p("trash");
  if (B(s)) return p("untitled");
  {
    let n = e.Xi(s.id);
    return Di(n);
  }
}
function ji({ groupId: t, h: e, l: i }) {
  t ??= i?.id;
  let s = i || e.v(t);
  return ht(s) ? p("all") : jt(s) ? p("trash") : s.label;
}
let Bi = {};
function Yo({ type: t, zu: e, Xa: i, Wu: s }) {
  s
    ? (delete Bi[t], i())
    : Bi[t] ||
      ((Bi[t] = !0),
      setTimeout(() => Yo({ type: t, zu: e, Xa: i, Wu: !0 }), e));
}
function _o() {
  return Vo();
}
function Vo() {
  ...
  if (t) {
    const i = t.find((s) => /Chrom(e|ium)/i.test(s.brand));
    return i ? Number(i.version) === 145 : !1;
  }
...
async function Xl(t) {
  ...
  if (!e.length) return;
  e.sort((a, r) => a.index - r.index);
  const i = e[0].windowId,
    s = e[0].index;
  let n = (await chrome.tabs.query({ windowId: i, active: !0 }))[0],
    o;
  try {
    (await chrome.tabGroups.update(t, { collapsed: !0 }),
      ...
      await chrome.tabs.group({ groupId: t, tabIds: o.id }),
...
function tr(t) {
  if (t.startsWith("data:")) {
    let u = t.indexOf("/");
    return u ? t.substring(0, u + 1) : "data:";
  }
  const e = String(t);
  let i = e,
    s = "",
    n = "";
  const o = i.indexOf("#");
  o !== -1 && ((n = i.slice(o)), (i = i.slice(0, o)));
  const a = i.indexOf("?");
  a !== -1 && ((s = i.slice(a + 1)), (i = i.slice(0, a)));
  let r;
  try {
    r = new URL(e);
  } catch {
  ...
  if (!s) return i + n;
  const b = s.split("&").filter((u) => u.length > 0),
    y = [];
  for (const u of b) {
    const T = u.indexOf("="),
      I = T === -1 ? u : u.slice(0, T),
    ...
    if (w(r, S) || f.has(S)) continue;
    (h.has(S) || !k(j, S, d)) && y.push(u);
  }
  return y.length ? i + "?" + y.join("&") + n : i + n;
  function x(u) {
    if (u == null) return "";
    const T = String(u).replace(/\+/g, " ");
    try {
  ...
  function g(u) {
    if (!u) return null;
    const T = (u.hostname || "").toLowerCase(),
      I = (u.pathname || "").toLowerCase();
    return /(^|\.)google\./.test(T) &&
      I.startsWith("/search") &&
      T !== "scholar.google.com"
      ? new Set(["q", "tbm", "start", "hl"])
      : T === "scholar.google.com" && I.startsWith("/scholar")
        ? new Set(["q", "hl", "as_sdt"])
        : T === "www.bing.com" && I.startsWith("/search")
          ? new Set(["q", "first"])
          : /(^|\.)yandex\./.test(T) && I.includes("/search")
            ? new Set(["text", "lr", "win"])
            : T === "search.yahoo.com" && I.startsWith("/search")
              ? new Set(["p"])
              : null;
  }
  function w(u, T) {
    if (!u) return !1;
    const I = (u.hostname || "").toLowerCase();
    return !!(T === "spm" && (I === "sohu.com" || I.endsWith(".sohu.com")));
  }
  function k(u, T, I) {
    if (u.length <= 12 || /[^\x00-\x7F]/.test(u) || /^\d+$/.test(u)) return !1;
    const $ =
        /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(
          u,
        ),
      S = /^[0-9a-f]{16,}$/i.test(u),
      j = /^[A-Za-z0-9+/]{24,}={0,2}$/.test(u),
      K = /^[A-Za-z0-9\-_]{24,}={0,2}$/.test(u),
      F =
    ...
    if (
      ...
      K ||
      F ||
      (/[A-Za-z0-9+/_\-]{24,}={0,2}/.test(u) && I.has(T))
    )
      return !0;
    if (/^[A-Za-z0-9._\-]+$/.test(u) && !/\s/.test(u) && u.length >= 20) {
      const D = u.match(/[A-Za-z]/g) || [],
        W = u.match(/[AEIOUYaeiouy]/g) || [],
        L = D.length ? W.length / D.length : 0;
      let C = 0;
      for (let J = 1; J < u.length; J++)
        (/[A-Z]/.test(u[J - 1]) && /[a-z]/.test(u[J]) && C++,
          /[a-z]/.test(u[J - 1]) && /[A-Z]/.test(u[J]) && C++);
      const ot = u.split(/[-_.]/).filter((J) => J.length > 0),
        lt = ot.length >= 6 && ot.every((J) => J.length <= 12),
        X = ot.some((J) => /[A-Za-z]{3,}/.test(J));
      if (
        (L < 0.25 && C >= 3 && !lt && !X) ||
        (I.has(T) && L < 0.35 && !lt && !X)
      )
    ...
    return (
      /\s/.test(u) ||
        (/[-_.]/.test(u) &&
          u.split(/[-_.]/).some((D) => /[A-Za-z]{3,}/.test(D))),
      !1
    );
  }
}
...
class Ht {
  ...
  Xt(e) {
    ...
    ((this.m ?? []).forEach((o) => o.remove()), (this.m = s));
    let n = i.i;
  ...
  return {
    o: U(t, {
      ...
      init: (k) => {
        ...
        (x.push(
          nt(k.i, "click", async (T) => {
            await u(T);
          }),
        ),
          x.push(
            nt(k.i, "keydown", async (T) => {
              T.key === "Enter" &&
                document.querySelector(":focus-visible") === k.i &&
                (T.stopPropagation(), await u(T));
            }),
          ));
      },
      tabIndex: a,
      children: {
        ...(l
          ? Ee(i.split("ONETAB"), (k) => ({
              ...
              b: et(
                ...
                (u) => `images/onetab-button-logo-${u ? "light" : "dark"}.png`,
              ),
              ...(k[1] !== "" && { c: qi(k[1]) }),
            }))
          : {
        ...
        ...(d && {
          Tm: c({
            init: (k) => {
              (x.push(
                nt(k.i, "click", async (u) => {
                  (u.stopPropagation(), b());
                }),
              ),
                x.push(
                  nt(k.i, "keydown", async (u) => {
                    u.key === "Enter" &&
                      document.querySelector(":focus-visible") === k.i &&
                      (u.stopPropagation(), b());
                  }),
    ...
    ((this.value = i),
      ...
      (this.o = c({
        ...
        onclick: (h) => {
          a?.()
            ? r?.()
            : (this.et(!this.value), this.onChange?.(this.value, ae(h)));
        },
        style: {
          zIndex: 0,
          position: "relative",
...
class Ut {
  constructor({
    ...
    ((this.value = e),
      ...
      (this.o = c({
        ...
        init: ({ i: f }) => {
          (n && (this.m ??= []).push(...te(f, { Yt: n })),
            (this.m ??= []).push(
              nt(f, "click", async (b) => {
                let y = !this.value;
                (!h || !(await h(y))) && this.et(!this.value);
              }),
            ),
            (this.m ??= []).push(
              ze(f, (b) => {
          ...
          icon: et(
            {
              ...
              dimension: l,
              style: { fontSize: o, minWidth: l },
            },
            (f) => `images/tick${f ? "" : "-dark"}.png`,
          ),
          label: c({
  ...
  Si(e) {
    let i = (a) => `images/${e}${a ? "" : "-dark"}.png`,
      s = i(!0),
      n = i(!1),
      o = this.o.u.icon.firstElementChild;
    ((o.dataset.lightSrc = s),
      (o.dataset.darkSrc = n),
      (o.draggable = !1),
      (o.src = le ? s : n));
  }
...
class Ui {
  constructor({
    ...
    ((this.color = e),
      (this.o = c({
        className: ["colorSwatch", ...G(i, "selectable"), ...G(s, "on")].join(
          " ",
        ),
        style: {
...
function Js({ color: t, dimension: e, $: i = {}, St: s }) {
  return c({
    style: {
...
class Jt {
  constructor({
    ...
    ((this.onclick = i),
      (this.er = o),
      (this.o = c({
        className: ["controlButton", ...G(r, "red")].join(" "),
        style: {
          position: "relative",
          ...(!s && { paddingInlineStart: "10px" }),
          ...(a && { flex: "0 1 auto", whiteSpace: "normal" }),
        },
        onclick: (l) => {
          if ((l.stopPropagation(), l.preventDefault(), o)) this.o.u.Oi.le(!0);
          else return this.onclick(l);
        },
        children: {
          ...(o && { Oi: new Ni({ oi: !1, Vi: this.er }) }),
          ...(s && {
            icon: Mt.kl({
              ...s,
          ...
          label: c({
            style: {
              fontSize: "11px",
              color: r ? "var(--red-control)" : "var(--blue-control)",
              paddingTop: "4px",
              paddingBottom: "4px",
            },
            textContent: e,
...
class Tr {
  ...
  ir({ sr: e, nr: i, rr: s, ar: n, Sm: o, lr: a, cr: r, ur: l }) {
    let h = [];
    return (
      Ys && !e.style.touchAction && (e.style.touchAction = "none"),
      h.push(
        nt(e, "pointerdown", (d) => {
          (d.stopPropagation(),
            vr(d) &&
              ...
              (d.shiftKey ||
                ...
                Mn({
                  ...
                  Al: ({
                    ...
                    !this.F ||
                      !this.ve ||
                      ((this.ve.style.left = `${x + y + (st() ? -20 : 20 - this.ve.offsetWidth)}px`),
                      (this.ve.style.top = `${g + -20 + m}px`));
                  },
                  xh: async () => {
                    if (this.P.vl) {
                    ...
                    this.F ? ((this.F = !1), this.ve?.remove(), a()) : o?.();
                  },
                }))));
        }),
      ),
  ...
  hr({ Ae: e, i, dr: s, pr: n, mr: o, wr: a }) {
    let r = [],
      l = (d) => {
        let f = E.P.Mi === e;
        return (
          f && (delete E.P.Mi, delete E.P.ss),
          Q.currentTarget === d && delete Q.currentTarget,
          f
        );
      },
      h = (d) => (i.isConnected ? !1 : (l(d), !0));
    return (
      ["dragover", "pointermove"].forEach((d) =>
        r.push(
          nt(i, d, (f) => {
            if (h(f.currentTarget) || (f.type === "pointermove" && !E.F))
              return;
            if (E.F && E.P.$l) {
              l(f.currentTarget) && o(f);
              return;
            }
            if (Ks.has(f)) return;
            let b = E.P.Mi,
            ...
            (Ks.add(f),
              (E.P.Mi = e),
              (E.P.ss = f.currentTarget),
              f.type === "dragover" && f.preventDefault(),
              f.dataTransfer && (f.dataTransfer.dropEffect = "move"),
              n(f));
          }),
        ),
      ),
          ...
          nt(i, d, async (f) => {
            ...
            if (
              ...
              ((E.P.Mi = e),
                (E.P.ss = f.currentTarget),
                n(f),
                f.type === "drop" && (f.preventDefault(), f.stopPropagation()),
                Xs.add(f),
                (E.P.Rn = !0));
              try {
                await a(f);
  ...
  setDragImage(e) {
    let i = An.find((s) => s.name === e);
    (this.ve?.remove(),
      (this.ve = Je(document.body, "div", {
        style: {
          pointerEvents: "none",
          zIndex: "100000",
          position: "absolute",
  ...
  constructor({
    ...
    ((this.ce = i),
      ...
      s &&
        ...
        (async () => {
          let u = await s();
          (this.ce.i.replaceWith(u.i), (this.ce = u));
        })()),
      (this.o = c({
        style: {
          display: "flex",
        ...
        children: {
          ...
          body: c({
            onclick: (u) => {
              (u.stopPropagation(), this.Ah && this.Jn(!1), this.Jn(!0));
            },
            className: "dropdown",
            style: {
              position: "relative",
            ...
            children: {
              ...
              lh: et(
                ...
                (u) => `images/tree-twistie-closed-${u ? "light" : "dark"}.png`,
              ),
            },
          }),
          Oi: new Ni({
            ...
            yl: et(
              {
                ...
                init: (u) => {
                  (this.m ??= []).push(...te(u.i, { Yt: w }));
                },
              },
              (u) => `images/help-circle${u ? "" : "-dark"}.png`,
            ),
          }),
        },
      })),
...
class tn {
  constructor({ children: e, Ws: i, ns: s, Kn: n, Xn: o }) {
    ((this.children = e),
      (this.Ws = i),
      (this.ns = s),
      (this.Kn = n),
      (this.Xn = o),
      this.children.forEach((a) => a.Ns(this)));
  }
  $h() {
    this._t ||
      ((this._t = !0),
...
class Ae {
  constructor({
    ...
    ((this.value = wi(e)),
      ...
      (this.o = c({
        ...
        p: U("span", {
          className: ["editInPlaceLabelSpan", ...G(o)].join(" "),
        }),
      })),
      (this.i = this.o.i),
  ...
  Ns(e) {
    ((this.group = e), ke(this.group.children, this));
  }
  Yn() {
    this._t &&
  ...
  Rs(e) {
    ...
    this._t ||
      ...
      (this.W.oninput = (i) => {
        ...
        let s = this.value;
        return (
          (s.length === 0 || (s.length > 0 && _n(s.charAt(s.length - 1)))) &&
            (s = s + " "),
  ...
  et(e) {
    ((this.value = wi(this.cs ? ws(e) : ms(e))),
      this.value
  ...
  us(e, i, s) {
    this.value &&
      Pi({ label: this.value, Ro: this.o.p.i, oe: e, ei: i, ii: s });
  }
  destroy() {
    ((this.o.i.onclick = null),
      (this._n = null),
...
class en {
  ...
  update() {
    let e = ({ Tr: i, Fm: s, onclick: n, D: o, Ph: a, Lh: r = 15 }) =>
      et(
        {
          className: "flag " + s + (a ? " no-hover" : ""),
          width: `${r}px`,
          height: `${r}px`,
          style: { marginBlock: "-2px -6px" },
          init: (l) => {
            ((l.i.onclick = n),
              o && (this.m ??= []).push(...te(l.i, { Yt: o })));
          },
        },
    ...
    if (
      (this.view.pinned &&
        ...
        ((this.hs = e({
          ...
          Tr: "pin",
          ...(!this.view.H && {
            D: _(this.view.l) ? p("tabPinFlagHelp") : p("nonTabPinFlagHelp"),
          }),
          onclick: async (i) => {
            ...
            (_(this.view.l)
              ? ((s = this.view.wt.l.id),
                (n = this.view.wt.k
                  .filter((o) => o.l.id === this.view.l.id)
                  .findIndex((o) => o === this.view)))
              : (s = this.view.l.parentIds.find(pt)),
              await v.Ir({
      ...
      this.view.l.task &&
        ...
        ((this.ri = e({
          ...
          D: this.view.l.done
            ? p("completedTaskFlagHelp")
            : p("pendingTaskFlagHelp"),
          onclick: async (i) =>
            re.call(this.view, { task: 1, done: +!this.view.l.done }),
        })),
        this.ai ? this.ai.before(this.ri) : this.o.i.appendChild(this.ri)),
      this.view.l.task)
    ) {
      let i = (a) =>
          `images/${this.view.l.done ? "task-ticked" : "task-unticked"}${a ? "" : "-dark"}.png`,
        s = i(!0),
        n = i(!1),
        o = this.ri.firstElementChild;
      ((o.dataset.lightSrc = s),
        (o.dataset.darkSrc = n),
        (o.draggable = !1),
        (o.src = le ? s : n));
    ...
    (this.view.l.rating &&
      ...
      ((this.ai = e({
        ...
        Lh: 16,
        D: p("starFlagHelp"),
        onclick: async (i) => re.call(this.view, { rating: 0 }),
      })),
      this.o.i.appendChild(this.ai)),
      this.view.pinned || (this.hs?.remove(), It?.destroy(), delete this.hs),
      this.view.l.task || (this.ri?.remove(), It?.destroy(), delete this.ri),
      this.view.l.rating || (this.ai?.remove(), It?.destroy(), delete this.ai),
...
class Ar {
        ...
        Cm: c({
          ...
          children: {
            ...
            gt: new Vs({
              ...
              qm: document.body,
              gh: async () => this.El(await yn(this.ds.id), this.ds),
              Zn: async () => {
                await this.Fl();
              },
            }),
            jh: new Ut({
              ...
              value: b,
              fontSize: "12px",
              label: p("createGroupInsideDestination"),
              D: p("createGroupInsideDestinationHelp"),
                  ...
                  w.map(($, S) => [
                    ...
                    c({
                      style: {
                        ...
                        cursor: "pointer",
                        whiteSpace: $.label?.length > 50 ? "wrap" : "normal",
                      },
                      ...
                      init: (j) =>
                        te(j.i, {
                          Yt: async () => {
                            ...
                            return c({ style: { padding: "5px 15px" }, p: K });
                          },
                        }),
                    }),
                  ]),
  ...
  async Fl({ _s: e } = {}) {
    await si({
      ...
      yt: this.yt,
      io: async (i) => {
        (this.o.u.gt.Jn(!1), await this.Ns(await kt(i.id), !0));
      },
      _s: e,
    });
  }
  async Ns(e, i) {
    ((this.ds = e),
      this.o.u.gt.yh(this.El(await yn(this.ds.id), this.ds)),
      ...
      children: {
        ...
        label: c({
          ...
          children: {
            ...
            zm: U("span", { textContent: je({ h: e, l: i }) }),
          },
        }),
      },
    });
...
class $r {
  ...
  async Lt({
    ...
    let y = new Zr({
      ...
      yt: s,
      Ar: async (m, x) => {
        m && (await n?.(await f.ht(x)));
      },
      Z: o,
      B: r || d[`${i}GroupChooserShowFoldersOnly`] === "true",
      Ot: Bs(d[`${i}GroupChooserShowNamedOnly`], "true"),
      xt: l,
    });
    (await y.st(),
      (this.o = U("div", {
            ...
            children: {
              ...
              Nm: c({
                ...
                children: {
                  ...(!r && {
                    B: new Ut({
                      value: d[`${i}GroupChooserShowFoldersOnly`] === "true",
                      fontSize: "12px",
                      label: p("showFoldersOnly"),
                      $: { flex: "0 1 auto" },
                      onChange: async (m) => {
                        ((d[`${i}GroupChooserShowFoldersOnly`] = m
                          ? "true"
                          : "false"),
                          await v.bt(
                            `${i}GroupChooserShowFoldersOnly`,
                          ...
                          this.o.search.oo.Vs(m),
                          await this.o.search.oo.Bl(),
                          this.o.Cl.Hl().ql.Vs(m),
                  ...
                  Ot: new Ut({
                    value: Bs(d[`${i}GroupChooserShowNamedOnly`], "true"),
                    fontSize: "12px",
                    label: p("showNamedOnly"),
                    $: { flex: "0 1 auto" },
                    onChange: async (m) => {
                      ((d[`${i}GroupChooserShowNamedOnly`] = m
                        ? "true"
                        : "false"),
                        await v.bt(
                          `${i}GroupChooserShowNamedOnly`,
          ...
          search: c({
            ...
            children: {
              oo: new Hr({
                ...
                Et: b,
                B: r || d[`${i}GroupChooserShowFoldersOnly`] === "true",
                he: async (m) => await n?.(m),
              }),
            },
          }),
          Cl: new an({
            label: p("recent"),
            isOpen: d[`${i}GroupChooserRecentsOpen`] === "true",
            Ch: async (m) => {
              await v.bt(`${i}GroupChooserRecentsOpen`, m ? "true" : "false");
            },
...
class Et {
  ...
  Ql() {
    return [this.X, ...this.k.flatMap((e) => (e instanceof Et ? e.Ql() : []))];
  }
  Jl() {
    return this.k.map((e) => e.Jl()).flat();
  }
  async getParent() {
    let e = this.l.parentIds.find(pt);
    return await kt(e);
  }
  async qh() {
    return dt(await this.getParent());
  }
  async Uh(e) {
    let i = this.l.parentIds.find(pt),
      s = await kt(i),
      n = this.l.parentIds.filter((a) => a === "quickList");
    if (
      (ke(n, e.id),
      ...
      if (
        ((this.o.u.destination.o.u.gt.ce.label.i.textContent = ht(e)
          ? p("all")
          : e.label || p("untitled")),
        (this.l.parentIds = n),
        this.J)
      ) {
        let a = await xe(this.X, { parentIds: n });
        ((this.Rt = Object.entries(a).length > 0),
  ...
  async st({
      ...
      (this.jt = i));
    {
      let u = await s.ht(e);
      this.l = { ...u };
      let T = await s.ht(u.parentIds.find(pt));
      this.ys = T && B(T) && !this.H;
    }
    if (this.J) {
      this.nn = structuredClone(this.l);
      let u = await gi(this.X),
        T = Object.entries(u),
        I = !1;
      if (T.length) {
        for (let [$, S] of T) $ !== "parentIds" && (this.l[$] = S);
        ((this.Rt = !0), this.It({ de: !0, pe: !1 }));
      }
    }
    let d,
      f = this.l.parentIds.find(pt);
    d = await s.ht(f);
    let b = !this.H && !this.C && d && !dt(d),
      y = await Promise.all(this.l.parentIds.map(async (u) => await s.ht(u))),
      m = y.find((u) => !ki(u)),
      x = B(m ?? {}),
      g = y.find(yt),
      w = this.l.childIds;
    ...
    ((this.o = c({
      ...
      className: [
        "tabGroup",
        ...G(this.l.archived, "archived"),
        ...G(this.l.task && !this.l.done, "task-pending"),
        ...G(this.l.task && this.l.done, "task-done"),
      ].join(" "),
      style: {
        ...
        body: c({
          init: (u) => {
            (this.m ??= []).push(
              nt(u.i, "keydown", (T) => {
                let I;
                (this.o.u.Pr && (I = () => this.o.u.Pr.onclick(T)),
                  this.o.u.Lr && (I = () => this.o.u.Lr.onclick(T)),
                  T.key === "Enter" &&
                    I &&
                    document.querySelector(":focus-visible") === u.i &&
                    (T.stopPropagation(), I()));
              }),
            );
          },
          ...
          className: [
            "tabGroupBody",
            ...G(this.Tt, "centerColFolderHeaderGroup"),
          ].join(" "),
          style: {
          ...
          children: {
            ...
            ...(this.tn && {
              destination: new Ar({
                vr: p("chooseALocation"),
                yt: this.H,
                Li: "destination",
                Ll: (await s.il({ count: 5, B: !1, sl: !0, Ju: !0 })).filter(
                  (u) => u.id !== d.id,
                ),
                Fh: p("recentDestinationsColon"),
                style: {
            ...
            ...(this.H && {
              Rh: c({
                ...
                textContent: p("noTabsMeetCriteriaUseCheckboxes"),
              }),
            }),
            Kl: c({
              style: {
              ...
              children: {
                    ...
                    K: et(
                      {
                        ...
                        style: {
                          ...
                          width: "19px",
                          height: "19px",
                          top: B(this.l) ? "6px" : "11px",
                        },
                        l: {
                          onclick: async (u) => {
                            await Fo(this.o.i);
                            let T = [Bt({ itemId: this.l.id })],
                              I = await v.gs(T);
                            (await v.move({ rt: T, O: "trash" }),
                              await v.Oe(I));
                          },
                        },
                      },
                      (u) => `images/cross2${u ? "" : "-dark"}.png`,
                    ),
                    ...(B(this.l) && {
                      so: c({
                        style: { display: "inline-block" },
                        p: et(
                          {
                            ...
                            style: {
                              ...
                              marginInlineEnd: "4px",
                              position: "relative",
                              top: `${jt(this.l) ? 7 : 8}px`,
                            },
                          },
                          (u) =>
                            `images/${jt(this.l) ? "trash" : "folder"}${u ? "" : "-dark"}.png`,
                        ),
                      }),
                    }),
                    ...(he(this.l) && {
                        ...
                        p: et(
                          {
                            ...
                            init: (u) => {
                              (this.m ??= []).push(
                                ...te(u.i, { Yt: p("lockedGroupUnlockHelp") }),
                              );
                            },
                          },
                          (u) => `images/lock${u ? "" : "-dark"}.png`,
                        ),
                      }),
                    }),
                    $e: new Ae({
                      ...(B(this.l) && jt(this.l) && { gr: !0 }),
                      ...(B(this.l) && { Zs: Fi({ h: s, l: this.l }) }),
                      style: {
                        display: "flex",
                        alignItems: "flex-start",
                        marginInlineEnd: "10px",
                        marginInlineStart: "5px",
                        marginTop: B(this.l) ? "0" : "5px",
                        flex: "1 1 auto",
                      },
                      value: this.l.label,
                ...
                Qm: c({
                  ...
                  children: {
                      ...
                      !jt(this.l) && {
                        Jm: c({
                          style: {
                            ...
                            marginBlockStart: B(this.l) ? "3px" : "8px",
                          },
                          children: {
                            ...(!this.J && {
                              co: c({
                    ...
                    controls: c({
                      style: {
                        marginTop: `${ht(this.l) || jt(this.l) ? 10 : 0}px`,
                        marginInlineEnd: "7px",
                        textAlign: "end",
                      ...
                      children: {
                        ...(this.Tt &&
                          ...
                          ht(this.l) && {
                            Jh: new Jt({
                              label: p("storeAllOpenWindowsHere"),
                              icon: { I: "close", dimension: "12px" },
                              onclick: async (u) => await v.Kh(),
                            }),
                          }),
                        ...(this.Tt &&
                          !ht(this.l) &&
                            ...
                            Xh: new Jt({
                              ...
                              onclick: async (u) => {
                                await navigateToItem({
                                  itemId: this.l.parentIds.find(pt),
                                });
                              },
                            }),
                          }),
                        ...
                        ...(this.C &&
                          !jt(this.l) && {
                            ...
                            Jr: new Jt({
                              ...
                              onclick: async (u, T) => sn(this.l),
                            }),
                          }),
                        ...(this.C &&
                          jt(this.l) && {
                            Vh: new Jt({
                              label: p("deleteAllTrash"),
                              ni: !0,
                              icon: { I: "cross-action", dimension: "10px" },
                              onclick: async () => {
                                (await v.td(),
            ...
            sn: new Ae({
              style: {
                marginTop: B(this.l) ? 0 : "4px",
                marginBottom: "8px",
                marginInlineStart: B(this.l)
                  ? this.Tt
                    ? "44px"
                    : "57px"
                  : "30px",
            ...
            ho: c({
              ...
              init: (u) => {
                (this.m ??= []).push(nt(u.i, "click", (T) => this.Wt(!0, !0)));
              },
            }),
            ...(this.bs && {
              bs: c({
                style: {
                  display: "flex",
                  marginInlineStart: B(this.l) ? "59px" : "32px",
        ...
        ...E.ir({
          ...
          ar: (u) => {
            ((E.ft.types = [
              ...
              ...G(this.ut, "locked"),
              ...G(this.C, "trash"),
              ...G(!this.l.label, "untitled"),
            ]),
              (E.ft.Ae = { itemsMeta: [Bt({ itemId: this.l.id })] }),
              this.o.u.K && (this.o.u.K.style.visibility = "hidden"),
              Vi({ e: u, Kr: "dragged-group", ji: [this.o.i] }));
          },
          lr: () => ui(),
          cr: () => !this.Ft,
        }),
      ...
      (this.Y = this.o.u.sn),
      (this.on = new tn({
        children: [...G(!ht(this.l), this.$e), this.Y],
        Ws: () => {
          (this.qe && (this.o.u.K.style.visibility = "hidden"),
        ...
        ns: async () => {
          ...
          ((this.l.label = this.$e.value),
            ...
            (this.o.u.sn.i.style.display = this.l.notes?.text
              ...
              : "none"));
          let I = {
            ...(u !== this.l.label && { label: this.l.label }),
            ...(!Ke(T, this.l.notes) && { notes: this.l.notes }),
          };
          if (Object.entries(I).length > 0)
            if (this.J) {
              (I.label === "" && (I.label = void 0),
                ["", void 0].includes(I.notes?.text) && (I.notes = void 0));
              let $ = await xe(this.X, I);
              ((this.Rt = Object.entries($).length > 0),
                this.It({ de: this.Rt || this.fe.size > 0, pe: !0 }));
            } else await v.Fi(this.l.id, I);
        },
      })),
      this.ln(),
      (this.fe = new Set()),
      await s.th(w),
      vs(this.k),
      await this.sync({ h: s, ci: n, Se: o }),
      this.A &&
        this.J &&
        (this.m ??= []).push(
          new Es({
            listener: ({ count: u, nt: T }) => this.Yr(),
            Ka: (u) => this.A.lc(u),
            Bs: (u) => this.A.od(u),
          }),
        ),
  ...
  ln() {
    ...
    this.o.u.co.i.textContent = `${s} ${n} - ${Ts(e)}`;
    let o = 10;
    (i > 60 && (o = 15),
      i > 300 && (o = 60),
      i > 3600 && (o = 900),
      ...
      (this.Ue = setTimeout(() => this.ln(), o * 1e3)));
  }
  rc() {
    if (
      ...
      let e = c({
        ...
        children: {
          ...
          label: c({
            ...
            textContent:
              p("sharedExpiresColon") +
              " " +
              fo(new Date(this.l.shareExpiryDate)),
          }),
          cn: new Jt({
            gl: !0,
            label: p("copySharedPageUrl"),
            onclick: async () => {
              let i = await v.ht(this.l.id),
                s = ha(i.shareId);
              (await navigator.clipboard.writeText(s),
                e.u.cn.Xt(p("copiedToClipboard")),
                setTimeout(() => e.u.cn.Xt(p("copySharedPageUrl")), 3e3));
            },
          }),
          _r: new Jt({
            gl: !0,
            label: p("modifySharing"),
  ...
  Yr() {
    ...
    this.A && this.A.count()
      ? this.l.groupType === "tabGroup"
        ? (e = this.k.filter(
            (n) => n instanceof mt && this.A.nt.some((o) => o.At === n.At),
          ).length)
        : (e = this.A.nt.length)
      : (e = this.Xi());
    let i =
        ...
        !this.vt &&
        !this.te &&
        !this.k.map((n) => n instanceof Et).length,
      s = i ? "" : Di(e);
    (this.$e.Dl(s),
      Eo(this.o.u.Rh, (n) => {
  ...
  Xi() {
    return this.k
      .map((e) => (e instanceof mt ? 1 : e.Xi()))
      .reduce((e, i) => e + i, 0);
  }
  async ad(e) {
    let i = this.k.filter((s) => s.l.id === e.l.id).findIndex((s) => s === e);
    (await v.move({
      rt: [Bt({ itemId: e.l.id, Fe: this.l.id, zt: i })],
      O: "trash",
    }),
  ...
  async ld({ ud: e, Xm: i = !1, hd: s = [] }) {
    ...
    let n = [],
      ...
      d = new Map(),
      f = new Map(),
      b = (u) => (f.has(u) || f.set(u, u.fo(s)), f.get(u)),
      y = b(this),
      m =
        !e && (y.length || this.k.some((u) => u instanceof Et && b(u).length)),
      x = 0,
      g = this.k.flatMap((u, T) => {
        if (u instanceof mt) {
          let I = G(u.isSelected() && !h.has(u.l.id), u);
          return (yt(this.l) && I && T < this.l.pinnedCount && x++, I);
        } else if (u instanceof Et) {
          let I = b(u);
          return i ? I : G(I.length, u);
        } else throw new Error("childView instance type unrecognized");
      });
    ((a = g.map((u) => u.l.id)),
      (r = g.map((u) => ({ itemId: u.l.id, At: u.At }))),
      m &&
        n.push({
          ...this.l,
          childIds: a,
          ...(yt(this.l) && {
            pinnedCount: (await Promise.all(y.map((u) => u.At).map(fr))).filter(
              (u) => u?.pinned,
            ).length,
          }),
        }));
    let w = (u, T, I) => {
      let $ = d.get(u.l.id);
      ($ || (($ = { ...u.l }), o.push($), d.set($.id, $)),
        ($.parentIds = ke($.parentIds.filter(To(T)), I)));
    };
    for (let u of this.k) {
      let T = u instanceof Et ? b(u) : void 0;
      if (u instanceof Et && T.length) {
        if (!i) {
          let I = {
            ...u.l,
            ...
            ...(e && {
              parentIds: ke(
                u.l.parentIds.filter((S) => S === "quickList"),
                e,
              ),
            }),
          };
          n.push(I);
          let $ = { Qt: I, dd: T.map((S) => ({ itemId: S.l.id, At: S.At })) };
          (($.di = (await chrome.tabs.get($.dd[0].At))?.groupId), l.push($));
        }
        T.forEach((I) => {
          w(I, u.l.id, i ? (e ?? this.l.id) : u.l.id);
        });
      } else
        u instanceof mt &&
          u.isSelected() &&
          !h.has(u.l.id) &&
          w(u, this.l.id, e ?? this.l.id);
    }
    let k = new Set(["quickList", ...n.map((u) => u.id), ...G(e)]);
    return (
      o.forEach((u) => (u.parentIds = u.parentIds.filter((T) => k.has(T)))),
      o.forEach((u) => delete u.pinned),
      { fd: n, pd: o, md: a, wd: x, xd: r, bd: l }
    );
  }
  yd(e = []) {
  ...
  uc() {
    return (
      this.k.some((e) => e instanceof mt && e.Gt()) ||
      this.Vr().some((e) => e.uc())
    );
  }
  fo(e = []) {
    ...
    return this.k.filter(
      (s) => s instanceof mt && s.isSelected() && !i.has(s.l.id),
    );
  }
  Vr() {
    return this.k.filter((e) => e instanceof Et);
  }
  gd() {
    return this.k.filter((e) => e instanceof mt);
  }
  po(e = []) {
    return [
      ...this.fo(e).map((i) => i.At),
      ...this.k.filter((i) => i instanceof Et).flatMap((i) => i.po(e)),
    ];
  }
  hc() {
  ...
  async Ge(e) {
    if (!this.j) {
      if (
        (qt(e.targetParentGroupTypeUpdated, (i) => this.ze(i)),
        qt(
        ...
        if (
          (At(e, "label", (i) => this.mo(i)),
          At(e, "notes", (i) => this.wo(i)),
          At(e, "rating", (i) => this.fi(i)),
          At(e, "archived", (i) => this.Bi(i)),
          At(e, "color", (i) => this.setColor(i)),
          At(e, "collapsed", (i) => this.Td(i)),
          At(e, "openType", (i) => this.Id(i)),
          At(e, "groupType", (i) => this.ze(i)),
          At(e, "locked", (i) => this.vd(i)),
          At(e, "pinnedCount", (i) => (this.l.pinnedCount = i)),
          Fe.some((i) => e.propChanges[i]))
        ) {
          let i = Object.fromEntries(
            Object.entries(e.propChanges)
              .filter(([s, n]) => Fe.includes(s))
              .map(([s, n]) => [s, n.new]),
          );
          this.Ci(i);
        }
        if (js.some((i) => e.propChanges[i])) {
          let i = Object.fromEntries(
            Object.entries(e.propChanges)
              .filter(([s, n]) => js.includes(s))
              .map(([s, n]) => [s, n.new]),
          );
          (Object.assign(this.l, i), this.rc());
        }
      } else if (e.type === "store" && this.l.id === e.targetParentId) {
        let i = await kt(this.l.id);
  ...
  ze(e) {
    if (((this.l.groupType = e), this.dc(), !this.J)) {
      let i = this.k.filter((s) => s instanceof mt);
      (async () => {
        let s = new $t();
        await s.Te({ groupId: this.l.id });
        for (let n = 0; n < i.length; n++) {
          let o = i[n];
          await this.fc({ item: { ...o.l }, view: o, h: s, index: n });
        }
      })();
    }
    this.l.color || this.setColor(Ie);
  }
  mc() {
    let e = this.k.filter((s) => s instanceof mt && !s.tr()).length,
      i = this.k
        .filter((s) => s instanceof Et)
        .map((s) => s.mc())
        .reduce((s, n) => s + n, 0);
    return e + i;
  }
  ...
  async Xl() {
    ...
    let s;
    (i
      ? (s = gt("seeOtherTabsInThisGroup", e))
      : (s = gt("seeTabsInThisGroup", e)),
  ...
  Ad({ item: e, ci: i, index: s, di: n }) {
    let o = this.jt && this.jt.has(e.id),
      a;
    return (
      _(e)
        ? (a = new mt({
            ...
            Nt: ({ e: r, qi: l }) =>
              this.Nt({
                ...
                qi: l,
                dn: this,
                tabIndex: this.k.filter((h) => h instanceof mt).indexOf(l),
              }),
            ...(this.ps && { fn: async (r) => await this.ad(a) }),
            At: i?.[s],
            A: this.A,
            xo: this.li,
            It: ({ de: r, pe: l, X: h, Ui: d }) => {
              (r ? this.fe.add(e.id) : this.fe.delete(e.id),
                this.It({
                  de: this.Rt || this.fe.size > 0,
                  pe: l,
                  X: h,
            ...
            We: async (r, l) => {
              let h = this.k
                  .filter((f) => f.l.id === a.l.id)
                  .findIndex((f) => f === a),
                d = [Bt({ itemId: a.l.id, Fe: this.l.id, zt: h })];
              await si({
                title: p("chooseLocationToRestoreTo"),
                He: B(a.l),
                io: async (f) => {
                  await li({ rt: d, O: f.id });
                },
              });
            },
            Ne: async () => {
              let r = this.k
                  .filter((h) => h.l.id === a.l.id)
                  .findIndex((h) => h === a),
                l = [Bt({ itemId: a.l.id, Fe: this.l.id, zt: r })];
              await v._h({ rt: l });
            },
          }))
        : at(e) &&
          (a = new Et({
            ...
            H: this.H,
            vt: this.vt,
            dt: this.jt && (o || e.childIds.some((r) => this.jt.has(r))),
            Ft: this.Ft,
            Nt: ({ e: r, qi: l, dn: h }) =>
              this.Nt({
                e: r,
                qi: l,
                dn: h,
                tabIndex: a.k.filter((d) => d instanceof mt).indexOf(l),
              }),
            Vt: this.Vt && !this.C,
            qe: this.qe && !this.C,
            ps: this.ps && !this.C,
  ...
  async fc({ item: e, view: i, h: s, index: n, ci: o, Se: a }) {
    _(e)
      ? (await i.st({
          ut: this.ut,
          ta: e,
          ...
          xe: this.l.id,
          wt: this,
          ys: yt(this.l) && this.Rl,
          h: s,
        }),
        i.A && a?.has(i.At) && i.lt(!0))
      : at(e) &&
        (await i.st({
          ut: this.ut,
          C: this.C,
  ...
  async sync({ h: e, ci: i, Se: s, Hi: n } = {}) {
    if (!this.j) {
      if (((e ??= new $t()), !B(this.l))) {
        let o;
        i?.length && (o = (await chrome.tabs.get(i.flat()[0])).groupId);
        let a = await e.ht(this.l.id);
        ((this.l.parentIds = a.parentIds), (this.l.childIds = a.childIds));
        let r = a.pinnedCount ?? 0;
        ((this.l.pinnedCount = r),
          await Ki({
            Hi: n,
            ...
            sa: async (l, h) => {
              let d = await e.ht(l);
              if (!d) return;
              let f = this.Ad({ item: d, ci: i, index: h, di: o });
              return (
                await this.fc({
                  item: d,
                  view: f,
  ...
  yc() {
    this.k.filter((e) => e instanceof mt).forEach((e) => e.lt(!0));
  }
  gc(e) {
    let i = !1;
    this.k
      .filter((s) =>
        s instanceof mt ? (s === e && (i = !0), !i || s === e) : !1,
      )
      .forEach((s) => s.lt(!0));
  }
  kc(e) {
  ...
  Tc(e) {
    (this.k
      .filter((i) => i instanceof mt)
      .filter((i) => i !== e)
      .forEach((i) => i.lt(!0)),
      e.lt(!1));
  }
  Ic() {
    this.k.filter((e) => e instanceof mt).forEach((e) => e.lt(!e.Gt()));
  }
  vc() {
    this.A.reset();
  }
  na(e, i) {
    let s = this.k.filter((n) => n instanceof mt);
    if (s.includes(e)) {
      let n = !1,
        o = !1;
      s.forEach((a) => {
  ...
  Ac() {
    return this.k.filter((e) => e instanceof mt && e.Gt()).length;
  }
  ra() {
    return this.gd().length;
  }
  $c(e) {
    return this.k.filter((i) => i instanceof mt)[0] !== e;
  }
  Sc(e) {
    return this.k.filter((i) => i instanceof mt).at(-1) !== e;
  }
  ac() {
    this.Ts ||
      !dt(this.l) ||
      ...
      (this.m ??= []).push(
        ...te(this.Ts.o.i, { Yt: p("tabGroupIndicatorTooltipHelp") }),
      ),
...
async function re(t) {
  if (
    ...
    Gi(t, "archived", (e) => this.Bi(e)),
    Gi(t, "rating", (e) => this.fi?.(e)),
    Gi(t, "task", (e) => {
    ...
    if (Object.hasOwn(t, "pinned")) {
      ...
      (_(this.l)
        ? ((i = this.xe),
          (e = this.wt.k
            .filter((s) => s instanceof mt && this.l.id === s.l?.id)
            .findIndex((s) => s === this)))
        : (i = this.l.parentIds.find(pt)),
        await v.Ir({ itemId: this.l.id, parentId: i, zt: e, value: t.pinned }),
        delete t.pinned);
    }
    (Object.assign(this.l, t),
      Object.keys(t).length && (await v.Fi(this.l.id, t)));
  }
}
function Sr({ Me: t, k: e, ed: i, sd: s, we: n, nd: o, Oc: a = !1 }) {
  let r = [];
  return (
    r.push(
      ...E.hr({
        ...
        dr: (l) => {
          ...
          let h = i();
          if (!h || !s()) return !1;
          let d = E.F ? (E.ft?.types ?? []) : ["tab"];
          return !(
            (E.F && !d.length) ||
            !ss({ Er: d, Fr: n, jr: h, Br: o(), Cr: "groupView" }) ||
            zi(l)
          );
        },
        pr: (l) => {
          Or({ e: l, pn: (h) => h?.o?.i, k: e, Me: t, Oc: a });
        },
        mr: () => {
          Tt.remove();
        },
        wr: async (l) => {
          ...
          let h = i();
          if (h && t.i.contains(Tt))
            try {
              await ts({
                e: l,
                Hr: () => {
                  let d = [...t.i.children],
                    f = d.findIndex((k) => k === Tt);
                  if (f < 0) {
                    let k = e.filter((u) => u?.o?.i?.parentElement === t.i);
                    return k.length ? k.at(-1)?.index + 1 : void 0;
                  }
                  let b = new Map();
                  e.forEach((k) => {
                    let u = k?.o?.i;
                    u && u.parentElement === t.i && !b.has(u) && b.set(u, k);
                  });
                  let y = d
                      .filter((k) => k !== Tt)
                      .map((k) => b.get(k))
                      .filter(Boolean),
                    m = y[f]?.index;
                  (f === y.length && y.length && (m = y[f - 1]?.index + 1),
                    m === void 0 &&
                      f > y.length &&
                      y.length &&
                      (m = y.at(-1)?.index + 1));
                  let x = E.F ? (E.ft?.types ?? []) : [],
                    g = E.F ? (E.ft?.Ae?.itemsMeta ?? []) : [],
                    w =
                      h === "quickList" ||
                      (x.includes("tab") &&
                  ...
                  if (
                    ...
                    let k = Q.ji.reduce((u, T) => {
                      let I = e.find(($) => $?.o?.i === T);
                      return u + (I?.index < m ? 1 : 0);
                    }, 0);
                    k && (m = Math.max(0, m - k));
                  } else if (
                    Number.isFinite(m) &&
                    ...
                    let k = new Set(g.map((u) => u.itemId));
                    if (k.size) {
                      let u = d.reduce((T, I, $) => {
                        if ($ >= f || I === Tt) return T;
                        let S = b.get(I);
                ...
                Ur: () => n,
                Sd: () =>
                  !Q.q && Q.i && Q.ji.length === 1 && Tt.replaceWith(Q.i),
              });
            } finally {
              Tt.remove();
            }
...
function Or({ e: t, pn: e, k: i, Me: s, Oc: n }) {
  if (!s?.i?.isConnected) {
    Tt.remove();
    return;
  }
  let o = Q.Mc ?? 20;
  t.currentTarget !== Q.currentTarget &&
    ((Q.currentTarget = t.currentTarget),
    n
      ? ((Tt.style.border = ""),
        (Tt.style.borderBottom = "var(--drop-area-border)"),
        (Tt.style.borderRadius = ""),
        (Tt.style.height = 0))
      : ((Tt.style.borderBottom = ""),
        (Tt.style.border = "var(--drop-area-border)"),
        (Tt.style.borderRadius = "10px"),
        (Tt.style.height = `${o - 6}px`)));
  let a = new Set(
      i.map((l) => e(l)).filter((l) => l && l.parentElement === s.i),
    ),
    r = null;
  for (let l of s.i.children) {
    if (l === Tt || !a.has(l)) continue;
    let h = l.getBoundingClientRect(),
      d = h.y + h.height / 2;
    if (l.previousSibling === Tt ? t.clientY < d : t.clientY < d - 1) {
      r = l;
      break;
    }
  }
  (r?.parentElement !== s.i && (r = null), s.i.insertBefore(Tt, r));
}
async function sn(t) {
  let e = [Bt({ itemId: t.id })];
  await si({
    title: p("chooseLocationToRestoreTo"),
    He: B(t),
    io: async (i) => {
      await li({ rt: e, O: i.id });
    },
  });
}
class $e {
  constructor(
    ...
    ((this.Gc = d),
      (this.o = U("picture", {
        style: { width: s, height: n, ...o },
        className: `lightDarkPicture${e ? " " + e : ""}`,
        ...a,
        draggable: !1,
        children: { ko: Mr(d(!0), d(!1), s, n) },
        ...(r && {
          onpointerover: (f) => this.Re(!0),
          onpointerout: (f) => this.Re(!1),
        }),
        ...(l && { onclick: l }),
      })),
      h?.(this.o));
...
class nn {
  constructor({
              ...
              if (d.St) d.St(f);
                ...
                if (a) {
                  ...
                  if (r) {
                    ...
                    let m = this.Lc();
                    (await s(m)) === !1 && y.classList.add("on");
                  }
                } else {
                  let y = Object.values(this.Dt).find(({ mi: x, button: g }) =>
    ...
    let h = Object.fromEntries(
      Object.values(this.Dt).map(({ mi: d, button: f }) => [
        d.name,
        c({
          children: {
            Md: c({
...
function Gr({ fontSize: t, label: e, isSelected: i, St: s }) {
  return c({
    className: ["multiple-choice-button", ...G(i, "on")].join(" "),
    style: { fontSize: t },
    textContent: e,
    onclick: (n) => s(n),
  });
  ...
  constructor({ eo: e, iw: i, Ec: s, ...n }) {
    (super({
      ...
      ce: c({
        ...
        textContent: e.find((o) => o.name === i)?.label ?? "",
      }),
      Th: { fontSize: "12px" },
      ...n,
      kh: async () =>
...
class Dr {
  constructor({ heading: e, Dd: i, icon: s, note: n, style: o }) {
    this.o = c({
      style: {
        marginInlineStart: "16px",
        marginBottom: "60px",
          ...
          children: {
            ...(s && {
              icon: new $e(
                ...
                (a) => `images/${s.prefix}${a ? "" : "-dark"}.png`,
              ),
            }),
            text: c({ textContent: e }),
          },
        }),
        ...(i && { Dd: c({ style: { fontSize: "12px" }, textContent: i }) }),
        sw: c({ style: { paddingTop: "16px" } }),
        body: c({}),
        ...(n && {
          note: c({
            style: {
  ...
  Pd(e) {
    (this.o.body.i.replaceWith(e), (this.o.body.i = e));
  }
}
class Pr extends Dr {
  constructor({ To: e, heading: i, options: s, note: n, icon: o, style: a }) {
    (super({ heading: i, icon: o, note: n, style: a }),
      (this.To = e),
      (this.options = s),
      (this.mn = this.options.map((r) => new Lr({ aa: this, mi: r }))),
      this.Pd(
        c({
          style: {
            display: "flex",
  ...
  async Lt() {
    let e = await v.ks(this.To);
    await this.wn(e);
  }
  async wn(e, i) {
    (this.mn.forEach((s) => s.wn(e)), i && (await v.Ve(this.To, e)));
  }
}
class Lr {
  wn(e) {
    ((this.value = e), this.o.u.wi.Re(!1));
  }
  constructor({ aa: e, mi: i }) {
    this.o = c({
      onclick: (s) => {
        (this.wn(i.settingValue), this.o.u.wi.Re(!1), e.wn(i.settingValue, !0));
      },
      onpointerover: (s) => {
        this.o.u.wi.Re(!0);
      },
        ...
        nw: c({
          ...
          children: {
            wi: new $e(
              ...
              (s, n) =>
                `images/option-button-${this.value === i.settingValue ? "on" : n ? "hover" : "off"}${s ? "" : "-dark"}.png`,
            ),
          },
        }),
        ow: c({
          ...
          children: {
            label: c({ style: { fontSize: "14px" }, textContent: i.title }),
            ...(i.xi && {
              xi: c({
                style: {
                  color: "var(--text-color-weak)",
            ...
            ...(i.Fc && { Fc: c({ style: { marginTop: "8px" }, p: i.Fc }) }),
          },
        }),
      },
    });
...
class Mt {
    ...
    ((this.ua = []),
      (this.o = c({
        ...
        style: {
          fontSize: 0,
          position: "absolute",
          zIndex: Ct.Is ? Ct.zIndex + 1 : 1e3,
          borderRadius: s,
        },
        p:
          e ??
          Qi({ style: { marginInline: "4px 14px", marginBlock: "10px 10px" } }),
      })),
      (this.m ??= []).push(nt(this.o.i, "click", (d) => d.stopPropagation())));
    let r = i.getBoundingClientRect();
    ((this.o.i.style.left = "-1000px"),
      (this.o.i.style.top = 0),
      document.body.appendChild(this.o.i));
    let l = this.o.i.offsetWidth,
      h = this.o.i.offsetHeight;
    ((this.o.i.style.left = ""),
      (this.o.i.style.top = ""),
      window.innerWidth - r.x > l
        ? (this.o.i.style.left = `${r.x + r.width / 2}px`)
        : (this.o.i.style.right = `${window.innerWidth - r.x - r.width / 2}px`),
      window.innerHeight - r.y > h
        ? (this.o.i.style.top = `${window.scrollY + r.y + r.height / 2 - 11}px`)
        : (this.o.i.style.top = `${window.scrollY + r.y + r.height / 2 - 11 + (window.innerHeight - r.y - h)}px`),
      (this.m ??= []).push(nt(n, "click", (d) => this.destroy())),
      (this.m ??= []).push(nt(n, "contextmenu", (d) => this.destroy(), !0)),
      (Mt.rn = () => this.destroy()),
      a &&
        this.m.push(
          nt(document, "keydown", (d) => {
            Oe(d) && this.destroy();
          }),
        ),
      o?.(this));
  ...
  static bi({ icon: e, label: i, name: s, action: n, D: o, ni: a }) {
    return c({
      className: ["menuItem", ...G(a, "red")].join(" "),
      style: {
        display: "flex",
        alignItems: "flex-start",
        cursor: "pointer",
          ...
          children: {
            ...
            ...(o && {
              yl: et(
                ...
                (r) => `images/help-circle${r ? "" : "-dark"}.png`,
              ),
            }),
          },
        }),
      ...
      init: (r) => {
        r.i.onclick = async (l) => {
          (l.stopPropagation(), await n({ e: l, o: r }));
        };
      },
    });
  }
  ...
  aw(e) {
    let i = parseInt(this.o.i.style.top),
      s = this.o.i.getBoundingClientRect().top,
      n = e.clientY;
    this.o.i.style.top = `${i + n - s - 30}px`;
  }
}
class Er {
  constructor({ aa: e, label: i, value: s }) {
    ((this.o = c({
      style: {
        display: "flex",
        flexDirection: "row",
      ...
      children: {
        wi: new $e(
          ...
          (n, o) =>
            `images/option-button-${e.value === s ? "on" : o ? "hover" : "off"}${n ? "" : "-dark"}.png`,
        ),
        label: c({ textContent: i }),
      },
      init: (n) => {
        ((n.i.onclick = (o) => (o.stopPropagation(), e.Fd(s), !1)),
          (n.i.onpointerover = (o) => {
            n.u.wi.Re(!0);
          }),
          (n.i.onpointerleave = (o) => {
            n.u.wi.Re(!1);
          }));
      },
    })),
...
class Tc {
  constructor({ onChange: e, lw: i, options: s }) {
    ((this.onChange = e),
      (this.value = i),
      (this.mn = s.map(
        ({ label: n, value: o }) => new Er({ aa: this, label: n, value: o }),
      )),
      (this.o = c({
  ...
  Fd(e) {
    ((this.value = e), this.mn.forEach((i) => i.update()), this.onChange(e));
  }
}
class Fr {
  constructor({ h: e, Et: i, he: s, B: n }) {
    ((this.h = e),
      (this.Et = i),
      (this.he = s),
      (this.B = n),
  ...
  async st() {
    let e = await this.h.il({ count: 30, B: this.B, sl: !1 }),
      i = await xn({
        Et: this.Et,
        groups: e,
        h: this.h,
    ...
    this.o.i.replaceChildren(...i.map((s) => s.i));
  }
  Vs(e) {
    this.B = e;
  }
...
class Ni {
  ...
  le(e) {
    if (e !== this.isVisible) {
      if (e) {
        ...
        (this.onShown?.(this), (Mt.rn = () => this.le(!1)));
      ...
      ((this.isVisible = e),
        ...
        e
          ? ((this.o.i.style.maxWidth = `${this.zs}px`),
            ...
            (this.fa = nt(document, "keydown", (i) => {
              Oe(i) && (this.da(), document.activeElement?.blur());
            })),
            (this.m ??= []).push(this.fa),
            It?.destroy(),
            ...
            (async () => this.jc(await this.Vi((i, s) => this.jc(i, s))))())
          : (this.Io &&
  ...
  jc(e, i) {
    ...
    ((this.o.i.style[this.oi ? "right" : "left"] = 0),
      (this.o.i.style.top = 0));
    let n = i ? i.clientY - 10 - this.o.i.getBoundingClientRect().top : 0;
    i && (this.o.i.style.top = n);
    let o =
      ...
      r =
        ...
        20;
    ((this.Bt = e), (this.Bt.i.style.boxSizing = "border-box"));
    let l = this.Bt.i.style.position,
      h = this.Bt.i.style.left;
    ((this.Bt.i.style.position = "absolute"),
      (this.Bt.i.style.left = "-1000px"),
      document.body.appendChild(this.Bt.i));
    let d = this.Bt.i.offsetWidth + 1,
      f = this.Bt.i.offsetHeight + 1;
    ((this.Bt.i.style.position = l),
      (this.Bt.i.style.left = h),
      (this.Bt.i.style.width = d + "px"));
    let b = 0;
    d > o && (b = o - d);
    let y = 0;
    (f > r && (y = r - f),
...
class jr {
  constructor({ style: e = {} }) {
    ...
    ((i.style.border = "1px solid var(--tree-glyph-color)"),
...
function Br({ style: t }) {
  return c({
    init: (e) =>
      (e.u.Bc.Bd.i.onclick = (i) => {
        ((e.u.Bc.i.style.display = "none"), (e.u.Cd.i.style.display = "block"));
      }),
    style: { ...(t && t), fontSize: "12px" },
    children: {
      Bc: c({
        children: {
          info: U("span", { textContent: p("pasteRichOrPlainTextBelow") }),
          Bd: U("span", {
            textContent: p("seePasteInstructions"),
            style: {
              marginInlineStart: "1ex",
              color: "var(--link-color)",
              cursor: "pointer",
      ...
      Cd: c({
        style: { display: "none" },
        children: [
          c({ textContent: p("canPasteWebContentForExample") }),
          (() => {
            let e = (a, r) =>
                U("a", {
                  textContent: a,
              ...
              i = (a) => (a === "" ? void 0 : U("span", { textContent: a })),
              [s, n, o] = p("exampleRichTextParagraph")
                .split("PLACEHOLDER")
                .map(i);
            return c({
              ...
              children: [
                s,
                e(p("exampleLink"), "https://www.example.com/one"),
                n,
                e(p("secondExampleLink"), "https://www.example.com/two"),
                o,
              ].filter((a) => a),
            });
          })(),
          c({
            ...
            textContent: p("plainTextLineFormat"),
          }),
          c({
            className: "linkImportExample",
            children: [
              c({
                textContent: `https://www.example.com/one | ${p("exampleLinkTitle")}`,
              }),
              c({
                textContent: `https://www.example.com/two | ${p("secondExampleLinkTitle")}`,
              }),
            ],
          }),
          c({
            style: { paddingTop: "8px" },
            textContent: p("alternatePlainTextFormat"),
          }),
          c({
            style: { "unicode-bidi": "plaintext" },
            className: "linkImportExample",
            children: [
              c({ textContent: p("exampleLinkTitleOptional") }),
              c({ textContent: "https://www.example.com/one" }),
              c({ textContent: p("notesAboutTheLinkOptional") }),
              c({ style: { paddingTop: "14px" } }),
              c({ textContent: p("secondExampleLinkTitleOptional") }),
              c({ textContent: "https://www.example.com/two" }),
              c({ textContent: p("notesAboutTheSecondLinkOptional") }),
            ],
          }),
          c({
            style: { paddingTop: "10px", paddingBottom: "14px" },
            textContent: p("canDragTextNote"),
          }),
        ],
      }),
    },
...
class Cr {
  constructor({ Cc: e, cw: i, xn: s, pa: n, ma: o, wa: a }) {
    ((this.Cc = e),
      (this.pa = n),
      (this.ma = o),
      (this.wa = a),
    ...
    ((this.m ??= []).push(nt(this.o.be.Ze.i, "keydown", r, !0)),
      (this.m ??= []).push(
        nt(this.o.be.Ze.i, "input", (l) => {
          this.xn?.({ value: this.$i(), qc: this.o.vs.body.i, Ct: this });
        }),
      ),
      (this.m ??= []).push(
        nt(document, "keydown", (l) => {
          !(this.Cc && Ct.Is) &&
            !l.isComposing &&
            l.key === "/" &&
            !ua(l.target) &&
  ...
  Hd({ query: e }) {
    ((this.active = !0),
      this.vo(!0),
      (this.o.be.Ze.i.value = e),
      this.xn?.({ value: this.$i(), qc: this.o.vs.body.i, Ct: this }),
      setTimeout(() => this.o.be.Ze.i.focus(), 1));
  }
  xa(e) {
    this.o.vs.i.style.display = e ? "block" : "none";
  }
  $i() {
  ...
  vo(e) {
    let i = !1;
    (e && !this.isActive && ((this.isActive = !0), (i = !0)),
      e !== this.highlighted &&
        ((this.highlighted = e),
        (this.o.be.Hc.i.style.pointerEvents = e ? "auto" : "none"),
        gn({
          i: this.o.be.Hc.i,
          duration: 150,
          Uc: e,
...
class Hr {
  ...
  async Bl() {
    if (!(this.j || !this.Ct))
      if (this.ti?.length) {
        let e = this.h.Ku({ ti: this.ti, maxResults: 100, B: this.B });
        if (e.length) {
          let i = await xn({
            Et: this.Et,
            groups: e,
          ...
          this.Ct.o.vs.body.i.replaceChildren(...i.map((s) => s.i));
        } else
          this.Ct.o.vs.body.i.replaceChildren(
            c({ style: {}, textContent: p("noMatchesFound") }).i,
          );
        this.Ct.xa(!0);
      } else this.Ct.xa(!1);
  }
...
class qr {
  constructor({
    ...
    this.o = c({
      className: ["selectable-item", ...G(i, "on")].join(" "),
      style: {
        display: "inline-block",
        textIndent: 0,
        ...(o && { margin: o }),
...
class Ur {
  constructor(e) {
    ((this.id = e), (this.nt = []), (this.bn = []), (this.yn = void 0));
  }
  Wc() {
    return this.id;
  }
  Ao({ newState: e, selection: i, Nc: s }) {
    (e && !s && (this.yn = i),
      e ? ke(this.nt, i) : bi(this.nt, i),
      this.bn.forEach((n) =>
        n({ count: this.nt.length, nt: this.nt, A: this }),
      ));
  }
  reset() {
    (this.nt.forEach((e) => e.Rc?.()),
      vs(this.nt),
      (this.yn = void 0),
      this.bn.forEach((e) =>
        e({ count: this.nt.length, nt: this.nt, A: this }),
      ));
  }
  lc(e) {
    this.bn.push(e);
...
class mt {
  ...
  Ud({ e, $o: i }) {
    if (!i) return !1;
    if (e.detail === 0) return !0;
    let { clientX: s, clientY: n } = e;
    if (typeof s != "number" || typeof n != "number") return !0;
    let o = document.createRange();
    o.selectNodeContents(i);
    let a = Array.from(o.getClientRects()).filter(
      (r) => r.width > 0 && r.height > 0,
    );
    return (
      o.detach?.(),
      a.length || (a = [i.getBoundingClientRect()]),
      a.some((r) => s >= r.left && s <= r.right && n >= r.top && n <= r.bottom)
    );
  }
  Zc({ e, $o: i, zd: s = !1, Wd: n = !1 }) {
    return this.Ud({ e, $o: i })
      ? (s && e.stopPropagation(),
        n && e.preventDefault(),
        this.Nt({ e, qi: this }))
      : (e.preventDefault(), !1);
  ...
  async st({ ta: e, ys: i, pinned: s, xe: n, wt: o, kn: a, h: r, ut: l }) {
    ((this.l = { ...e }),
      (this.ut = l),
      (this.ys = i),
      (this.pinned = s),
      ...
      (this.kn = a));
    let h = ao(bt(this.l.url), this.xo);
    if ((this.Qc(), this.J)) {
      this.nn = structuredClone(this.l);
      let y = await gi(this.X),
        m = Object.entries(y);
      m.length > 0 &&
        (m.forEach(([x, g]) => (this.l[x] = g)),
        (this.Rt = !0),
        this.It({ de: !0, pe: !1, X: this.X, Ui: this.yo }));
    }
    let d, f;
    if (this.gn) {
      let { o: y, Nd: m } = await this.Jc({ h: r });
      ((d = y), (f = m));
    }
    let b = this.o.i;
    ((this.o = c({
        ...
        ((this.m ??= []).push(
          ze(y.i, (m) => {
            !Q.Xr &&
              ...
              this.K &&
                this.it &&
                this.o.tab.i.insertBefore(Ri(), this.o.tab.i.children.item(0)));
          }),
        ),
          (this.m ??= []).push(
            We(y.i, (m) => {
      ...
      children: {
        tab: c({
          className: "tabInner",
          style: { ...(a && { paddingInlineEnd: "19px" }) },
          children: {
            zi: c({
              className: "favIconDiv tabLinkText",
              p: En(this.l.url, this.Ft && !this.ut ? "move" : "default"),
            }),
            ba: U("a", {
              draggable: !1,
              ...(!this.kn && { tabIndex: -1 }),
              ...
              children: {
                So: U("span", {
                  ...
                  textContent: xi(this.l.title, "Untitled"),
                }),
              },
              href: h,
              onclick: (y) =>
          ...
          Wi: U("div", {
            ...
            children: {
              a: U("a", {
                ...
                children: {
                  dw: U("span", {
                    textContent: Ee(Hi(this.l.url), (y) =>
                      Tn(this.Mt === "domain" ? fs(y) : Wn(y), kn),
                    ),
                  }),
                },
              }),
      ...
      b?.parentNode && b.replaceWith(this.o.i),
  ...
  async Jc({ h: e }) {
    let i = "11px;",
      s;
    this.C && (s = p("otherCopiesColon"));
    let n = this.l.id;
    await e.ke();
    let o = await kt(n),
      a = await Promise.all(
        o.parentIds
          .filter((l) => pt(l) && !e.re.has(l))
          .map((l) => {
            let h = e.v(l);
            return {
              parentId: l,
      ...
      r;
    if (!a.length) r = c({});
    else if (a.length === 1) r = c({ p: a[0] });
    else {
      let l = () =>
        U("span", { style: { textAlign: "start" }, textContent: ",   " });
      r = c({
        style: { textAlign: "start", marginInlineEnd: "20px" },
        children: {
          Yd: (() => {
            let [h, d] = gt("placeholderAndOtherLocations", a.length - 1).split(
                "PLACEHOLDER",
              ),
              f = [h, a[0], d].filter((b) => b);
            return (
              (f = f.map((b) =>
                typeof b == "string"
                  ? U("span", {
                      style: { cursor: "pointer" },
                      onclick: (y) => {
                        ((r.u.Yd.i.style.display = "none"),
                          r.u._d.i.replaceWith(
                            U("span", {
                              children: Mi(
                                a.map((m, x) => ({ [`loc_${x}`]: m })),
                                l,
    ...
    return { o: r, Nd: a.length };
  }
  async Vd({ h: e }) {
    let { o: i } = await this.Jc({ h: e });
    this.o.info.location.i.replaceWith(i.i);
  }
  Gt() {
    return this.oa;
  }
  ...
  lt(e, i, s) {
    this.A &&
      ((this.oa = e),
      e && this.Kc(),
      (this.it.firstElementChild.style.opacity = e ? "1" : "0.5"),
      (this.it.style.visibility = e ? "visible" : "hidden"),
      this.Si(e ? "tick" : "tickbox"),
      i ||
  ...
  Wt(e) {
    ((this.dt = e), (this.o.i.style.display = e ? "block" : "none"));
  }
  Jl() {
    return this.l;
  }
  us(e, i, s) {
    (Pi({ label: ce(this.l.title), Ro: this.o.u.So.i, oe: e, ei: i, ii: s }),
      this.Y?.us(e, i, s),
      this.o.u.Wi &&
        Pi({
          label: Hi(this.l.url),
  ...
  async Ge(e, i) {
    if (this.j) return;
    let s = e.itemId;
    if (e.type === "update" && this.l.id === s) {
      if (
        (At(e, "title", (n) => this.setTitle(n)),
        At(e, "notes", (n) => this.wo(n)),
        At(e, "rating", (n) => this.fi(n)),
        At(e, "archived", (n) => this.Bi(n)),
        Fe.some((n) => e.propChanges[n]))
      ) {
        let n = Object.fromEntries(
          Object.entries(e.propChanges)
            .filter(([o, a]) => Fe.includes(o))
            .map(([o, a]) => [o, a.new]),
        );
        this.Ci(n);
      }
      ...
      (e.type === "move" &&
        ie(
          this.l.id,
          e.itemsMeta.map((n) => n.itemId),
        )) ||
      (e.type === "copy" && ie(this.l.id, e.itemIds))
    ) {
      let n = await kt(this.l.id);
      ((this.l.parentIds = n.parentIds), this.gn && (await this.Vd({ h: i })));
    } else if (
      e.type === "store" &&
      ie(
        this.l.id,
        e.tabItems.map((n) => n.id),
      )
    ) {
      let n = await kt(this.l.id);
      n &&
  ...
  setTitle(e) {
    ((this.l.title = e),
      (this.o.u.So.i.textContent = xi(e, p("untitled"))),
      this.Je?.et(e));
  }
  wo(e) {
    ((this.l.notes = e), this.Oo(), this.Y.et(this.l.notes?.text));
    let i = this.l.notes?.text;
    this.Y.i.style.display = i ? "block" : "none";
  }
  un(e) {
    ((this.pinned = e), this.o.u.flags?.update());
  }
  ...
  Ci(e) {
    (Object.entries(e).forEach(([i, s]) => (this.l[i] = s)),
      ["task-pending", "task-done"].forEach((i) =>
        this.o.i.classList.remove(i),
      ),
      this.l.task && !this.l.done && this.o.i.classList.add("task-pending"),
    ...
    (this.Yc(),
      this.Je ||
        ((this.Je = new Ae({
          ...
          ue: this.ue,
          value: ce(this.l.title),
          rs: "tabLinkText",
          Gi: p("title"),
          Qs: (e) => (this.o.u.So.i.textContent = xi(e, p("untitled"))),
        })),
      ...
      !this.ie &&
        ...
        ((this.ie = new Ae({
          style: {
            display: "none",
            marginInlineStart: `${st() ? 49 : 10}px`,
            marginInlineEnd: `${st() ? 10 : 49}px`,
            marginBottom: "5px",
            direction: "ltr",
      ...
      ((this.it = et(
        {
          ...
          init: (e) => {
            ((this.m ??= []).push(
              nt(e.i, "click", (i) => this.lt(!this.Gt(), !1, ae(i))),
            ),
              (this.m ??= []).push(nt(e.i, "contextmenu", (i) => this.ya(i))));
          },
        },
        (e) => `images/tickbox${e ? "" : "-dark"}.png`,
      )),
        ...
        ns: async () => {
          ...
          if (this.hn)
            if (!this.ie.value) this.ie.et(this.l.url);
              ...
              let o = bt(this.ie.value);
              if (o !== this.l.url) {
                ((n = !1), (this.tu = !0));
                let [a] = await v.Xo([
                    { id: await Pe(o), kt: o, oh: [this.xe] },
                  ]),
                  r = a;
                (Object.entries(this.l)
                  .filter(([f]) => !["id", "url", "parentIds"].includes(f))
                  .forEach(([f, b]) => (r[f] = b)),
                  (r.parentIds = [this.xe]));
                let l = this.wt.k
                  .map((f, b) => [f, b])
                  .filter(([f]) => f.l.id === this.l.id)
                  .map(([f, b]) => b);
                await v.In({ vn: [r], O: this.xe, N: this.index, An: [r.id] });
                let h = new $t();
                if (
                  (await h.ke(),
                  !(
                    this.l.parentIds.filter(
                      (f) => pt(f) && !h.re.has(f) && f !== this.xe,
                    ).length || l.length > 1
                  ) && this.l.parentIds.includes("quickList"))
                ) {
                  let b = (await kt("quickList")).childIds.indexOf(this.l.id);
                  await v.eu({ iu: [r.id], O: "quickList", N: b });
                }
                await v.move({ rt: [Ce(this)], O: "delete" });
              }
            }
          if (n) {
            let o = {
              ...(e !== this.l.title && { title: this.l.title }),
              ...(i !== this.l.url && { url: this.l.url }),
              ...(!Ke(s, this.l.notes) && { notes: this.l.notes }),
            };
            if (Object.entries(o).length > 0)
              if (this.J) {
                (o.title === "" && (o.title = void 0),
                  ["", void 0].includes(o.notes?.text) && (o.notes = void 0));
                let a = await xe(this.X, o);
                ((this.Rt = Object.entries(a).length > 0),
                  this.It({ de: this.Rt, pe: !0, X: this.X, Ui: this.yo }));
              } else await v.Fi(this.l.id, o);
          }
        },
      }));
  }
  ...
  Jd(e) {
    let i = (this.A?.nt ?? []).filter((l) => l?.o?.i?.isConnected && l?.l),
      s = [...i];
    if (
      (s.includes(this) || s.push(this),
      new Set(s.map((l) => _i(l.l))).size > 1)
    )
      return (Ct.Is || pe(p("cannotMixTabsGroupsFoldersDuringDrag")), !1);
    E.ft.types = ["tab", ...G(this.C, "trash"), ...G(this.ut, "locked")];
    let o = [this.o.i];
    i.map((l) => l.o.i).forEach((l) => {
      o.includes(l) || o.push(l);
    });
    let a = i.map(Ce);
    (i.includes(this) || a.push(Ce(this)),
      (E.ft.Ae = {
        itemsMeta: a,
      ...
      Ri().remove());
    let r;
    (a.length > 1 && (r = "multi-dragged-tab"),
      E.bh({ title: this.l.title }),
      Vi({ e, Kr: r, ji: o }));
  }
}
function At(t, e, i) {
...
function Ri() {
  return (
    (on ??= c({
      ...
      style: {
        [st() ? "left" : "right"]: "-31px",
        boxShadow: `var(--tick-cross-box-shadow${st() ? "" : "-rtl"})`,
      },
    }).i),
    on
  );
...
function zr(t) {
  return {
    ...
    ...(_(t.l) && {
      Fe: t.xe ?? t.G?.l.id,
      zt: ti(
        t.wt?.k.filter((e) => e.l.id === t.l.id).findIndex((e) => e === t),
      ),
    }),
  };
}
...
class Wr {
  constructor({ Zd: e, As: i, We: s, Ne: n, su: o, Qd: a, Rd: r }) {
    ((this.We = s),
      (this.Ne = n),
      (this.su = o),
      (this.o = c({
        className: [a, "trashControls"].join(" "),
        style: {
          display: "flex",
          alignItems: "center",
          flex: "0 0 auto",
        ...
        children: {
          Qr: new Jt({
            ni: !0,
            label: p(r ? "deleteThisCopy" : "delete"),
            icon: { I: "cross-action", dimension: "10px" },
            onclick: this.Ne,
          }),
          Jr: new Jt({
...
class Nr {
  constructor({ ot: e, tf: i, marginInlineStart: s }) {
    ((this.o = c({
      className: "treeGlyph",
      style: {
        flex: `1 0 ${i}px`,
...
class Ic {
  constructor() {}
  ef({ ye: e, $n: i, Sn: s } = { ye: void 0, $n: void 0, Sn: void 0 }) {
    e !== this.ye &&
...
class cs {
  ...
  async st({ h: e, ka: i, sf: s } = {}) {
    e ??= (await new $t().Te({ groupId: this.itemId })).h;
    let n = e.v(this.itemId);
    this.l = { ...n };
    let o = this.l.id === "trash" ? [] : [this.l.id];
    i ??= await v.pw(`treeItemsOpen:${this.q}`, o);
    let a = i.includes(this.l.id),
      r,
      l;
    if (this.l.type === "tab") r = this.l.title;
    else {
      let [x, g] = Xo({ h: e, l: this.l });
      ((r = x), (l = g));
    }
    let h = _(this.l) ? 1 : e.Xi(this.l.id),
      d = this.Ht && e.ll(this.l.id).cl,
      f = this.Ht ? d : h,
      b = Number(f).toLocaleString();
    this.Ht && !f && (b = "");
    let y = "none";
    (B(this.l) && (y = "folder"),
      jt(this.l) && (y = "trash"),
    ...
    (m && this.De({ pi: !0 }),
      (this.o = c({
        ...
        children: {
          mw: new Nr({ ot: this.ot, tf: this.au }),
          se: c({
                ...
                children: {
                  ...(this.A &&
                    !this.ot && {
                      Pe: new kr({
                        ...
                        onChange: (x, g) => {
                          (this.A.Ao({ newState: x, selection: this, Nc: g }),
                      ...
                      p: et(
                        {
                          ...
                          l: { onclick: (x) => this.setActive(!0, !0) },
                        },
                        (x) => `images/folder${x ? "" : "-dark"}.png`,
                      ),
                    }),
                  }),
                  ...(this.icon === "trash" && {
                  ...
                  Ut: new Ae({
                    ...
                    Qs: async (x) => {
                      ...
                      let g = _(this.l) ? "title" : "label",
                        w = this.l[g];
                      if (((this.l[g] = x), w !== this.l[g])) {
                        let k = { [g]: this.l[g] };
                        await v.Fi(this.itemId, k);
                      }
                    },
                  }),
                  uu: c({
      ...
      (this.m ??= []).push(
        ...E.ir({
          ...
          ar: (x) => {
            ...
            let k = g.map(Ce);
            g.includes(this) || k.push(Ce(this));
            let u = [...g];
            u.includes(this) || u.push(this);
            let T = Rr(u);
            if (new Set(u.map((S) => _i(S.l))).size > 1)
              return (
                Ct.Is || pe(p("cannotMixTabsGroupsFoldersDuringDrag")),
                !1
              );
            ((E.ft.types = T),
              (E.ft.Ae = {
            ...
            let $ = _(this.l)
              ...
              : B(this.l)
                ...
                : "dragged-group";
            (u.length > 1 &&
              (u.every((S) => at(S.l) && !B(S.l))
                ? ($ = "multi-dragged-group")
                : u.every((S) => B(S.l))
                  ? ($ = "multi-dragged-folder")
                  : u.every((S) => _(S.l))
                    ? ($ = "multi-dragged-tab")
                    : ($ = "multi-dragged-item")),
              Vi({ e: x, Kr: $, ji: w, q: this.q }));
          },
          lr: () => {
            (ui(),
              this.qt &&
        ...
        ...E.hr({
          ...
          dr: (x) => {
            let g = this.o.u.body.Ut.i,
              ...
              T = Math.floor(u.height * 0.2);
            const I = (C) => (C ? [C.l.id, ...I(C.G)] : []);
            let $ = I(this.G),
              S = [this.l.id, ...$],
              j = E.F ? (E.ft?.Ae?.itemsMeta ?? []) : [],
              K = E.F ? (E.ft?.types ?? []) : ["tab"];
            if (E.F && (!j.length || !K.length)) return !1;
            let F = !(
                (this.ot && !this.S.length && this.ou) ||
                _(this.l) ||
                j.some((C) => S.includes(C.itemId))
              ),
              P = !(
                j.some((C) => $.includes(C.itemId)) ||
                (K.includes("tab") && this.q !== "quickAccessCol-quickList") ||
                (this.B && me(["window", "tabGroup"], K)) ||
                (this.Ot &&
                  me(["window", "tabGroup"], K) &&
                  K.includes("untitled")) ||
                (this.L.l.id === "trash" && this.l.id !== "trash")
              );
            if (!F && !P) return !1;
            let q = F ? "within" : "before";
            !this.ot &&
              P &&
              (x.clientY <= u.y + Math.max(9, T) && (q = "before"),
              this.isOpen
                ? x.clientY > k.y + k.height - 2 && (q = "after")
                : F
                  ? x.clientY > u.y + u.height - Math.max(9, T) && (q = "after")
                  : x.clientY > u.y + u.height / 2 && (q = "after"));
            let D =
              this.ot &&
            ...
            if (D) {
              let C = this.Ke?.i,
                lt = this.S.map((X) => X?.o?.i)
                  .filter((X) => X?.parentElement === C)
                  .at(-1);
              if (lt) {
                let X = lt.getBoundingClientRect();
                x.clientY > X.bottom - 2 && (q = "after");
              }
            }
            let W = D && q === "after";
            E.P.Le = q;
            let L = q === "within" || W ? this : this.G;
            return !L ||
              !ss({
                Er: K,
                Fr: L.l.groupType,
              ...
              zi(x)
              ? !1
              : L.itemId === "quickList" && !E.F
                ? (delete fe.Le, Pt.remove(), !1)
                : L.q === "quickAccessCol-tasks" && L.itemId === "root"
                  ? (delete fe.Le, Pt.remove(), !1)
                  : !0;
          },
          pr: (x) => {
            let g = E.P.Le,
              ...
              u = this.o.se?.Ia;
            (u && this.ot && !this.S.length && g === "within"
              ? (u.i.appendChild(Pt),
                Object.assign(Pt.style, {
                  top: "3px",
                  bottom: "3px",
          ...
          mr: () => {
            (delete fe.Le, Pt.remove());
          },
          wr: async (x) => {
            if (this.j) return;
            let g = E.P.Le ?? fe.Le;
            if ((delete fe.Le, Pt.remove(), !g)) return;
            let w =
              this.ot &&
              this.q === "quickAccessCol-quickList" &&
              this.itemId === "quickList" &&
              g === "after";
            (g !== "within" && !w && !this.G?.Ke?.i.contains(this.o.i)) ||
              (g === "within" && this.Os(!0),
              await ts({
                e: x,
                Hr: () => {
                  ...
                  if (!u) return;
                  let T = [...u.children],
                    I = w ? T.length : T.findIndex((q) => q === this.o.i);
                  if (I < 0) {
                    let q = k.S.filter((D) => D?.o?.i?.parentElement === u);
                    return q.length ? q.at(-1)?.index + 1 : void 0;
                  }
                  g === "after" && !w && I++;
                  let $ = new Map();
                  k.S.forEach((q) => {
                    let D = q?.o?.i;
                    D && D.parentElement === u && !$.has(D) && $.set(D, q);
                  });
                  let S = T.map((q) => $.get(q)).filter(Boolean),
                    j = S[I]?.index,
                    K = k?.l?.id;
                  (I === S.length && S.length && (j = S[I - 1]?.index + 1),
                    j === void 0 &&
                      I > S.length &&
                      S.length &&
                      (j = S.at(-1)?.index + 1));
                  let F = E.F ? (E.ft?.types ?? []) : [],
                    P = E.F ? (E.ft?.Ae?.itemsMeta ?? []) : [];
                  if (
                    Number.isFinite(j) &&
                    E.F &&
                    K !== "quickList" &&
                    ...
                    let q = new Set(P.map((D) => D.itemId));
                    if (q.size) {
                      let D = T.reduce((W, L, C) => {
                        if (C >= I) return W;
                        let ot = $.get(L);
                        return W + (q.has(ot?.l?.id) ? 1 : 0);
                      }, 0);
                      D && (j = Math.max(0, j - D));
                    }
                  }
                  return (
                    j === void 0 && console.log("Warn: viewIndex not found"),
                    j
                  );
                },
                qr: () => (g === "within" || w ? this.itemId : this.G.l.id),
                Ur: () =>
                  g === "within" || w ? this.l.groupType : this.G.l.groupType,
              }));
          },
        }),
      ),
      ...
      this.fi(this.l.rating),
      (this.S = []),
      at(n) && (await this.sync({ L: this.L, h: e, Hi: !0, ka: i })),
      m && m.replaceWith(this.i),
      this.yi?.ye === this && this.setActive(!0, !1));
  }
  un(e) {
    (e && this.nf(),
      this.gi && (this.gi.i.style.display = e ? "inline-block" : "none"));
  }
  rf() {
    if (!this.Gn) {
      this.Gn = c({
      ...
      let e = this.o.se.body,
        i;
      (e.Pe && (i = e.Pe.o.i),
        e.zi && (i = e.zi.i),
        this.gi && (i = this.gi.i),
        i
          ? i.insertAdjacentElement("afterend", this.Gn.i)
          : e.i.prepend(this.Gn.i));
    }
  }
  nf() {
    if (!this.gi) {
      ...
      (e.Pe && (i = e.Pe.o.i),
        e.zi && (i = e.zi.i),
        i
          ? i.insertAdjacentElement("afterend", this.gi.i)
          : e.i.prepend(this.gi.i));
    }
  }
  Nn() {
    this.o.u.Pe &&
      ...
      (this.o.u.Pe.Nn(),
      (this.m ??= []).push(
        nt(this.o.u.Pe.o.i, "contextmenu", (e) => this.ya(e)),
      ));
  }
  af() {
    this.Ke ||
  ...
  hu() {
    this.ot ? (this.Aa(), this.S.forEach((e) => e.Aa())) : this.G.hu();
  }
  Aa() {
    (this.Dn && this.Dn.destroy(), this.S.forEach((e) => e.Aa()));
  }
  Ta() {
    this.qt ||
      ((this.qt = c({
              ...
              let i = await as({
                ...
                onChange: async (s) => {
                  (Object.hasOwn(s, "isTabGroup") &&
                    ...
                    delete s.isTabGroup),
                    Object.keys(s).length > 0 && (await v.Fi(this.l.id, s)));
                },
                xs: this.G && B(this.G.l),
              });
              this.Dn = new Mt({
                Z: this.Z,
                ca: this.qt.uf.i,
  ...
  setActive(e, i) {
    ...
    (n.Ol(this.isActive && this.Go ? "edit" : "click"),
      ...
      s && i && this.$s(this.isActive, this.itemId),
      this.isActive && this.yi?.ef({ ye: this, $n: this.itemId, Sn: this.q }),
      !s && e && i && this.ru?.());
    let o = this.o.u.body.Ut.i;
    this.Mn && !ra(o, this.Mn) && o.scrollIntoView();
  }
  async df(e, i) {
    if (this.itemId === e) (await this.G?.Os(!0, !0), this.setActive(!0, i));
    else for (let s of this.S) await s.df(e, i);
  }
  async Ge(e, i) {
    if (this.j) return;
    let s = this.S.length;
    if (
      ...
      (At(e, "label", (o) => this.mo(o)),
      At(e, "title", (o) => this.mo(o)),
      At(e, "archived", (o) => this.Bi(o)),
      At(e, "color", (o) => this.setColor(o)),
      At(e, "groupType", (o) => this.ze(o)),
      At(e, "rating", (o) => this.fi(o)),
      At(e, "locked", (o) => (this.l.locked = o)),
      ["task", "done"].some((o) => e.propChanges[o]))
    ) {
      let o = Object.fromEntries(
        Object.entries(e.propChanges)
          .filter(([a, r]) => Fe.includes(a))
          .map(([a, r]) => [a, r.new]),
      );
      this.Ci(o);
    }
    if (
      (qt(
        e.targetParentId === this.itemId && e.targetParentGroupTypeUpdated,
        (o) => this.ze(o),
      ),
      e.type === "move")
    ) {
      let o = e.itemsMeta.find(
        (a) => a.itemId === this.itemId && a.groupTypeUpdated,
      );
      if (o) {
        let a = o.groupTypeUpdated;
        this.ze(a);
      }
    }
    if (
      (((this.Ot &&
        e.type === "update" &&
        me(["label"], Object.keys(e.propChanges)) &&
        e.updatedItemParentIds.includes(this.itemId)) ||
        (this.On &&
          e.type === "update" &&
          me(["archived"], Object.keys(e.propChanges)) &&
          e.updatedItemParentIds.includes(this.itemId)) ||
        (this.Ht &&
          ((ie(e.type, ["store", "move", "copy"]) &&
            e.affectedAncestorIds.includes(this.itemId)) ||
            (e.type === "update" &&
              me(["archived", "task"], Object.keys(e.propChanges)) &&
              e.affectedAncestorIds.includes(this.itemId)))) ||
        (e.type === "sort" && e.parentId === this.itemId) ||
        (e.type === "removeFromQuickList" && this.itemId === "quickList") ||
        (e.type === "copy" && e.targetParentId === this.itemId)) &&
        (await this.sync({ L: this.L })),
      e.type === "move")
    ) {
      let o = e.itemsMeta ?? [],
        a = new Set(o.map((l) => l.sourceParentId)),
        r = new Set(o.map((l) => l.itemId));
      ((this.itemId === "quickList" && e.targetParentId === "trash") ||
        (this.itemId === "trash" &&
          ["trash", "delete"].includes(e.targetParentId)) ||
        a.has(this.itemId) ||
        this.itemId === e.targetParentId ||
        r.has(this.itemId)) &&
        (await this.sync({ L: this.L }));
    }
    if (
      e.type === "store" &&
      ie(this.itemId, ["trash", "quickList", e.targetParentId])
    ) {
      await this.sync({ L: this.L });
      let o = this.S.find((a) => a.itemId === i.$a);
      o && (await this.Os(!0), delete i.$a, o.du());
    }
    e.type === "pin" &&
      e.itemId === this.itemId &&
    ...
    (this.ot &&
      this.Ht &&
      e.type === "update" &&
      me(["archived", "task", "done"], Object.keys(e.propChanges)) &&
      (await oneTabPage.ww.xw(n), await this.fu(n, e.updatedItemParentIds)),
      this.ot &&
        ie(e.type, ["store", "move", "copy", "removeFromQuickList"]) &&
        (await this.fu(n, e.storeMoveCopyAffectedParentIds)),
      !this.j &&
        (this.S.forEach((o) => o.Ge(e, i)),
        s !== this.S.length && this.nu?.(this.S.length)));
  }
  ff(e) {
    if (!e.v(this.itemId)) return;
    let i = e.Xi(this.itemId),
      s = this.Ht && e.ll(this.itemId).cl,
      n = this.Ht ? s : i,
      o = Number(n).toLocaleString();
    (this.Ht && !n && (o = ""),
      B(this.l) || this.o.u.Ut.Dl(Di(i)),
      (this.o.u.uu.i.textContent = o));
  }
  du() {
    this.o.u.Ut.Rs(!0);
  }
  mo(e) {
    ((this.l.label = e), this.o.u.Ut.et(e));
  }
  Bi(e) {
    ((this.l.archived = +e),
      this.o.u.Ut.i.classList[e ? "add" : "remove"]("archived"));
  }
  Ci(e) {
    (Object.entries(e).forEach(([i, s]) => (this.l[i] = s)),
      ["task-pending", "task-done"].forEach((i) =>
        this.o.u.Ut.i.classList.remove(i),
      ),
      this.l.task &&
        !this.l.done &&
  ...
  setColor(e) {
    ((this.l.color = e), this.va(), this.Ms.setColor(e));
  }
  fi(e) {
    ((this.l.rating = e),
      e && this.rf(),
      this.Gn && (this.Gn.i.style.display = e ? "inline-block" : "none"));
  }
  ze(e) {
    ((this.l.groupType = e),
      this.va(),
      this.Ms.Wt(dt(this.l)),
      this.l.color || this.setColor(Ie));
  }
  async sync({ L: e, h: i, Hi: s, ka: n }) {
    if (this.j) return;
    i ||
      ((i = new $t()),
      this.Ht
        ? await i.tl()
        : this.Ss
          ? at(this.l) && (await i.Te({ groupId: this.itemId }))
          : await i.ke());
    let o = i.v(this.itemId);
    if (!o) return;
    if (
      ((this.l = { ...o }),
      this.ze(o.groupType),
      !this.Ss && o.id !== "trash" && B(o))
    ) {
      let r = (o.childIds ?? []).filter((l) => !i.v(l));
      r.length && (await i.getItems(r), (o = i.v(this.itemId) ?? o));
    }
    let a = (o.childIds ?? [])
      .map((r, l) => ({ id: r, index: l }))
      .filter(({ id: r, index: l }) => {
        let h = i.v(r);
        return !(
          !h ||
          (!this.Ss && !at(h)) ||
          (this.Ot && at(h) && !h.label && this.L.$a !== h.id) ||
          (this.B && !B(h)) ||
          (this.On && ue(h)) ||
          (this.Ht && !(Xe(h) || i.Yu(h)))
        );
      });
    (qt(this.o.u.Ia?.i, (r) => (r.style.display = a.length ? "none" : "block")),
      this.af(),
      !this.j &&
        (await Ki({
          Hi: s,
          ...
          pn: (r) => r?.i,
          sa: async (r, l) => {
            let h = this.yi && this.yi.$n === r && this.yi.Sn === this.q,
              d = this.hf(r);
            return (
              await d.st({ h: i, ka: n, sf: l }),
              h && d.setActive(!0, !1),
              d
            );
          },
          bc: (r) => r.un?.(r.index < (this.l.pinnedCount ?? 0)),
        }),
        !this.j &&
          (qt(
            this.o.se.Ia?.i,
            (r) => (r.style.display = this.S.length ? "none" : "block"),
          ),
          this.mf(),
  ...
  async fu(e, i) {
    if (!this.j && this.ot) {
      ...
      const n = (o, a = []) => {
        if (o.j) return;
        let r = [...a, o];
        (s.has(o.itemId) || s.set(o.itemId, r), o.S.forEach((l) => n(l, r)));
      };
      (n(this), await e.ke(), this.Ht && (await e.tl()));
      for (let o of i) s.get(o)?.forEach((r) => r.ff(e));
    }
  }
  va() {
    this.Ms ||
      ((this.Ms = new Ui({
        ...
        St: (e) => this.setActive(!0, !0),
      })),
      oo(this.Ms.o.i, this.o.u.Ut.i));
  }
  mf() {
    (this.ot &&
      !this.Po &&
      ...
      !this.Jt &&
        ...
        ((this.Jt = c({
          ...
          p: et(
            ...
            (e) => `images/tree-twistie-closed-${e ? "light" : "dark"}.png`,
          ),
          onclick: async (e) => {
            await this.Os(!this.isOpen);
          },
        })),
        no(this.Jt.i, this.o.i, 0)));
  }
  async Os(e, i) {
    if (
      (e && i && (await this.G?.Os(!0, !0)),
      this.Jt &&
        ((this.Jt.p.style.transform = e
          ? "rotate(90deg)"
          : `rotate(${st() ? 0 : 180}deg)`),
        (this.Jt.p.style.top = e ? "0px" : "0")),
      this.Ke &&
        (this.Ke.i.style.display = this.S.length && e ? "block" : "none"),
      this.isOpen === e && !i)
    )
      return;
    this.isOpen = e;
    let s = `treeItemsOpen:${this.q}`,
      n = await v._e(s);
    ((n = n.filter((o) => !o.includes(this.itemId))),
  ...
  ya(e) {
    (e.preventDefault(),
      ...
      (this.Tn = new Mt({
        ...
        la: c({
          style: { margin: "8px" },
          children: rn({ view: this, Vc: this.G, Ni: () => this.Tn.destroy() }),
        }),
      })));
  }
  Rc() {
  ...
  lt(e, i) {
    (this.Nn(), this.o.u.Pe.et(e, !i));
  }
  Gt() {
    return this.o.u.Pe?.$i();
  }
  yc() {
    this.S.forEach((e) => e.lt(!0));
  }
  gc(e) {
    let i = !1;
    this.S.filter((s) => (s === e && (i = !0), !i || s === e)).forEach((s) =>
      s.lt(!0),
    );
  }
  kc(e) {
    let i = !1;
    this.S.filter((s) => (s === e && (i = !0), i)).forEach((s) => s.lt(!0));
  }
  Tc(e) {
    (this.S.filter((i) => i !== e).forEach((i) => i.lt(!0)), e.lt(!1));
  }
  Ic() {
    this.S.forEach((e) => e.lt(!e.Gt()));
  }
  vc() {
    this.A.reset();
  }
  ...
  Ac() {
    return this.S.filter((e) => e.Gt()).length;
  }
  ra() {
...
let fe = {};
async function He({ parentId: t, we: e, N: i, Ri: s }) {
  let n = Xt();
  return (
    s && (s.L.$a = n),
    await v.Sa({ id: n, parentId: t, we: e, N: i }),
    n
  );
}
function Rr(t) {
  let e = t.some((n) => n?.G.l.id === "quickList"),
    ...
    s = t.some((n) => at(n.l) && !n.l.label);
  return [
    ...new Set([
      ...t.map((n) => (at(n.l) ? n.l.groupType : n.l.type)),
      ...G(i, "trash"),
      ...G(s, "untitled"),
      ...G(e, "isTreeItemInQuickListRoot"),
    ]),
  ];
}
function rn({ Vc: t, view: e, Ni: i }) {
  return [
    Mt.bi({
      label: p("selectAll"),
      name: "all",
...
class Zr {
  constructor({ Et: e, h: i, Ar: s, Z: n, B: o, Ot: a, yt: r, xt: l }) {
    ((this.q = "treeBrowser"),
      (this.Et = e),
      (this.h = i),
      (this.yt = r),
  ...
  destroy() {
    (Kr(this.Oa), (this.Oa = null), this.L?.De({}));
  }
}
class an {
  constructor({
    ...
    ((this.isOpen = s),
      (this.o = c({
        ...
        children: {
          header: c({
            ...
            onclick: (l) => {
              ((this.isOpen = !this.isOpen),
                Ee(this.o.header.Jt.p.style, (h) => {
                  ((h.transform = `rotate(${this.isOpen ? 90 : st() ? 0 : 180}deg)`),
                    (h.top = `${s ? 1 : 0}px`));
                }),
                ...
                p: et(
                  {
                    ...
                    style: {
                      display: "inline-block",
                      transform: `rotate(${s ? 90 : st() ? 0 : 180}deg)`,
                      top: `${s ? 1 : 0}px`,
                    },
                  },
                  (l) =>
          ...
          pu: c({ style: { display: this.isOpen ? "block" : "none" }, p: o }),
        },
      })));
  }
  Hl() {
...
const ni = (t) => t.url && t.type !== "folder",
  Zi = (t) => !t.url && t.type !== "bookmark";
function ln(t, e = !1, i, s, n) {
  let o = t.children.filter(ni),
    a = t.children.some(Zi);
  return c({
      ...
      body: c({
        ...
        children: {
          yw: c({
            ...
            children: {
              xf: et(
                ...
                (r) => `images/folder${r ? "" : "-dark"}.png`,
              ),
              title: c({
                style: { flex: "0 1 auto", fontWeight: 600 },
                textContent: e ? p("allBookmarks") : t.title,
              }),
              gw: c({
                style: { flex: "0 0 auto" },
                ...(a && {
                  p: new Ht({
                    V: !0,
                    label: p("importFolderAndSubfolders"),
                    fontSize: "12px",
                    $: { marginInlineStart: "6px" },
                    Cs: { padding: "1px 5px" },
                    onclick: async (r) => {
                      ...
                      d.forEach((m) => (m.parentIds = []));
                      let f = [],
                        b = (m, x) => {
                          let g = m.children.some(Zi),
                            w = m.children.some(ni),
                            k = new Date().getTime(),
                            u;
                          g &&
                            ((u = {
                              id: Xt(),
                              label: m.title || p("importedBookmarks"),
                              type: "group",
                              groupType: "folder",
                              createDate: m.dateAdded ?? k,
                              modifyDate: m.dateGroupModified ?? k,
                              parentIds: [x.id],
                              childIds: [],
                              pinnedCount: 0,
                            }),
                            x.childIds.push(u.id),
                            f.push(u));
                          let T = 1e3,
                            I,
                            $ = () => {
                          ...
                          (w && (I = $()),
                            m.children.forEach((S) => {
                              if (ni(S)) {
                                let j = bt(S.url),
                                  K = d.find((F) => F.url === j);
                                (I.childIds.length >= T && (I = $()),
                                  I.childIds.push(K.id),
                                  K.parentIds.push(I.id));
                              } else b(S, u);
                            }));
                        },
                        y = await kt(s);
                      for (; !B(y); ) {
                        let m = y.parentIds.find(pt);
                        if (!m)
                          throw new Error("non-quicklist parent id not found");
                        y = await kt(m);
                      }
                      (b(t, y),
                        await v.In({ Lo: f, vn: d, O: y.id, An: [f[0].id] }),
                        n());
                    },
                  }),
                }),
          ...
          ...(o.length && {
            kw: new an({
              wf: c({
                ...
                children: {
                  label: c({ style: {}, textContent: jo(o.length) }),
                  bf: c({
                    style: { flex: "0 0 auto" },
                    p: new Ht({
                      V: !0,
          ...
          Me: c({
            ...
            children: {
              ...t.children.filter(Zi).map((r) => ln(r, !1, i, s, n)),
              ...(!t.children.length && {
                Iw: c({
                  style: { paddingInlineStart: "26px", fontSize: "12px" },
                  textContent: p("emptyInBrackets"),
                }),
              }),
            },
          }),
...
function cn(t) {
  ...
  return c({
    className: [...G(t.hasBeenRead, "archived")].join(" "),
    style: {
...
chrome.runtime.onMessage.addListener((t, e, i) => {
  t.type === "stateChange" && oi.forEach((s) => s(t.$w));
});
const v = $i(
  new Proxy(
    {},
    {
      get(t, e, i) {
        return (...s) => ((s = Oi(s, void 0, Do)), Jr(e, { args: s }));
      },
    },
  ),
  "core",
...
let ri = document.createElement("canvas");
((ri.width = 32), (ri.height = 32));
let fn = ri.getContext("2d"),
  pn = "data:image/png;base64,",
  Vr = pn.length;
function mn(t) {
  (fn.clearRect(0, 0, 32, 32), fn.drawImage(t, 0, 0, 32, 32));
  let e = ri.toDataURL("image/png");
  return e.startsWith(pn) ? e.substring(Vr) : e;
}
async function ai(t) {
  let { Sw: e, Ow: i } = await v.Mw(t);
  return e ? (await ta(), []) : i;
}
function wn() {
  return p("chromeIncognitoInstructions");
}
async function ta() {
  let t = p("incogitoPermissionRequired") + " " + wn(),
    e = p("privateBrowsingPermissionRequired") + " " + wn();
  await pe(t);
}
function Qi({ style: t = {}, uh: e = 7 }) {
  let i = c({
    className: "spinner",
    style: { opacity: "1", ...t },
    children: Object.fromEntries(
      Ao(e).map((s) => [s, document.createElement("div")]),
    ),
  }).i;
...
async function Ji({
  ...
  (o || (o = p("locationColon")), await t.ke());
  let a = await t.Hn(e, s);
  return U("span", {
    style: { fontSize: i ?? "12px" },
    children: {
      ...(n && { Gw: U("span", { textContent: `${o}  ` }) }),
      ...Mi(
        a.map((r, l) => ({
          [`loc${l}`]: U("span", {
            dir: "auto",
            style: { cursor: "pointer" },
            textContent: je({ groupId: r.id, h: t, l: r }),
            onclick: async (h) => {
              await v.ec({ itemId: r.id, Zi: l === 0 ? r.id : a[l - 1].id });
            },
          }),
        })),
        () => U("span", { textContent: `  ${st() ? "➝" : "⭠"}  ` }),
      ),
    },
  });
}
async function xn({ Et: t, groups: e, h: i, he: s, oe: n }) {
  return (
    await Promise.all(e.map(async (a) => [...(await i.Hn(a.id)), a]))
  ).map((a) =>
    c({
      className: "groupPath",
      children: a.map((r, l) =>
          ...
          p: c({
            ...
            children: [
              ...
              new qr({
                ...
                marginBlock: "0px 0px",
                label: r.label || (ht(r) ? p("all") : p("untitled")),
                oe: n,
                qd: () => s(r),
              }),
            ],
  ...
  try {
    ...
    let i = c({
      ...
      children: {
        Dw: U("div", {
          children: {
            a: U("span", { textContent: p("oneTabRestartRequired") + " " }),
            b: U("a", {
              style: { cursor: "pointer", textDecoration: "underline" },
              onclick: () => chrome.runtime.reload(),
              textContent: p("clickHereToContinue"),
            }),
          },
        }),
        Pw: U("div", {
          p: U("div", {
            ...
            textContent: p("mayNeedToRestartBrowser"),
          }).i,
        }),
      },
    });
...
async function Ki({
  ...
  for (let m = 0; m < a.length; m++) {
    let x = a[m],
      g = i.findIndex((u, T) => T >= m && s(u) === x.id),
      w = i[g],
      k = w && n(w);
    if (!t && k && !w?.tu)
      (g > m && (i.splice(g, 1), i.splice(m, 0, w)),
        e.children.item(m) !== k && e.insertBefore(k, e.children.item(m)),
      ...
      let u = g >= m ? i[g] : void 0;
      if ((b % d === 0 && (await de(0)), (w = await o(x.id, x.index)), w)) {
        let T = n(w);
        if (!T) (w.De?.({ pi: !0 }), (w = u));
        else {
          let I = m;
          if (u) {
            let $ = i.indexOf(u);
            $ >= 0 && (u.De?.({ pi: !0 }), i.splice($, 1), $ < I && I--);
          }
          (e.insertBefore(T, e.children.item(I)), i.splice(I, 0, w));
        }
      } else u && (w = u);
    }
    w && ((w.index = x.index), h?.(w));
  }
  if ((r?.() && (f = !0), f)) {
    l();
    return;
  ...
  for (; i.length > a.length; ) {
    ...
    (m.De({ pi: g }), i.splice(i.length - 1, 1));
  }
  let y = new Set(i.map((m) => n(m)).filter(Boolean));
...
let Ue;
async function sa() {
  ((Ue = await v.ks("theme")), Xi());
}
function na() {
  return !window.matchMedia?.("(prefers-color-scheme: dark)").matches;
}
async function Mc(t) {
  (await v.bt("theme", t), (Ue = t), Xi());
}
let le;
function Xi() {
  ((le = { auto: na(), light: !0, dark: !1 }[Ue]),
    oa(),
    [...document.querySelectorAll(".lightDarkInnerImg")].forEach((t) => {
      t.src = t.dataset[le ? "lightSrc" : "darkSrc"];
    }),
    bn.forEach((t) => t()));
}
function oa() {
...
function Dc() {
  return c({
    ...
    onclick: async (t) => {
      (await v.dl({}), window.close());
    },
    children: [
      et(
        {
          dimension: "10px",
          style: { transform: `rotate(${st() ? 90 : 270}deg)` },
        },
        (t) => `images/down-arrow${t ? "" : "-dark"}.png`,
      ),
      c({ textContent: p("returnToOneTab") }),
    ],
  });
}
function ra(t, e) {
  ...
  return i <= o.top ? o.top - i <= n : s - o.bottom <= n;
}
async function yn(t) {
  let e = new $t(),
    i = await e.ht(t);
  return (B(i) || (await e.Te({ groupId: t })), e);
}
function Oe(t) {
  return !t.isComposing && (t.key === "Escape" || t.key === "Esc");
}
function nt(t, e, i, s = !1) {
  return new Es({
    listener: i,
...
function ze(t, e) {
  return nt(t, "pointerover", e);
}
function aa(t, e) {
  return nt(t, "pointermove", e);
}
function We(t, e) {
  return nt(t, "pointerleave", e);
}
async function li({ rt: t, O: e, N: i }) {
  let s = await Be(t.map((a) => a.itemId)),
    n = await kt(e);
  if (s.some(B) && !B(n))
    throw new Error(
      "folder should not have been allowed to have been moved here",
    );
  if (s.some(_) && s.some(Le(_)))
    throw new Error("Can't mix tabs with groups during smart move");
  let o = new Set(s.map(_i));
  if (o.size > 1)
    throw new Error(
      `Can't mix the following types during smart move: ${[...o].join()}`,
    );
  {
    let a = new $t();
    await a.ke();
    let [r, l] = we(t, (y) => y.sourceParentId),
      h = new Set(
        (await a.getItems([...new Set(l.map((y) => y.itemId))]))
          .filter(_)
          .map(Nt),
      );
    r = r.filter((y) => !h.has(y.itemId));
    let [d, f] = we(l, (y) => h.has(y.itemId)),
      b = [];
    for (let y of d) {
      let m = y.itemId,
        x = a.v(m),
        g = x.parentIds.map((k) => a.v(k)),
        w = [];
      if (
        (g.forEach((k) =>
          k.childIds
            .filter((u) => u === x.id)
            .forEach((u, T) => w.push(Bt({ itemId: x.id, Fe: k.id, zt: T }))),
        ),
        e === "trash")
      )
        w.forEach((k) => r.push(k));
      else {
        let k = w[0];
        (r.push(k), w.slice(1).forEach((T) => b.push(T)));
      }
    }
    if (b.length) {
      let y = await v.gs(b);
      (await v.move({ rt: b, O: "delete" }), await v.Oe(y));
    }
    t = [...r, ...f];
  }
  if (e === "trash") {
    let a = await v.gs(t);
    (await v.move({ rt: t, O: e, N: i }), await v.Oe(a));
  } else if (s.some(_) && B(n)) {
    let a = await vn({ O: e, N: i }),
      r = await v.gs(t);
    (await v.move({ rt: t, O: a }), await v.Oe(r));
  } else if (s.some(yt) && yt(n)) {
    let a = 0;
    for (let r of t) {
      let l = r.itemId,
        h = await kt(l);
      if (yt(h)) {
        let d = await Be(h.childIds);
        if (!0) {
          let b = [];
          (d.forEach((y, m) => {
            _(y)
              ? b.push(
                  Bt({
                    itemId: y.id,
                    zt: h.childIds.slice(0, m).filter((x) => x === y.id).length,
                    Fe: h.id,
                  }),
                )
              : b.push(Bt({ itemId: y.id }));
          }),
            await v.move({ rt: b, O: e, N: i === void 0 ? void 0 : i + a }),
            (a += d.length),
            await v.Oe([r.itemId], !0));
        } else {
          let [b, y] = we(d, _);
          (y.length &&
            (await v.move({
              rt: y.map((m) => Bt({ itemId: m.id })),
              O: e,
              N: i === void 0 ? void 0 : i + a,
            }),
            (a += y.length)),
            b.length
              ? (await v.Fi(h.id, { groupType: "tabGroup", color: Ie }),
                await v.move({
                  rt: [r],
                  O: e,
                  N: i === void 0 ? void 0 : i + (a - y.length),
                }),
                a++)
              : await v.Oe([r.itemId], !0));
        }
        ...
        let d = await v.gs([r]);
        (await v.move({ rt: [r], O: e, N: i === void 0 ? void 0 : i + a++ }),
          await v.Oe(d));
      }
    }
  } else if ((s.some(dt) || s.some(yt)) && dt(n)) {
    let a = new $t(),
      r = [],
      l = [];
    const h = (d, f, b) => {
      if (at(d)) {
        let y = d;
        (a.ul(y.childIds).forEach((x, g) => h(x, d, g)), l.push(y));
      } else
        r.push(
          Bt({
            itemId: d.id,
            zt: f.childIds.slice(0, b).filter((y) => y === d.id).length,
            Fe: f.id,
          }),
        );
    };
    for (let d of t) {
      let f = d.itemId;
      await a.Te({ groupId: f });
      let b = a.v(f),
        y = await a.ht(b.parentIds.find(pt));
      h(b, y);
    }
    (r.length && (await v.move({ rt: r, O: e, N: i })),
      await v.Oe(l.map(Nt), !0));
  } else {
    let a = await v.gs(t);
    (await v.move({ rt: t, O: e, N: i }), await v.Oe(a));
  }
...
function gn({
  ...
  duration: i,
  Uc: s,
  Fw: n = (o) => (o ? "ease-in" : "ease-out"),
}) {
  let o = [
    Object.fromEntries(e.map(({ name: a, before: r }) => [a, r])),
    Object.fromEntries(e.map(({ name: a, after: r }) => [a, r])),
  ];
  (s || o.reverse(),
    t.animate(o, { duration: i, jw: 1, Bw: n(s) }),
    e.forEach((a) => (t.style[a.name] = s ? a.after : a.before)));
}
function la(t) {
...
async function Yi(t) {
  return await Promise.all(
    t.map(async (e) => {
      let i = bt(e.url || e.pendingUrl);
      return { fl: e, Eo: await Pe(i), kt: i, At: e.id, di: e.groupId };
    }),
  );
}
function In(t) {
  return bt(t.url || t.pendingUrl);
}
function ci(t) {
  return ge(In(t));
}
...
async function Lc() {
  try {
    let t = await chrome.permissions.request({ origins: [`${Ge}/*`] });
    return (t && (await v.Cw()), t);
  } catch (t) {
    return (
      console.log(
...
const Ec = Symbol("dropHandled"),
  Fc = Symbol("dragOverHandled"),
  Tt = c({
    id: "landingDiv",
    style: {
...
function Kt() {
  (Tt.remove(),
    typeof Pt < "u" && Pt.remove(),
    typeof fe < "u" && delete fe.Le,
    typeof E < "u" && E.P && (delete E.P.Mi, delete E.P.ss));
}
  ...
  (t) => {
    Oe(t) &&
      ...
      typeof E < "u" &&
        E.F &&
        E.P &&
        ((E.P.$l = !0), delete E.P.Mi, delete E.P.ss, delete E.P.Le),
      delete Q.currentTarget);
  },
  !0,
);
function Vi({ e: t, Kr: e, ji: i, q: s }) {
  (t.stopPropagation(),
    Kt(),
    delete Q.br,
    delete Q.mu,
    ...
    (Q.wu = !s),
    (Q.q = s),
    e ? (E.setDragImage(e), (Q.Mc = 20)) : (Q.Mc = Q.i.offsetHeight));
  let n = Q.i.getBoundingClientRect();
  ((Q.Hw = t.clientX - n.left),
    (Q.qw = t.clientY - n.top),
    t.dataTransfer && (t.dataTransfer.effectAllowed = "all"),
    i.forEach((o) => {
      Q.Ds.push({ i: o, parent: o.parentElement, nextSibling: o.nextSibling });
    }),
    Q.wu && i.forEach((o) => o.remove()));
}
function ui() {
  if (E?.P?.Rn) {
    Q.br = !0;
  ...
  if (!Array.isArray(Q.Ds)) {
    (Kt(), (Q = {}));
    return;
  }
  if (Q.wu && !Q.mu) {
    let t = new Set();
    for (Q.Ds.forEach(({ i: e }) => t.add(e)); Q.Ds.length; ) {
      let e = Q.Ds.findIndex(({ i: s, nextSibling: n }) => !t.has(n)),
        [i] = Q.Ds.splice(e, 1);
...
async function ts({ e: t, Hr: e, Sd: i, qr: s, Ur: n }) {
  (t.preventDefault(), t.type === "drop" && t.stopPropagation());
  let o = E.F ? (E.ft?.types ?? []) : ["tab"],
    a = E.F ? E.ft?.Ae : void 0;
  if (E.F && (!a || !o.length)) {
    Kt();
    return;
  }
  let r = e();
  r !== void 0 && (!Number.isFinite(r) || r < 0) && (r = void 0);
  let l = s();
  if (!l) {
    Kt();
    return;
  ...
  if (a) {
    ...
    if (
      ((h = d.groupType ?? h),
      o?.includes("tab") &&
        o.some((x) => ["tabGroup", "window", "folder"].includes(x)))
    )
      throw new Error("Can't mix tabs with groups during drag");
    let f = a.selectionGroupId,
      b = () => {
        f && oneTabPage?.Uw(f)?.reset();
      },
      y = a.itemsMeta;
    {
      const x = async (w) => {
        if (!w) return [];
        let k = await v.ht(w);
        return k ? [k.id, ...(await x(k.parentIds.find(pt)))] : [];
      };
      let g = await x(l);
      if (a.itemsMeta.some((w) => l === w.itemId)) {
        pe(p("cannotMoveItemIntoItself"));
        return;
      }
      if (a.itemsMeta.some((w) => g.includes(w.itemId))) {
        pe(p("cannotMoveItemAncestorHere"));
        return;
      }
    }
    if (
      ...
      l === "quickList" ||
        (o.includes("tab") &&
          (y.some((x) => x.sourceParentId === "quickList") || _s(t))))
    )
      if (o.includes("tab") && h === "folder") {
        let x = await vn({ O: l, N: r });
        await v.eu({ iu: y.map((g) => g.itemId), O: x });
      } else await v.eu({ iu: y.map((x) => x.itemId), N: r, O: l });
    else {
      let x = Q.q === "quickAccessCol-quickList",
        g = !!Q.q;
      (await li({ rt: y, O: l, N: r }), (Q.mu = !(x || g)));
    }
    b();
  } else if (t.dataTransfer)
    if (
      ["text/uri-list", "text/html", "text/plain", "text/x-moz-place"].some(
        (d) => hi(t.dataTransfer.types, d),
      )
    ) {
      let d;
      if (
        hi(t.dataTransfer.types, "text/x-moz-place") &&
        Zo(t.dataTransfer.getData("text/x-moz-place"))
      ) {
        let b = JSON.parse(t.dataTransfer.getData("text/x-moz-place")),
          y = b.uri,
          m = Te(y);
        d = [[{ title: b.title || oe(m), kt: m }]];
      } else if (
        ["text/html", "text/plain"].some((b) => hi(t.dataTransfer.types, b))
      ) {
        let b = ["text/html", "text/plain"].reduce(
          (y, m) =>
            y ??
            (hi(t.dataTransfer.types, m) ? t.dataTransfer.getData(m) : void 0),
          void 0,
        );
        d = await Ps(b);
      } else {
        let b = t.dataTransfer.getData("text/uri-list"),
          y = (await chrome.tabs.query({})).find((x) => x.url === b)?.title,
          m = Te(t.dataTransfer.getData("text/uri-list"));
        m && (d = [[{ title: y || oe(m), kt: m }]]);
      }
      ...
      ((h = f.groupType ?? h), await v.Ma({ Ga: d, Gs: h, O: l, N: r }));
...
function jc() {
  ...
  An.forEach((e) => {
    ...
    da[e.name] = { light: i, dark: s, x: e.x, y: e.y };
  });
}
const fa = '<meta http-equiv="Content-Type" content="text/html;charset=UTF-8">';
function $n(t) {
  let e = `<a href="${Ls(t.url)}">${Lt(t.title)}</a>`;
  return (qt(t.notes?.text, (i) => (e += `<br/>${i}`)), e);
}
function Bc({ links: t, ge: e }) {
  let i = t.map((o) => es({ link: o, ge: e })),
    s = i.map((o) => o.Xe).filter((o) => o).join(`
`),
    n = i
      .map((o) => o.Ee)
      .filter((o) => o)
...
function es({ link: t, ge: e }) {
  let i, s;
  return (
    ["urlAndTitle", "richText"].includes(e)
      ? (i = [t.url, ...G(t.title)].join(" | "))
      : e === "titleAndUrl"
        ? (i = [...G(t.title), t.url].join(" | "))
        : e === "url"
          ? (i = t.url)
...
function pa({ group: t, level: e = 0, ge: i }) {
  let s = "",
    n = !1;
  return (
    i === "richText" &&
...
function ma({ group: t, level: e = 0 }) {
  let i = "",
    s = e ? 14 : 16,
    n = !1;
  return (
    qt(t.l.label, (o) => ((i += Sn(Lt(o), s) + "<br/>"), (n = !0))),
    qt(t.l.notes?.text, (o) => ((i += Lt(o) + "<br/>"), (n = !0))),
    n && (i += "<br/>"),
    (i += t.k
      .map((o) =>
        o.l.type === "tab"
          ? $n(o.l)
          : `<br/>${ma({ group: o, level: e + 1 })}<br/>`,
      )
      .join("<br/>")),
    i
  );
}
async function Cc({ zw: t, ge: e, h: i }) {
  i ??= new $t();
  let s = await Promise.all(
      t.map((a) => is({ groupId: a, ge: e, h: i, xu: !1, te: !1 })),
    ),
    n = s.map((a) => a.Xe).filter((a) => a).join(`
...
async function is({ groupId: t, ge: e, h: i, xu: s, te: n }) {
  ((i ??= new $t()), s || (await i.Te({ groupId: t })));
  let o,
    a,
    r = i.v(t),
    l = r.childIds.map((h) => i.v(h));
  if (e === "richText") {
    let h = !1;
    (qt(r.label, (d) => {
      if (
...
function Sn(t, e) {
  return wa(t, `style="font-size: ${e}pt;"`);
}
function ss({ Er: t, Fr: e, jr: i, Br: s, Cr: n }) {
  return !(
    (t.includes("folder") && ie(e, ["window", "tabGroup"])) ||
    (t.includes("trash") && i === "quickList") ||
    (t.includes("locked") && t.includes("tab") && i !== "quickList") ||
    (t.includes("locked") &&
      me(["window", "tabGroup"], t) &&
      ie(e, ["window", "tabGroup"])) ||
    (s &&
      !(
        n === "treeItem" &&
        i === "trash" &&
...
const Mn = (() => {
  ...
  function C({
    ...
    Ot ||
      ...
      (j = null),
      wt(),
      document.addEventListener("pointermove", ot, !1),
      document.addEventListener("pointerup", J, !1),
      M.preventDefault(),
      (I = !0));
  }
  function ot(M) {
    M.isTrusted !== !1 &&
      ((!Ot && !I) ||
        ...
        (k = M.target),
        (u = !0),
        T === null && (T = requestAnimationFrame(lt)),
        Ot && M.cancelable && M.preventDefault()));
  }
  function lt() {
    ((T = null), u && ((u = !1), X(m, x, g, w, k)));
  }
  function X(M, H, V, A, z) {
    if (!Ot && !I) return;
    let tt, it;
    ((tt = M - d), (it = H - f));
    const zt = tt * tt + it * it >= h;
    if (
      (!Ot &&
        I &&
        zt &&
        ...
        e && ((W = e.style.pointerEvents), (e.style.pointerEvents = "none")),
        s?.({ ts: e, es: i, qs: d, Us: f }),
        N(V, A)),
      !Ot)
    )
      return;
    ...
    ((b !== tt || y !== it) && (Dt = !0),
      ...
      (q = A),
      Dt &&
        n?.({ ts: e, es: i, dx: tt, dy: it, qs: d, Us: f, pageX: M, pageY: H }),
      St(z, A, V),
      N(V, A));
  }
  function J(M) {
    M.isTrusted !== !1 &&
      ((M?.pointerId !== void 0 && a !== void 0 && M.pointerId !== a) ||
        (!Ot && !I) ||
        (ft(M), ct(M)));
  }
  function ct(M, { If: H = !1 } = {}) {
    if (!Ot && !I) return;
    const V = Ot;
    (V && u && (X(m, x, g, w, k), (u = !1)),
      ...
      O(),
      V &&
        (H ? Gt() : L || document.body.classList.remove("dnd-no-select"),
        e && W !== null && (e.style.pointerEvents = W),
        (W = null)),
      document.removeEventListener("pointermove", ot, !1),
      document.removeEventListener("pointerup", J, !1),
      (Ot = !1),
      (I = !1),
      V && (On = +new Date()),
      (a = void 0),
      (r = void 0),
      (k = null),
      V && o?.({ ts: e, es: i, Ww: b, Nw: y, qs: d, Us: f }));
  }
  function Ft() {
    L &&
  ...
  function Gt() {
    (document.body.classList.add("dnd-no-select"),
      !L &&
        ((L = () => {
          (Ft(), document.body.classList.remove("dnd-no-select"));
        }),
  ...
  function St(M, H, V) {
    ...
    if (
      ...
      return;
    const tt = document.elementsFromPoint(H, V);
    if (!tt?.length) return;
    const it = tt.find((zt) => !vt(zt)) || tt[0];
    !it ||
      !(it instanceof Element) ||
      (M instanceof Element && M === it) ||
      it.dispatchEvent(
  ...
  function ft(M) {
    ...
    if (
      ...
      return;
    const A = Number.isFinite(M?.clientX) ? M.clientX : q,
      z = Number.isFinite(M?.clientY) ? M.clientY : P;
    if (
      !Number.isFinite(A) ||
      !Number.isFinite(z) ||
      A < 0 ||
      ...
      return;
    const tt = document.elementsFromPoint(A, z);
    if (!tt?.length) return;
    const it = tt.find((zt) => !vt(zt)) || tt[0];
    !it ||
      !(it instanceof Element) ||
      (M?.target instanceof Element && M.target === it) ||
      it.dispatchEvent(
  ...
  function ut(M) {
    if ((M === !0 && (M = { enabled: !0 }), !M || M.enabled !== !0))
      return null;
    const H = Number.isFinite(M.Da) ? M.Da : 48,
      V = Number.isFinite(M.Fo) ? M.Fo : 80,
      A = Number.isFinite(M.Pa) ? M.Pa : 640,
      z = M.jo || "quadratic",
      tt = M.target || "hover";
    return { enabled: !0, Da: H, Fo: V, Pa: A, jo: z, target: tt };
  }
  function rt(M) {
    let H = M;
  ...
  function O() {
    (K !== null && (cancelAnimationFrame(K), (K = null)), (F = 0));
  }
  function N(M, H) {
    !Ot ||
      !$ ||
      ...
      j &&
        K === null &&
        ((F = performance.now()), (K = requestAnimationFrame(R))));
  }
  function R(M) {
    if (((K = null), !Ot || !$)) return;
    const H = Math.max(0, (M - F) / 1e3);
    if (((F = M), (j = xt(q, P)), !j)) return;
    const V = Y(P);
    if (V !== 0) {
      const A = V * H;
      (j === window ? window.scrollBy(0, A) : (j.scrollTop += A),
        (K = requestAnimationFrame(R)));
    }
  }
  function Y(M) {
    const H = $;
    ...
    if (j !== window) {
      const us = j.getBoundingClientRect();
      ((V = us.top),
        (A = us.bottom),
        (z = j.scrollTop),
        (tt = j.scrollHeight - j.clientHeight));
    }
    const it = Math.min(A, Math.max(V, M)),
      zt = Math.max(0, it - V),
      Dt = Math.max(0, A - it),
      Zt = Math.max(1, H.Da);
    let Wt = 0,
      Me = 0;
    if (zt < Zt) ((Wt = -1), (Me = zt));
    else if (Dt < Zt) ((Wt = 1), (Me = Dt));
    else return 0;
    if ((Wt < 0 && z <= 0) || (Wt > 0 && z >= tt)) return 0;
    let Qt = 1 - Math.min(1, Me / Zt);
    return (
      H.jo === "quadratic"
        ? (Qt = Qt * Qt)
        : typeof H.jo == "function" && (Qt = H.jo(Qt)),
      (H.Fo + (H.Pa - H.Fo) * Qt) * Wt
    );
  }
  function xt(M, H) {
    if ($?.target === "origin")
      return S && S !== window && !S.isConnected ? null : S;
    if (M < 0 || H < 0 || M > window.innerWidth || H > window.innerHeight)
      return Rt() || S || window;
    const V = document.elementsFromPoint(M, H);
    for (const A of V) {
      if (vt(A)) continue;
      const z = rt(A);
      if (z) {
        const tt = Rt();
        return z === window && tt ? tt : ((D = z), z);
      }
    }
    return Rt() || S || window;
  }
  function vt(M) {
    return M ? !!(e && (M === e || e.contains(M))) : !1;
  }
  function Rt() {
    return (D && D !== window && !D.isConnected && (D = null), D);
  }
  return C;
})();
function Hc(t, e) {
          ...
          vf: et(
            {
              ...
              height: 86 / 2 + "px",
              style: { cursor: "pointer" },
              St: async () => await chrome.tabs.create({ url: Ge, active: !0 }),
            },
            (i) =>
        ...
        Qw: c({
          ...
          children: {
            Af: et(
              ...
              (o) => `images/twistie-open${o ? "" : "-dark"}.png`,
            ),
            $f: et(
              {
                width: "14px",
              ...
              (o) => `images/twistie-closed${o ? "" : "-dark"}.png`,
            ),
          },
        }),
        body: c({
...
let Gn, Dn, ns;
async function xa() {
  ns = (await chrome.permissions.getAll()).permissions.includes("favicon");
  try {
    ns && (Gn = await _r(Pn("http://example.com")));
  } catch (t) {
    console.log(t);
  }
  Dn = await Yr("alpha");
...
async function Ln(t, e) {
  let i = +new Date();
  i - os < 500
    ? ((os = i), rs++, rs >= 8 ? await de(e) : await de(t))
    : ((os = i), (rs = 0), await de(t));
}
function En(t, e = "move") {
  let i = Xr(t),
  ...
  if (
    ...
    let n = Yt.Ko.get(i),
      o = 16 * (n % Yt.hl),
      a = 16 * Math.floor(n / Yt.hl);
    ((s.style.backgroundSize =
      Yt.imageWidth / 2 + "px " + Yt.imageHeight / 2 + "px"),
      (s.style.backgroundRepeat = "none;"),
      (s.style.backgroundPositionX = -1 * o + "px"),
      (s.style.backgroundPositionY = -1 * a + "px"),
      (async () => (
        await qe(),
      ...
      !n ||
        ...
        (ns
          ? ((r.onload = () => {
            ...
            (async () => (
              document.readyState !== "complete" && (await qe()),
              (r.onerror = () => (r.src = a)),
              await Ln(10, 100),
              (r.src = Pn(t))
            ))())
...
async function as({
  ...
  let m = e?.G && ki(e.G.l),
    ...
    T = t?.Tt,
    I = t?.te;
  t || (I = e?.G && yt(e.G.l) && dt(e.l));
  let $ = t?.k?.some((O) => O instanceof Et);
  t || ($ = e.S?.some((O) => dt(O.l)));
  let S = e?.G && [B].some((O) => O(e.G.l)),
    j = e?.G && [yt, B].some((O) => O(e.G.l)),
    K = B(w) && (e || T),
    F = (B(w) && (e || T)) || yt(w),
    P = t?.J,
    q = e?.L.l.id === "trash",
    ...
    W = t?.wt?.J,
    L = (e?.G || t?.wt)?.l;
  !L && !_(w) && (L = await v.ht(w.parentIds.find(pt)));
  let C = L && L.childIds.indexOf(w.id) < (L.pinnedCount ?? 0),
    ot = 0,
    lt = t && t instanceof mt && !t.wt;
  (e?.G &&
    (_(w)
      ? (ot = e.G.S.filter((O) => _(O.l) && w.id === O.l?.id).findIndex(
          (O) => O === e,
        ))
      : (ot = void 0)),
    t?.wt &&
      (_(w)
        ? (ot = t.wt.k
            .filter((O) => O instanceof mt && w.id === O.l?.id)
            .findIndex((O) => O === t))
        : (ot = void 0)),
    _(w) &&
      ot &&
      L &&
      (C =
        (L.childIds.map((O, N) => [O, N]).filter(([O, N]) => O === w.id)[
          ot
        ]?.[1] ?? 0) < (L.pinnedCount ?? 0)));
  let X = e?.q === "quickAccessCol-tasks",
    J = X && Xe(w),
    ct = t?.ut || w.locked || e?.G?.l.locked,
    Ft =
      !_(w) &&
      !(e && !j) &&
      !m &&
  ...
  let St = ({
      ...
      Rt
        ...
        : Mt.bi({
            ...
            ee: vt,
            ni: M,
            action: async ({ e: H, o: V }) => {
              (await Y({ Of: R, e: H, i: V.i })) || l();
            },
          }),
    ft = ({ parentId: O, As: N }) => {
      let R = N ? "direct" : "recurse";
      return async ({ o: Y, e: xt }) => (
        f(
          c({
            style: {
              fontSize: "12px",
              ...
              body: c({
                children: [
                  ...
                  },
                  {
                    ...
                    label: p("recentlyCreated"),
                  },
                  ...G(!N, {
                    ki: [{ field: "index", order: "desc" }],
                    label: p("reverse"),
                  }),
                ].map(({ ki: vt, label: Rt }, M) =>
                  St({
                    name: `${M}`,
                    label: Rt,
                    icon: {
                      I: "sort",
                      ...(vt[0].field === "index" && { Ed: !0 }),
                    },
                    action: async () =>
                      await v.sort({ ki: vt, parentId: O, Jw: R }),
                  }),
                ),
              }),
            },
      ...
      ...Mi(
        [
          s && {
            ...Object.fromEntries(
              [
                ...ya.map(({ name: O, label: N }, R) => ({
                  name: O,
                  label: N,
                  ...(R === 0 && { icon: { I: "open", ee: !st() } }),
                  action: async ({ Of: Y, e: xt }) => {
                    if (
                      (ye(xt) && (xt.preventDefault(), xt.stopPropagation()),
                      !y &&
                        !x &&
                        !ct &&
                        !X &&
                    ...
                    await ai({
                      ...
                      ...(_(w) &&
                        ...
                        !m && {
                          bu: e.G.l.id,
                          tabIndex: e.G.S.findIndex((vt) => vt === e),
                          yu: ti(
                            e.G.S.filter((vt) => vt.l.id === e.l.id).findIndex(
                              (vt) => vt === e,
                            ),
                          ),
                        }),
          ...
          n && {
            ...Object.fromEntries(
              [
                ...G(
                  (lt && b) ||
                    (!P && b && w.parentIds.includes("quickList")) ||
                    (e?.q === "quickAccessCol-quickList" && m),
                  {
                    name: "removeFromQuickList",
                    label: p("removeFromQuickList"),
                    icon: {
                      I: "remove-from-quicklist",
                      dimension: "14px",
                      top: "1px",
                    },
                    D: p("removeFromQuickListMenuItemHelp"),
                    action: async () => await v.Xw([k]),
                  },
                ),
                ...G(!P && !g && !b && at(w) && !X && !y, {
                  name: "shareAsWebPage",
                  label: p("shareAsAWebPage"),
                  icon: { I: "share-action", dimension: "12px", left: "0px" },
                  D: p("shareAsAWebPageMenuItemHelp"),
                  action: async () => showSharingModal(w.id),
                }),
                ...G(!P && !g && B(w) && !X, {
                  name: "saveFolderTabsAsHtmlFile",
                  label: p("saveTabsAsHtmlFile"),
                  D: p("saveTabsAsHtmlFileMenuItemHelp"),
                  action: async () => await Da({ La: w.id }),
                }),
                ...G(!P && !ht(w) && B(w), {
                  name: "storeAllOpenWindowsHere",
                  label: p("storeAllOpenWindowsHere"),
                  Kt: { I: "close", dimension: "13px", left: "0px", ee: !st() },
                  D: p("storeAllOpenWindowsHereMenuItemHelp"),
                ...
                ...G(!P && !g && he(w) && !X, {
                  ...
                  D: p("copyToClipboardMenuItemHelp"),
                  action: async () => {
                    let O = async () => {
                      let { Xe: N, Ee: R } = await is({
                        groupId: t?.l.id ?? e.l.id,
                        ge: r,
                      });
                      return {
                        Mf: new Blob([N], { type: "text/plain" }),
                        ...(R && {
                          Gf: new Blob([fa + R], { type: "text/html" }),
                        }),
                      };
                    };
                    await ea({
                ...
                ...G(!ht(w) && !g && !_(w), { name: "horizDivider1", Zt: !0 }),
                ...G(!ht(w), {
                  name: "rename",
                  label: p("renameOrAddNote"),
                ...
                ...G(he(w) && !X && !g && !P, {
                  name: "lock",
                  label: w.locked ? p("unlock") : p("lock"),
                  icon: {
                ...
                ...G(!ht(w) && !w.rating && !g, {
                  ...
                  D: p("starMenuItemHelp"),
                  action: async () => re.call(t ?? e, { rating: 5 }),
                }),
                ...G(!ht(w) && w.rating && !g, {
                  name: "removeStar",
                  label: p("removeStar"),
                  ...
                  action: async () => re.call(t ?? e, { rating: 0 }),
                }),
                ...G(!ht(w) && w.task && !w.done && !g, {
                  name: "markAsDoneTask",
                  label: p("markAsDoneTask"),
                  icon: {
                  ...
                  D: p("markAsDoneTaskMenuItemHelp"),
                  action: async () => re.call(t ?? e, { task: 1, done: 1 }),
                }),
                ...G(!ht(w) && w.task && !g, {
                  name: "unmarkAsTask",
                  label: p("unMarkAsTask"),
                  icon: {
                    I: "un-task",
                    left: "0px",
                    top: "-2px",
                  ...
                  action: async () => re.call(t ?? e, { task: 0, done: 0 }),
                }),
                ...G(!ht(w) && (!w.task || w.done) && !g, {
                  name: "markAsPendingTask",
                  label: p("markAsPendingTask"),
                  icon: {
                  ...
                  D: p("markAsPendingTaskMenuItemHelp"),
                  action: async () => re.call(t ?? e, { task: 1, done: 0 }),
                }),
                ...G(!ht(w) && w.archived && !g, {
                  name: "un-archive",
                  label: p("unmarkAsArchived"),
                  Kt: {
                    I: "un-archive",
                    dimension: "18px",
                    left: "0px",
                  ...
                  D: p("markAsArchivedMenuItemHelp"),
                  action: async () => re.call(t ?? e, { archived: 0 }),
                }),
                ...G(!ht(w) && !w.archived && !g, {
                  name: "archive",
                  label: p("markAsArchived"),
                  Kt: {
                    I: "archive",
                    left: "0px",
                    top: "1px",
                  ...
                  D: p("markAsArchivedMenuItemHelp"),
                  action: async () => re.call(t ?? e, { archived: 1 }),
                }),
                ...G(
                  !W &&
                    !t?.Tt &&
                    ...
                    !(ht(w) || x || (e && !S) || X || g || lt),
                  {
                    ...
                    Kt: {
                      I: `${C ? "un-" : ""}pin-action`,
                      dimension: `${C ? 15 : 13}px`,
                      top: "1px",
                    },
                    ...(!C && {
                      D: _(w)
                        ? p("openAsPinnedTabMenuItemHelp")
                        : p("pinToTopOfFolderMenuItemHelp"),
                    }),
                    action: async () => {
                      let O;
                      (_(w) ? (O = L.id) : (O = w.parentIds.find(pt)),
                        await v.Ir({
                          itemId: w.id,
                          parentId: O,
                          zt: ot,
                ...
                ...G(!ht(w) && !_(w), { name: "horizDivider2", Zt: !0 }),
                ...G(!P && !g && !b && at(w) && !X, {
                  name: "importLinks",
                  label: p("importLinksHere"),
                  Kt: {
                    I: "import",
                    dimension: "14px",
                    left: "1px",
                  ...
                  D: p("importLinksHereMenuItemHelp"),
                  action: async () =>
                    await Fn({
                      O: k,
                      Gs: w.groupType,
                      gu: async ({ itemId: O, Zi: N }) => {
                        T &&
                          B(t.l) &&
                          (await navigateToItem({ itemId: O, Zi: N }));
                      },
                    }),
                }),
                ...G(!P && !Gt && B(w) && !(t && !T) && !X, {
                  name: "createFolderWithin",
                  label: p("createFolderWithin"),
                  D: p("createFolderWithinMenuItemHelp"),
                  icon: {
                    I: "add-folder",
                    dimension: "15px",
                    top: "1px",
                  ...
                  action: async () => {
                    let O = await He({ we: "folder", parentId: w.id, Ri: e });
                    T && (await navigateToItem({ itemId: w.id, Zi: O }));
                  },
                }),
                ...G(!P && Gt && !X, {
                  name: "createFolder",
                      ...
                      c({
                        ...
                        children: Object.fromEntries(
                          [
                            {
                              name: "above",
                              label: p("createFolderAbove"),
                              icon: { I: "add-folder", dimension: "16px" },
                              action: async () => {
                                let R = k,
                                  Y = w.parentIds.find(pt),
                                  xt = await kt(Y);
                                await He({
                                  we: "folder",
                                  parentId: Y,
                                  Ri: e,
                                  N: xt.childIds.indexOf(R),
                                });
                              },
                            },
                            ...G(K, {
                              ...
                              icon: { I: "add-folder", dimension: "16px" },
                              action: async () => {
                                await He({ we: "folder", parentId: k, Ri: e });
                              },
                            }),
                            {
                              name: "below",
                              label: p("createFolderBelow"),
                              icon: { I: "add-folder", dimension: "16px" },
                              action: async () => {
                                let R = k,
                                  Y = w.parentIds.find(pt),
                ...
                ...G(
                    ...
                    (B(w) || yt(w)),
                  {
                    ...
                    D: p("createGroupMenuItemHelp"),
                    action: async () => {
                      if (e && a) await pe(p("createNewGroupTip"));
                      else {
                        let O = await He({
                          we: yt(await kt(k)) ? "tabGroup" : "window",
                          parentId: k,
                          Ri: e,
                        });
                        T && (await navigateToItem({ itemId: w.id, Zi: O }));
                ...
                ...G(!P && Ft && !X, {
                  name: "createGroup",
                  label: p(
                    F ? "createGroupAboveWithinBelow" : "createGroupAboveBelow",
                  ),
                  icon: {
                    I: "add-group",
                    dimension: "14px",
                ...
                ...G(!P && I && !b && !g && !X, {
                  ...
                  label: p("mergeIntoParent"),
                  Kt: { I: "merge-into-parent", dimension: "14px", top: "1px" },
                  action: async () => {
                    let O = await kt(k);
                    await v.Df({ Pf: O, Lf: O.parentIds.find(pt), N: u });
                  },
                }),
                ...G(!P && $ && !g && !B(w) && !b && !X, {
                  name: "mergeInnerGroups",
                  label: p("mergeWithInnerGroups"),
                  Kt: { I: "merge-into-parent", dimension: "14px", top: "2px" },
                  action: async () => {
                    let O = await Be(w.childIds);
                    for (let N = O.length - 1; N >= 0; N--) {
                      let R = O[N];
                      at(R) && (await v.Df({ Pf: R, Lf: w.id, N }));
                    }
                  },
                }),
                ...G(!P && !g && B(w) && !b && !X, {
                  name: "sortDirect",
                  label: p("sortGroups"),
                  Kt: { I: "sort", dimension: "14px", ee: !st() },
                  action: ft({ parentId: k, As: !0 }),
                }),
                ...G(!P && t && he(w) && !X && !b, {
                  name: "sortRecursive",
                  label: p("sort"),
                  Kt: { I: "sort", dimension: "14px", ee: !st() },
                  action: ft({ parentId: k, As: !1 }),
                }),
                ...G(!P && !b && !g && at(w) && !X, {
                  name: "removeDuplicates",
                  label: p("removeDuplicates"),
                  Kt: { I: "remove-duplicates", dimension: "14px", ee: !st() },
                  D: p("removeDuplicatesMenuItemHelp"),
                  action: async ({ e: O }) => {
                    let { Yw: N, _w: R, Vw: Y } = await v.tx(k),
                      xt = !(N.length || R.length || Y.length);
                    return (
                      f(
                        c({
                          style: {
                              ...
                              children: [
                                ...[
                                  ...G(N.length, {
                                    ...
                                    D: p("recentDuplicateRetainedHelp"),
                                    Ea: N,
                                  }),
                                  ...G(R.length, {
                ...
                ...G(!P && !b && !_(w) && !g && !ht(w) && !m, {
                  name: "move",
                  label: p("move"),
                  Kt: { I: "move", dimension: "15px", ee: !st(), left: "1px" },
                  action: async () => {
                    let O = [Bt({ itemId: k })];
                    await si({
                      title: p("chooseLocationToMoveTo"),
                      He: B(w),
                      io: async (N) => {
                        await li({ rt: O, O: N.id });
                      },
                    });
                  },
                }),
                ...G(!P && !g && !ht(w) && !(_(w) && m), {
                  ...
                  action: async () => {
                    let O;
                    _(w) && L && (O = L.id);
                    let N = [Bt({ itemId: k, Fe: O })],
                      R = await v.gs(N);
                    (await v.move({ rt: N, O: "trash" }),
                      await v.Oe(R),
                      await ka({ Ef: !!t && !e && !y && !T && he(w) }));
                  },
                }),
              ].map((O) => [O.name, St(O)]),
            ),
          ...
          i && {
            ...
            ku: new Ut({
              ...
              value: dt(w),
              fontSize: "12px",
              label: p("openAsTabGroup"),
              D: p("openAsTabGroupMenuItemHelp"),
              onChange: async (O) => {
                ut.Fa.i.style.display = O ? "block" : "none";
                let N = { isTabGroup: O };
                (O && (w.color || (N.color = Ie)),
                  O || ((N.color = void 0), (N.collapsed = void 0)),
                  Fs.forEach((R) =>
                    ut.Fa.Ff[R].p.fh(R === (N.color ?? w.color)),
                  ),
                  ut.Fa.jf.et(w.collapsed, !0),
                  h(N));
              },
              ae: `${24 / 2}px`,
              $: {
            ...
            Fa: c({
              style: {
                marginTop: "3px",
                marginBottom: "0px",
                display: dt(w) ? "block" : "none",
              },
              children: {
                jf: new Ut({
                  value: !!w.collapsed,
                  fontSize: "12px",
                  label: p("openAsCollapsedTabGroup"),
                  D: p("openAsCollapsedTabGroupMenuItemHelp"),
                  onChange: async (O) => {
                    let N = { collapsed: O };
                    (dt(w) || (ut.ku.et(!0, !1), w.color || (N.color = Ie)),
                      h(N));
                  },
                  ae: `${24 / 2}px`,
                  $: {
                ...
                ix: c({
                  ...
                  textContent: p("tabGroupColorColon"),
                }),
                Ff: c({
                  style: {
                    display: "flex",
    ...
    rt = Object.entries(ut),
    wt = (O) => O.i?.classList.contains("horizDivider");
  return (
    (rt = rt.filter(
      ([O, N], R, Y) => !((R === 0 || R === Y.length - 1) && wt(N)),
    )),
    (rt = rt.filter(([O, N], R, Y) => !(wt(N) && R > 0 && wt(Y[R - 1][1])))),
    Object.fromEntries(rt)
  );
}
