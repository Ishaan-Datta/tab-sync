...
function Pt({ text: e, ti: t, ei: n, ii: r }) {
  let o = [{ s: e, tt: 0 }];
  return (
    t.sort(Y((i) => i.length)).forEach((i) => {
      o = o.flatMap(({ s: a, tt: u }) =>
        u ? { s: a, tt: u } : vt(a, i, n, r),
      );
    }),
    o
  );
...
function ne(e, t, n) {
  return Array.isArray(e)
    ...
    : typeof e == "object" && e !== null
      ? Object.fromEntries(Object.entries(e).map(([r, o]) => [r, ne(o, t, n)]))
      : e === t
        ? n
        : e;
}
...
function Ee(e, t) {
  let n = D(e),
    r = D(t);
  return !n || !r ? !1 : H(n, r) ? !0 : Oe(n) === Oe(r);
}
function qt(e) {
  try {
    let t = new URL(x(e)).hostname.toLowerCase();
    return (
      t === "youtube.com" ||
...
function Uo(e, t, n) {
  ...
  return !o || Ee(o, t)
    ? !0
    : qt(t) && o.toLowerCase() === "youtube"
      ? r.toLowerCase() !== "youtube" && !Ee(r, t)
      : !1;
}
function q(e) {
  let t = x(e);
...
async function Do(e) {
    ...
    o;
  {
    ...
    [...n.querySelectorAll("a")].forEach((u) => {
      ...
      (H(d, l) && (d = E(d)), l && d && i.push({ url: c, kt: l, title: d }));
    });
    ...
    o = Object.values(a).map(
      (u) =>
        u.sort(
          Ie(
            Ot((c) => H(c.title, c.url)),
            Y((c) => c.title.length),
          ),
        )[0],
    );
  }
  if (o.some((i) => !H(i.url, i.title))) return [o];
  {
    let i = [
      "address",
      "article",
...
`)),
    ...
    let y = /(?<url>(?![A-Za-z]:[\\/])[a-zA-Z][a-zA-Z0-9+.-]*:(?:\/\/)?\S+)/g,
      m = l
        .flatMap((s) => [...s.matchAll(y)].map((f) => q(Wt(f.groups.url))))
        .filter((s) => s);
    return (
      (m = [...new Set(m)]),
