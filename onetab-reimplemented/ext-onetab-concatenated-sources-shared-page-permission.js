...
const p = Oe(
  new Proxy(
    ...
    {
      get(e, t, n) {
        return (...r) => ((r = re(r, void 0, $t)), $e(t, { args: r }));
      },
    },
  ),
  "core",
...
(($.width = 32), ($.height = 32));
let se = $.getContext("2d"),
  le = "data:image/png;base64,",
  Be = le.length;
function He(e) {
  (se.clearRect(0, 0, 32, 32), se.drawImage(e, 0, 0, 32, 32));
  let t = $.toDataURL("image/png");
  return t.startsWith(le) ? t.substring(Be) : t;
}
async function Mn(e) {
...
async function We() {
  let e = A("incogitoPermissionRequired") + " " + fe(),
    t = A("privateBrowsingPermissionRequired") + " " + fe();
  await showModalAlert(e);
}
function Dn({ style: e = {}, uh: t = 7 }) {
  let n = C({
    className: "spinner",
    style: { opacity: "1", ...e },
    children: Object.fromEntries(
      Mt(t).map((r) => [r, document.createElement("div")]),
    ),
  }).i;
...
async function Rn({ Et: e, groups: t, h: n, he: r, oe: o }) {
  return (
          ...
          p: C({
            ...
            children: [
              ...
              new SelectableItem({
                ...
                marginBlock: "0px 0px",
                label: u.label || (X(u) ? A("all") : A("untitled")),
                oe: o,
                qd: () => r(u),
              }),
            ],
...
async function kn({
  ...
  for (let s = 0; s < a.length; s++) {
    let f = a[s],
      w = n.findIndex((S, x) => x >= s && r(S) === f.id),
      h = n[w],
      b = h && o(h);
    if (!e && b && !h?.tu)
      ...
      if ((y % d === 0 && (await H(0)), (h = await i(f.id, f.index)), h)) {
        let x = o(h);
        if (!x) (h.De?.({ pi: !0 }), (h = S));
        else {
          let N = s;
          ...
          (t.insertBefore(x, t.children.item(N)), n.splice(N, 0, h));
        }
      } else S && (h = S);
    }
...
let G;
async function Gn() {
  ((G = await p.ks("theme")), _());
}
function qe() {
  return !window.matchMedia?.("(prefers-color-scheme: dark)").matches;
}
async function jn(e) {
  (await p.bt("theme", e), (G = e), _());
}
let de;
function _() {
  ((de = { auto: qe(), light: !0, dark: !1 }[G]),
    ze(),
    [...document.querySelectorAll(".lightDarkInnerImg")].forEach((e) => {
      e.src = e.dataset[de ? "lightSrc" : "darkSrc"];
    }),
    me.forEach((e) => e()));
}
function ze() {
...
function Vn(e, t) {
  return J(e, "pointerover", t);
}
function _n(e, t) {
  return J(e, "pointermove", t);
}
function Jn(e, t) {
  return J(e, "pointerleave", t);
}
async function Qn({ rt: e, O: t, N: n }) {
    ...
    );
  {
    let a = new ItemCache();
    await a.ke();
    let [u, c] = K(e, (m) => m.sourceParentId),
      l = new Set(
    ...
    for (let m of d) {
      ...
      if (
        (w.forEach((b) =>
          b.childIds
            .filter((S) => S === f.id)
            .forEach((S, x) => h.push(R({ itemId: f.id, Fe: b.id, zt: x }))),
        ),
        t === "trash")
      )
        ...
        let b = h[0];
        (u.push(b), h.slice(1).forEach((x) => y.push(x)));
      }
    }
    if (y.length) {
      let m = await p.gs(y);
  ...
  if (t === "trash") {
      ...
      if (P(l)) {
        ...
        if (!0) {
          ...
          (m.length &&
            ...
            (a += m.length)),
            y.length
              ? (await p.Fi(l.id, { groupType: "tabGroup", color: Xt }),
                await p.move({
                  rt: [u],
                  O: t,
    ...
    for (let d of e) {
      ...
      let y = a.v(g),
        m = await a.ht(y.parentIds.find(Pt));
      l(y, m);
    }
    (u.length && (await p.move({ rt: u, O: t, N: n })),
      await p.Oe(c.map(xe), !0));
  } else {
    let a = await p.gs(e);
    (await p.move({ rt: e, O: t, N: n }), await p.Oe(a));
  }
...
async function _e(e) {
  return await Promise.all(
    e.map(async (t) => {
      let n = I(t.url || t.pendingUrl);
      return { fl: t, Eo: await ut(n), kt: n, At: t.id, di: t.groupId };
    }),
  );
}
function Je(e) {
  return I(e.url || e.pendingUrl);
}
function tr(e) {
  return j(Je(e));
}
...
async function Ze() {
  try {
    let e = await chrome.permissions.request({ origins: [`${V}/*`] });
...
const Ke = chrome.runtime.getURL("onetab.html"),
...
async function fr(e, t) {
  ...
  return await (await nt(e, n)).json();
}
...
async function ut(e) {
  let n = [...(await at(e))]
      ...
      .slice(0, 132),
    r = "";
  for (let o = 0; o < 22; o++) r += Q[parseInt(n.slice(o * 6, (o + 1) * 6), 2)];
  return r;
}
function ct(e) {
...
function wr(e) {
  return e ? lt(e).replace(/[\x00-\x09\x0B-\x1F\x7F-\x9F\uFEFF]/g, "") : "";
}
function gr(e, t) {
  return (e && M(e)) || t;
}
...
function yr(e, t, n) {
  return pt(e, t) && mt(e, n);
}
const br = globalThis.getOneTabDefaultSettings();
function Tr(e, t, n) {
...
function T(e, t, n) {
  return wt(void 0, e, t, n);
}
const ht = ["style", "children", "child", "init", "destroy", "dataset"];
function wt(e, t, n, r) {
...
const ge = "about:reader?url=";
function I(e) {
  if (!e) return "";
  if (e.startsWith("data:text/html") && e.includes('<div id="placeholderUrl">'))
    return e.match(/<div id="placeholderUrl">(.+)<\/div>/)?.[1];
  if (e.indexOf(":") === -1) return I("https://" + e);
  if (e.indexOf(ge) === 0) return decodeURIComponent(e.substring(ge.length));
...
function Sr(e, t, n) {
  return t && ((e || "").toLowerCase().startsWith("file:") || Ce(e))
    ? n
      ? `data:text/html, <html><body><div id="placeholderUrl">${Qt(e)}</div></body></html>`
...
const ye = [...new Array(30)].map((e, t) => parseInt(10 + Math.pow(1.6, t)));
function* gt(e) {
  let t = 0;
  for (; ye.slice(0, t).reduce((n, r) => n + r, 0) < e; ) yield ye[t++];
}
...
const bt = new Intl.RelativeTimeFormat(void 0, { ju: "auto" }),
  be = [
    { Ye: 60, name: "seconds" },
    { Ye: 60, name: "minutes" },
    { Ye: 24, name: "hours" },
...
function Te(e) {
  ...
  for (let n = 0; n < be.length; n++) {
    const r = be[n];
    if (Math.abs(t) < r.Ye) return bt.format(Math.round(t), r.name);
    t /= r.Ye;
  }
}
function Lr(e) {
  const t = (e - new Date()) / 1e3;
  return t > -60 && t < 0 ? A("justNow") : Te(t);
}
function Pr(e) {
  const t = (e - new Date()) / 1e3;
  return t < 60 && t > 0 ? A("soon") : Te(t);
}
function Ae(e, t) {
  ...
  if (Array.isArray(e)) {
    ...
    for (let o = 0; o < n.length; o++) if (!Ae(e[n[o]], t[n[o]])) return !1;
    return !0;
  } else return e === t;
}
function Se(e) {
  if (Array.isArray(e)) return e.map((t) => Se(t));
  if (typeof e == "object") {
    let t = [...Object.keys(e)].sort();
    return Object.fromEntries(t.map((n) => [n, Se(e[n])]));
  } else return e;
}
function vr(e) {
  e.splice(0, e.length);
...
function St(e, t) {
  let n = e.map((r) => (Array.isArray(r) ? St(r, t) : r));
  return (
...
function Ce(e) {
  if (!e || e === "") return !0;
  for (let t of xt) if (e.startsWith(t) && !Kt(e)) return !0;
...
async function It(e) {
  ...
  ((n = Object.fromEntries(
    ...
    await p.Ve("uncommittedChangesStore", n),
    e && setTimeout(() => It(), 1e3 * 3600 * 24 * 7));
}
const Et = globalThis.createOneTabLocalStorageAdapter();
function Yr() {
  return Et;
}
const eo = (e) => e === void 0,
  ...
  ao = (e) => e.task,
  uo = (e) => O(e) && !Y(e),
  co = (e) => e.groupType === "quickList",
  so = (e) => O(e) || P(e),
  Lt = (e) => e.type === "group",
  D = (e) => e.groupType === "tabGroup",
  P = (e) => e.groupType === "window",
  lo = (e) => D(e) || P(e),
  Pt = (e) => e !== "quickList",
  fo = (e) => e.shared && e.shareExpiryDate > +new Date();
function mo(e, t) {
...
function Co(e, t) {
  return e.length < 2
    ? e
    : e.flatMap((n, r) => [n, ...Z(r === e.length - 1 ? void 0 : t())]);
}
function Dt({ text: e, ti: t, ei: n, ii: r }) {
  let o = [{ s: e, tt: 0 }];
  return (
    t.sort(ee((i) => i.length)).forEach((i) => {
      o = o.flatMap(({ s: a, tt: u }) =>
        u ? { s: a, tt: u } : Ut(a, i, n, r),
      );
    }),
    o
  );
...
function Ut(e, t, n, r) {
  let o = e.split(Ft(t, r, n)),
    i = 0,
    a = o.map((u) => {
      let c = e.slice(i, i + u.length);
      return ((i += u.length + t.length), { s: c, tt: 0 });
    });
  return (
    (i = 0),
    a.length < 2
      ? a
      : a.flatMap(({ s: u, tt: c }, l) =>
          l === a.length - 1
            ? { s: u, tt: c }
            : ((i += u.length),
              [
                { s: u, tt: c },
                { s: e.slice(i, (i += t.length)), tt: 1 },
              ]),
        )
  );
}
...
const xo = "c",
  Io = "e",
  Oo = "t";
const kt = globalThis.createOneTabSessionStorageAdapter();
function Eo() {
  return kt;
}
const $t = "undefined-34LKmiHxP3Mu48u8qrDaHf";
function re(e, t, n) {
  return Array.isArray(e)
    ? e.map((r) => re(r, t, n))
    : typeof e == "object" && e !== null
      ? Object.fromEntries(Object.entries(e).map(([r, o]) => [r, re(o, t, n)]))
      : e === t
        ? n
        : e;
}
function Gt() {
  return navigator.userAgentData?.brands.some(
    ({ brand: e, version: t }) => e === "Opera",
  );
}
function Lo() {
  return navigator.userAgentData?.brands.some(
    ({ brand: e, version: t }) => e === "Brave",
  );
}
function jt() {
  return navigator.userAgentData?.brands.some(
    ({ brand: e }) => e === "Microsoft Edge",
  );
}
async function Po(e) {
...
function vo(e, t) {
  let n = [];
  for (let r = 0; r < e.length; r++)
    (n.push(e[r]), r < e.length - 1 && n.push(t()));
  return n;
}
function Mo(e, t, n) {
  Object.hasOwn(e, t) && n(e[t]);
}
function Do(e, t) {
  e !== void 0 && t(e);
}
function Uo(e, ...t) {
  ...
  return (
    t.forEach((o) => r.add(o)),
    r.forEach((o) => o && o.trim() && n.push(o.trim())),
    n.join(e) || void 0
  );
}
async function Ro(e) {
...
function Ht({ label: e, oe: t, ei: n, ii: r, No: o = 300 }) {
  if (t?.length) {
    ...
    return ((i.textContent = Ve(e, o)), [i]);
  }
}
function Wt(e) {
  return De("tabCount", e);
}
function No(e) {
  return De("bookmarkCount", e);
}
function ko({ label: e, Ro: t, oe: n, ei: r, ii: o, No: i }) {
  t.replaceChildren(...Ht({ label: e, oe: n, ei: r, ii: o, No: i }));
}
function qt(e, t) {
  return t(e);
}
...
function zt(e) {
  return (
    [...".,"].some((t) => e.endsWith(t)) && (e = e.substring(0, e.length - 1)),
    e
  );
}
function Vt(e, t) {
  if (!e) return e;
  let n = e.indexOf(t);
  return (n !== -1 && (e = e.substring(n + t.length)), e);
}
function E(e) {
  return Vt(e, "://");
}
function W(e, t) {
  return ((e = E(e)), (t = E(t)), e === t);
}
function U(e) {
...
function Ee(e) {
  let t = U(e);
  if (!t) return "";
  let n = t.includes("://") ? t : `https://${t}`,
    r = I(n);
  return (r.endsWith("/") && (r = r.substring(0, r.length - 1)), E(r));
}
function Le(e, t) {
  let n = U(e),
    r = U(t);
  return !n || !r ? !1 : W(n, r) ? !0 : Ee(n) === Ee(r);
}
function _t(e) {
  try {
    let t = new URL(I(e)).hostname.toLowerCase();
    return (
      t === "youtube.com" ||
...
function Go(e, t, n) {
  ...
  return !o || Le(o, t)
    ? !0
    : _t(t) && o.toLowerCase() === "youtube"
      ? r.toLowerCase() !== "youtube" && !Le(r, t)
      : !1;
}
function q(e) {
  let t = I(e);
...
async function jo(e) {
  ...
  {
    let i = [];
    [...n.querySelectorAll("a")].forEach((u) => {
      let c = u.href,
        l = q(u.href),
        d = M(r.get(c) ?? u.textContent);
      (W(d, l) && (d = E(d)), l && d && i.push({ url: c, kt: l, title: d }));
    });
    let a = i.reduce((u, c) => ((u[c.kt] ??= []).push(c), u), {});
    o = Object.values(a).map(
      (u) =>
        u.sort(
          Ie(
            vt((c) => W(c.title, c.url)),
            ee((c) => c.title.length),
          ),
        )[0],
    );
  }
  if (o.some((i) => !W(i.url, i.title))) return [o];
  {
    let i = [
      "address",
      "article",
      ...
      [...s.childNodes].reduce(
        (f, w) =>
          w.nodeType === 3
            ? `${f}${w.textContent}`
            : `${f}${
                i.some((h) => h.toUpperCase() === w.tagName?.toUpperCase())
                  ? `
${a(w)}`
                  : a(w)
              }`,
...
`,
          ...
          .map((f) => M(f))
          .forEach((f) => {
            if (!f.trim()) s[s.length - 1].length && s.push([]);
            else {
              let w = f.match(c);
              if (w) {
                let h = q(w.groups.url);
                if (h) {
                  let b = w.groups.title || r.get(w.groups.url) || E(h),
                    S = { kt: h, title: b };
                  s[s.length - 1].push(S);
                }
              }
    ...
    for (let s = 0; s < l.length; s++) {
      ...
      if (d.test(f)) {
        ...
        b && !d.test(b)
          ? ((h.title = b), w?.Zo.pop())
          : (h.title = r.get(f) || E(h.kt));
      } else w?.Zo.push(f);
    }
    g.forEach((s) => {
      ((s.Ja = s.Zo.filter((f) => f).join(`
`)),
        s.Ja || delete s.Ja);
    });
    let y = /(?<url>(?![A-Za-z]:[\\/])[a-zA-Z][a-zA-Z0-9+.-]*:(?:\/\/)?\S+)/g,
      m = l
        .flatMap((s) => [...s.matchAll(y)].map((f) => q(zt(f.groups.url))))
        .filter((s) => s);
    return (
      (m = [...new Set(m)]),
      m.length > g.length ? [m.map((s) => ({ kt: s, title: E(s) }))] : [g]
    );
  }
}
function Qt(e) {
...
function _o({ tab: e, Uu: t, excludedDomains: n = [] }) {
  let r = I(e.url ?? e.pendingUrl);
  return Xe(r) || (e.pinned && !t) || n.includes(j(r));
}
function Jo(e, t = (n) => n) {
  let n = t(e[0]);
...
const ti = [
  ...
  Yt = /^https:\/\/(?:[A-Za-z0-9-]+\.)*one-tab\.com\/page\/.*$/;
function ri({ Ep: e = 1e3, Fp: t, jp: n, Bp: r }) {
  return t.flatMap((o) => {
...
let Pe = !1;
Pe && globalThis.document && (document.documentElement.dir = "rtl");
function tn() {
  return Pe || ["ar", "he", "fa", "ps", "ur"].indexOf(oe()) >= 0
    ? "rtl"
    : "ltr";
}
let ve = tn();
...
function nn() {
  document.getElementsByTagName("html")[0].dir = ve;
}
const Me = {};
function De(e, t) {
  let n = oe(),
    r = Me[n];
  r || ((r = new Intl.PluralRules(n)), (Me[n] = r));
  const o = r.select(t);
...
async function ui({ h: e, itemId: t, Qo: n }) {
  return (await e.Hn(t, n))
    .slice(1)
    .map((o) => Ue({ groupId: o.id, h: e, l: o }))
    .join(`  ${F() ? "➝" : "⭠"}  `);
}
function ci({ groupId: e, h: t, l: n }) {
  e ??= n?.id;
  let r = n || t.v(e);
  return [Fe({ h: t, l: r }), Re({ h: t, l: r })];
}
...
function Fe({ groupId: e, h: t, l: n }) {
  e ??= n?.id;
  let r = n || t.v(e);
  return X(r) ? A("all") : Y(r) ? A("trash") : r.label;
}
let ie = {};
function rn({ type: e, zu: t, Xa: n, Wu: r }) {
  r
    ? (delete ie[e], n())
    : ie[e] ||
      ((ie[e] = !0),
      setTimeout(() => rn({ type: e, zu: t, Xa: n, Wu: !0 }), t));
}
function on() {
  return an();
}
