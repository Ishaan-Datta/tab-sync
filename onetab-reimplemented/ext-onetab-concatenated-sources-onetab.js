...
const mr = "2.14",
  ...
  jl = "chrome://",
  Gl = "chrome://newtab/",
  we = "https://www.one-tab.com",
  El = !1,
  Bl = !1,
  Hl = !0,
  Nl = !1,
  xr = chrome.runtime.getURL("onetab.html"),
  je = chrome.runtime.getURL(""),
  As = !0;
async function zl() {
  return As
...
function Oi(t) {
  return t && t.indexOf(xr) === 0;
}
function Wl(t) {
  return t && t.indexOf(je) === 0;
}
function wr(t) {
  let e = t.toLowerCase();
...
async function kr(t, e) {
  ...
  return await (await Tr(t, i)).json();
}
...
function Ms(t) {
  return t ? Sr(t).replace(/[\x00-\x09\x0B-\x1F\x7F-\x9F\uFEFF]/g, "") : "";
}
function Fi(t, e) {
  return (t && oe(t)) || e;
}
...
function Zl(t, e, i) {
  return Fr(t, e) && Ds(t, i);
}
const Jl = globalThis.getOneTabDefaultSettings();
function Lr(t, e, i) {
...
function L(t, e, i) {
  return Ge(void 0, t, e, i);
}
const jr = ["style", "children", "child", "init", "destroy", "dataset"];
function Ge(t, e, i, s) {
    ...
    if ((i.p && ((i.children ??= []).p = i.p), i.children)) {
      ...
      for (const [h, u] of l)
        u instanceof HTMLElement
          ? n.appendChild(u)
          : (n.appendChild(u?.o?.i ?? u.i),
            u.u && (Object.assign(o, u.u), (o[h] = u)));
      for (const [h, u] of l) ((r[h] = u), (o[h] = u));
    }
  }
  e !== void 0 && t && t.appendChild(n);
  let a = { i: n, u: o };
  return (
    i.destroy && (a.destroy = i.destroy),
    Object.assign(a, r),
    s && Object.assign(a, s),
    i?.init && i.init(a),
    a
...
const Fs = "about:reader?url=";
function St(t) {
  if (!t) return "";
  if (t.startsWith("data:text/html") && t.includes('<div id="placeholderUrl">'))
    return t.match(/<div id="placeholderUrl">(.+)<\/div>/)?.[1];
  if (t.indexOf(":") === -1) return St("https://" + t);
  if (t.indexOf(Fs) === 0) return decodeURIComponent(t.substring(Fs.length));
  if (t.startsWith(`${je}placeholder.html?`)) {
...
function Gr(t, e, i) {
  return e && ((t || "").toLowerCase().startsWith("file:") || Ws(t))
    ? i
      ? `data:text/html, <html><body><div id="placeholderUrl">${Ot(t)}</div></body></html>`
      : `${je}placeholder.html?url=${encodeURIComponent(t)}`
    : t;
}
async function Ls() {
  try {
...
const js = [...new Array(30)].map((t, e) => parseInt(10 + Math.pow(1.6, e)));
function* Er(t) {
  let e = 0;
  for (; js.slice(0, e).reduce((i, s) => i + s, 0) < t; ) yield js[e++];
}
async function Gs(t, e, i) {
  let s = 0;
  for (let n of Er(t)) {
    if (await i(s)) return;
    (await le(n), (s += n));
...
const Hr = new Intl.RelativeTimeFormat(void 0, { ju: "auto" }),
  Es = [
    { Ye: 60, name: "seconds" },
    { Ye: 60, name: "minutes" },
    { Ye: 24, name: "hours" },
...
function Bs(t) {
  ...
  for (let i = 0; i < Es.length; i++) {
    const s = Es[i];
    if (Math.abs(e) < s.Ye) return Hr.format(Math.round(e), s.name);
    e /= s.Ye;
  }
}
function Hs(t) {
  const e = (t - new Date()) / 1e3;
  return e > -60 && e < 0 ? f("justNow") : Bs(e);
}
function Ns(t) {
  const e = (t - new Date()) / 1e3;
  return e < 60 && e > 0 ? f("soon") : Bs(e);
}
function ii(t, e) {
  if (typeof t != typeof e) return !1;
  if (Array.isArray(t)) {
    if (!Array.isArray(e) || t.length !== e.length) return !1;
    for (let i = 0; i < t.length; i++) if (!ii(t[i], e[i])) return !1;
    return !0;
    ...
    for (let n = 0; n < i.length; n++) if (!ii(t[i[n]], e[i[n]])) return !1;
    return !0;
  } else return t === e;
}
function zs(t) {
  if (Array.isArray(t)) return t.map((e) => zs(e));
  if (typeof t == "object") {
    let e = [...Object.keys(t)].sort();
    return Object.fromEntries(e.map((i) => [i, zs(t[i])]));
  } else return t;
}
function Us(t) {
  t.splice(0, t.length);
...
function zr(t, e, i) {
  ...
  for (let l = n - 1; l >= r; l--)
    a.call(t, l) ? (t[l + o] = t[l]) : delete t[l + o];
  for (let l = 0; l < o; l++) t[r + l] = i[l];
}
function Ur(t, e) {
...
function Wr(t, e) {
  let i = t.map((s) => (Array.isArray(s) ? Wr(s, e) : s));
  return (
...
async function ih(t, e) {
  ...
  return t.reduce(([s, n], r, o) => ((i[o] ? s : n).push(r), [s, n]), [[], []]);
}
async function sh(t) {
...
function Ws(t) {
  if (!t || t === "") return !0;
  for (let e of qr) if (t.startsWith(e) && !mo(t)) return !0;
  return !!Wo(t);
}
async function ge(t, e) {
  let i = (await T._e("uncommittedChangesStore")) ?? {},
    s = i[t] ?? {};
  return (
    ...
    (i[t] = s),
    await T.Ve("uncommittedChangesStore", i),
    s.uncommittedChanges
  );
}
async function ah(t) {
  let e = (await T._e("uncommittedChangesStore")) ?? {},
    i = !1;
  (t.forEach((s) => {
    e[s]
      ? (delete e[s], (i = !0))
    ...
    i && (await T.Ve("uncommittedChangesStore", e)));
}
async function qs(t) {
  return (
    ((await T._e("uncommittedChangesStore")) ?? {})?.[t]?.uncommittedChanges ??
    {}
  );
}
async function lh() {
  await T.Bu("uncommittedChangesStore");
}
async function Rs(t) {
  let e = new Date().getTime() - 12096e5,
    i = (await T._e("uncommittedChangesStore")) ?? {};
  ((i = Object.fromEntries(
    Object.entries(i).filter(([s, n]) => n.modifyDate > e),
  )),
    await T.Ve("uncommittedChangesStore", i),
    t && setTimeout(() => Rs(), 1e3 * 3600 * 24 * 7));
}
class Rr {
  async remove(e) {
...
const ch = (t) => t === void 0,
  ...
  it = (t) => t.id === "root",
  It = (t) => t.id === "trash",
  F = (t) => t.groupType === "folder",
  ae = (t) => t.archived,
  ni = (t) => t.task,
  dh = (t) => F(t) && !It(t),
  ji = (t) => t.groupType === "quickList",
  fh = (t) => F(t) || Dt(t),
  Y = (t) => t.type === "group",
  kt = (t) => t.groupType === "tabGroup",
  Dt = (t) => t.groupType === "window",
  Yt = (t) => kt(t) || Dt(t),
  rt = (t) => t !== "quickList",
  ri = (t) => t.shared && t.shareExpiryDate > +new Date();
function ph(t, e) {
  let i = t.split("PLACEHOLDER");
  return L("span", {
    children: {
      a: L("span", { textContent: i[0] }),
      b: e,
      c: L("span", { textContent: i[1] }),
    },
  });
}
function ke(...t) {
...
`,
        ...
        oi !== void 0 && (clearTimeout(oi), (oi = void 0)),
        (oi = setTimeout(() => {
          (console.log(
            JSON.stringify(
              Object.fromEntries(
...
function gh(t, e, i) {
  ...
  let s = t.map((n, r) => [n, r]).filter(([n]) => n === e);
...
function Ni(t, e, i) {
  return Array.isArray(t)
    ...
    : typeof t == "object" && t !== null
      ? Object.fromEntries(Object.entries(t).map(([s, n]) => [s, Ni(n, e, i)]))
      : t === e
        ? i
        : t;
}
...
function Js({ label: t, oe: e, ei: i, ii: s, No: n = 300 }) {
  if (e?.length) {
    let r = Xr({ text: t, ti: e, ei: i, ii: s }),
      o = r.reduce((h, { s: u }) => h + u.length, 0),
      a = Math.max(0, o - n),
      l = r.filter(({ tt: h }) => !h).length;
    for (
      let h = 0;
      h < l &&
      !(a <= 0 || !r.filter(({ s: x, tt: g }) => !g && x.length > 5).length);
      h++
    ) {
      let u = [...r]
          .filter(({ tt: x }) => !x)
          .sort(ke(te(({ s: x }) => x.length))),
        d = u.filter(
          ({ s: x }, g, y) => g === 0 || y[g - 1].s.length === x.length,
        ),
        w = u[d.length],
        b = Math.ceil(a / d.length),
        p = d[0].s.length;
      (w && (b = Math.min(p - w.s.length, b)),
        p - b < 5 && (b = Math.max(0, p - 5)),
        (a -= b * d.length),
        b > 0 &&
          d.forEach((x, g) => {
            ...
            let y = Math.floor(b / 2),
              k = Math.ceil(b / 2);
            ((x.s = x.s.substring(0, x.Ki - y) + x.s.substring(x.Ki + k)),
              (x.Ki = x.Ki - y),
              (x.Hu = !0));
          }));
    }
    return r.flatMap((h) =>
      h.tt
        ...
        : h.Hu
          ? [
              L("span", { textContent: h.s.substring(0, h.Ki) }).i,
              L("span", {
                style: { color: "var(--text-color-extra-weak)" },
                textContent: "…",
              }).i,
              L("span", { textContent: h.s.substring(h.Ki) }).i,
            ]
          : L("span", { textContent: h.s }).i,
    );
  } else {
    let r = document.createElement("span");
    return ((r.textContent = Nn(t, n)), [r]);
  }
}
function Wi(t) {
  return C("tabCount", t);
...
function ao(t) {
  return C("bookmarkCount", t);
}
function qi({ label: t, Ro: e, oe: i, ei: s, ii: n, No: r }) {
  e.replaceChildren(...Js({ label: t, oe: i, ei: s, ii: n, No: r }));
}
function fe(t, e) {
  return e(t);
}
...
function Qs(t) {
  ...
  let i = e.includes("://") ? e : `https://${e}`,
    s = St(i);
  return (s.endsWith("/") && (s = s.substring(0, s.length - 1)), ee(s));
}
function Ks(t, e) {
  let i = pe(t),
    s = pe(e);
  return !i || !s ? !1 : ai(i, s) ? !0 : Qs(i) === Qs(s);
}
function co(t) {
  try {
    let e = new URL(St(t)).hostname.toLowerCase();
    return (
      e === "youtube.com" ||
...
function uo(t, e, i) {
  ...
  return !n || Ks(n, e)
    ? !0
    : co(e) && n.toLowerCase() === "youtube"
      ? s.toLowerCase() !== "youtube" && !Ks(s, e)
      : !1;
}
function ve(t) {
  let e = St(t);
...
async function Vs(t) {
    ...
    n;
  {
    ...
    [...i.querySelectorAll("a")].forEach((a) => {
      let l = a.href,
        h = ve(a.href),
        u = oe(s.get(l) ?? a.textContent);
      (ai(u, h) && (u = ee(u)), h && u && r.push({ url: l, kt: h, title: u }));
    });
    ...
    n = Object.values(o).map(
      (a) =>
        a.sort(
          ke(
            Gi((l) => ai(l.title, l.url)),
            te((l) => l.title.length),
          ),
        )[0],
    );
  }
  if (n.some((r) => !ai(r.url, r.title))) return [n];
  {
    let r = [
      "address",
      "article",
      ...
      [...p.childNodes].reduce(
        (x, g) =>
          g.nodeType === 3
            ? `${x}${g.textContent}`
            : `${x}${
                r.some((y) => y.toUpperCase() === g.tagName?.toUpperCase())
                  ? `
${o(g)}`
                  : o(g)
              }`,
...
`,
          ...
          .map((x) => oe(x))
          .forEach((x) => {
            if (!x.trim()) p[p.length - 1].length && p.push([]);
            else {
              let g = x.match(l);
              if (g) {
                let y = ve(g.groups.url);
                if (y) {
                  let k = g.groups.title || s.get(g.groups.url) || ee(y),
                    m = { kt: y, title: k };
                  p[p.length - 1].push(m);
                }
              }
        ...
        return p.filter((x) => x.length);
    }
    let u = /^(?![A-Za-z]:[\\/])[a-zA-Z][a-zA-Z0-9+.-]*:(?:\/\/)?\S+$/,
      d = [];
    for (let p = 0; p < h.length; p++) {
      ...
      if (u.test(x)) {
        ...
        k && !u.test(k)
          ? ((y.title = k), g?.Zo.pop())
          : (y.title = s.get(x) || ee(y.kt));
      } else g?.Zo.push(x);
    }
    d.forEach((p) => {
      ((p.Ja = p.Zo.filter((x) => x).join(`
`)),
        p.Ja || delete p.Ja);
    });
    let w = /(?<url>(?![A-Za-z]:[\\/])[a-zA-Z][a-zA-Z0-9+.-]*:(?:\/\/)?\S+)/g,
      b = h
        .flatMap((p) => [...p.matchAll(w)].map((x) => ve(lo(x.groups.url))))
        .filter((p) => p);
    return (
      (b = [...new Set(b)]),
      b.length > d.length ? [b.map((p) => ({ kt: p, title: ee(p) }))] : [d]
    );
  }
}
function Ot(t) {
...
function wt({ itemId: t, Fe: e, zt: i }) {
  return {
    itemId: t,
    ...(e && { sourceParentId: e }),
...
function mo(t) {
  return t?.startsWith(`${je}placeholder.html?`);
}
function xo({ tab: t, Uu: e, excludedDomains: i = [] }) {
  let s = St(t.url ?? t.pendingUrl);
  return Oi(s) || (t.pinned && !e) || i.includes(ei(s));
}
function Ph(t, e = (i) => i) {
  let i = e(t[0]);
...
const Be = [
  ...
  Eh = /^https:\/\/(?:[A-Za-z0-9-]+\.)*one-tab\.com\/page\/.*$/;
function Bh({ Ep: t = 1e3, Fp: e, jp: i, Bp: s }) {
  return e.flatMap((n) => {
    if (i(n).length <= t) return [n];
    const r = [];
    let o = i(n).length;
    for (let a = 0; a < o; a += t)
      r.push(s({ Cp: a, entry: n, Hp: i(n).slice(a, a + t) }));
    return r;
  });
}
function go(t) {
...
let nn = !1;
nn && globalThis.document && (document.documentElement.dir = "rtl");
function To() {
  return nn || ["ar", "he", "fa", "ps", "ur"].indexOf(hi()) >= 0
    ? "rtl"
    : "ltr";
}
let rn = To();
...
function vo() {
  document.getElementsByTagName("html")[0].dir = rn;
}
const on = {};
function C(t, e) {
  let i = hi(),
    s = on[i];
  s || ((s = new Intl.PluralRules(i)), (on[i] = s));
  const n = s.select(e);
  let r = chrome.i18n.getMessage(`${t}_${n}`);
  r || (r = chrome.i18n.getMessage(`${t}_other`));
  let o = e;
  return (
    typeof e == "number" && (o = Number(e).toLocaleString()),
    r ? r.replace("{COUNT}", o) : ""
  );
}
async function Hh({ h: t, itemId: e, Qo: i }) {
  return (await t.Hn(e, i))
    .slice(1)
    .map((n) => He({ groupId: n.id, h: t, l: n }))
    .join(`  ${U() ? "➝" : "⭠"}  `);
}
function Ao({ groupId: t, h: e, l: i }) {
  t ??= i?.id;
  let s = i || e.v(t);
  return [Zi({ h: e, l: s }), Ci({ h: e, l: s })];
}
function He({ groupId: t, h: e, l: i }) {
  t ??= i?.id;
  let s = i || e.v(t);
  return Zi({ h: e, l: s }) || Ci({ h: e, l: s });
}
function Ci({ groupId: t, h: e, l: i }) {
  t ??= i?.id;
  let s = i || e.v(t);
  if (it(s)) return f("all");
  if (It(s)) return f("trash");
  if (F(s)) return f("untitled");
  {
    let n = e.Xi(s.id);
    return Wi(n);
  }
}
function Zi({ groupId: t, h: e, l: i }) {
  t ??= i?.id;
  let s = i || e.v(t);
  return it(s) ? f("all") : It(s) ? f("trash") : s.label;
}
let Ji = {};
function Io({ type: t, zu: e, Xa: i, Wu: s }) {
  s
    ? (delete Ji[t], i())
    : Ji[t] ||
      ((Ji[t] = !0),
      setTimeout(() => Io({ type: t, zu: e, Xa: i, Wu: !0 }), e));
}
function Oo() {
  return $o();
}
...
function Mo(t) {
  ...
  let i = e,
    ...
    n = "";
  const r = i.indexOf("#");
  r !== -1 && ((n = i.slice(r)), (i = i.slice(0, r)));
  const o = i.indexOf("?");
  o !== -1 && ((s = i.slice(o + 1)), (i = i.slice(0, o)));
  let a;
  try {
    a = new URL(e);
  } catch {
  ...
  if (!s) return i + n;
  const w = s.split("&").filter((m) => m.length > 0),
    b = [];
  for (const m of w) {
    const v = m.indexOf("="),
      A = v === -1 ? m : m.slice(0, v),
    ...
    if (y(a, M) || d.has(M)) continue;
    (h.has(M) || !k(N, M, u)) && b.push(m);
  }
  return b.length ? i + "?" + b.join("&") + n : i + n;
  function x(m) {
    if (m == null) return "";
    const v = String(m).replace(/\+/g, " ");
    try {
  ...
  function g(m) {
    if (!m) return null;
    const v = (m.hostname || "").toLowerCase(),
      A = (m.pathname || "").toLowerCase();
    return /(^|\.)google\./.test(v) &&
      A.startsWith("/search") &&
      v !== "scholar.google.com"
      ? new Set(["q", "tbm", "start", "hl"])
      : v === "scholar.google.com" && A.startsWith("/scholar")
        ? new Set(["q", "hl", "as_sdt"])
        : v === "www.bing.com" && A.startsWith("/search")
          ? new Set(["q", "first"])
          : /(^|\.)yandex\./.test(v) && A.includes("/search")
            ? new Set(["text", "lr", "win"])
            : v === "search.yahoo.com" && A.startsWith("/search")
              ? new Set(["p"])
              : null;
  }
  function y(m, v) {
    if (!m) return !1;
    const A = (m.hostname || "").toLowerCase();
    return !!(v === "spm" && (A === "sohu.com" || A.endsWith(".sohu.com")));
  }
  function k(m, v, A) {
    ...
    const D =
      ...
      M = /^[0-9a-f]{16,}$/i.test(m),
      N = /^[A-Za-z0-9+/]{24,}={0,2}$/.test(m),
      Z = /^[A-Za-z0-9\-_]{24,}={0,2}$/.test(m),
      dt =
    ...
    if (
      ...
      Z ||
      dt ||
      (/[A-Za-z0-9+/_\-]{24,}={0,2}/.test(m) && A.has(v))
    )
      return !0;
    if (/^[A-Za-z0-9._\-]+$/.test(m) && !/\s/.test(m) && m.length >= 20) {
      const V = m.match(/[A-Za-z]/g) || [],
        vt = m.match(/[AEIOUYaeiouy]/g) || [],
        W = V.length ? vt.length / V.length : 0;
      let et = 0;
      for (let Mt = 1; Mt < m.length; Mt++)
        (/[A-Z]/.test(m[Mt - 1]) && /[a-z]/.test(m[Mt]) && et++,
          /[a-z]/.test(m[Mt - 1]) && /[A-Z]/.test(m[Mt]) && et++);
      const q = m.split(/[-_.]/).filter((Mt) => Mt.length > 0),
        jt = q.length >= 6 && q.every((Mt) => Mt.length <= 12),
        nt = q.some((Mt) => /[A-Za-z]{3,}/.test(Mt));
      if (
        (W < 0.25 && et >= 3 && !jt && !nt) ||
        (A.has(v) && W < 0.35 && !jt && !nt)
      )
        return !0;
    }
    return (
      /\s/.test(m) ||
        (/[-_.]/.test(m) &&
          m.split(/[-_.]/).some((V) => /[A-Za-z]{3,}/.test(V))),
      !1
    );
  }
}
...
function ra({ fontSize: t, label: e, isSelected: i, St: s }) {
  return c({
    className: ["multiple-choice-button", ...I(i, "on")].join(" "),
    style: { fontSize: t },
    textContent: e,
    onclick: (n) => s(n),
  });
  ...
  constructor({ eo: e, iw: i, Ec: s, ...n }) {
    (super({
      ...
      ce: c({
        ...
        textContent: e.find((r) => r.name === i)?.label ?? "",
      }),
      Th: { fontSize: "12px" },
      ...n,
      kh: async () =>
...
class aa {
  constructor({ heading: e, Dd: i, icon: s, note: n, style: r }) {
    this.o = c({
      style: {
        marginInlineStart: "16px",
        marginBottom: "60px",
...
class la extends aa {
  constructor({ To: e, heading: i, options: s, note: n, icon: r, style: o }) {
    (super({ heading: i, icon: r, note: n, style: o }),
      (this.To = e),
      (this.options = s),
      (this.mn = this.options.map((a) => new ha({ aa: this, mi: a }))),
      this.Pd(
        c({
          style: {
            display: "flex",
  ...
  async Lt() {
    let e = await T.ks(this.To);
    await this.wn(e);
  }
  async wn(e, i) {
    (this.mn.forEach((s) => s.wn(e)), i && (await T.Ve(this.To, e)));
  }
}
class ha {
  wn(e) {
...
class X {
  constructor({
    ...
    ((this.ua = []),
      (this.o = c({
        ...
        style: {
          fontSize: 0,
          position: "absolute",
          zIndex: gt.Is ? gt.zIndex + 1 : 1e3,
          borderRadius: s,
        },
        p:
          e ??
          ns({ style: { marginInline: "4px 14px", marginBlock: "10px 10px" } }),
      })),
      (this.m ??= []).push(tt(this.o.i, "click", (u) => u.stopPropagation())));
    ...
    ((this.o.i.style.left = ""),
      ...
      window.innerHeight - a.y > h
        ? (this.o.i.style.top = `${window.scrollY + a.y + a.height / 2 - 11}px`)
        : (this.o.i.style.top = `${window.scrollY + a.y + a.height / 2 - 11 + (window.innerHeight - a.y - h)}px`),
      (this.m ??= []).push(tt(n, "click", (u) => this.destroy())),
      (this.m ??= []).push(tt(n, "contextmenu", (u) => this.destroy(), !0)),
      (X.rn = () => this.destroy()),
      o &&
        this.m.push(
          tt(document, "keydown", (u) => {
            Me(u) && this.destroy();
          }),
        ),
      r?.(this));
  ...
  static bi({ icon: e, label: i, name: s, action: n, D: r, ni: o }) {
    return c({
      className: ["menuItem", ...I(o, "red")].join(" "),
      style: {
        display: "flex",
        alignItems: "flex-start",
        cursor: "pointer",
    ...
    ((this.o = c({
      ...
      children: {
        wi: new Oe(
          ...
          (n, r) =>
            `images/option-button-${e.value === s ? "on" : r ? "hover" : "off"}${n ? "" : "-dark"}.png`,
        ),
        label: c({ textContent: i }),
      },
      init: (n) => {
        ((n.i.onclick = (r) => (r.stopPropagation(), e.Fd(s), !1)),
          (n.i.onpointerover = (r) => {
            n.u.wi.Re(!0);
          }),
...
class ua {
  constructor({ onChange: e, lw: i, options: s }) {
    ((this.onChange = e),
      (this.value = i),
      (this.mn = s.map(
        ({ label: n, value: r }) => new ca({ aa: this, label: n, value: r }),
      )),
      (this.o = c({
  ...
  le(e) {
    if (e !== this.isVisible) {
      if (e) {
        ...
        (this.onShown?.(this), (X.rn = () => this.le(!1)));
      ...
      ((this.isVisible = e),
        ...
        e
          ? ((this.o.i.style.maxWidth = `${this.zs}px`),
            ...
            (this.fa = tt(document, "keydown", (i) => {
              Me(i) && (this.da(), document.activeElement?.blur());
            })),
            (this.m ??= []).push(this.fa),
            bt?.destroy(),
  ...
  jc(e, i) {
    ...
    (d > a && (b = a - d),
      ...
      (this.o.i.style[this.oi ? "right" : "left"] =
        `${Math.max(o, this.Ce.x + w)}px`),
      (this.o.i.style.top = `${this.Ce.y + n + b}px`));
  }
  destroy() {
    (this.le(!1),
      (this.Vi = null),
...
function pa({ style: t }) {
  return c({
    ...
    children: {
      Bc: c({
        children: {
          info: L("span", { textContent: f("pasteRichOrPlainTextBelow") }),
          Bd: L("span", {
            textContent: f("seePasteInstructions"),
            style: {
              marginInlineStart: "1ex",
              color: "var(--link-color)",
              cursor: "pointer",
      ...
      Cd: c({
        style: { display: "none" },
        children: [
          c({ textContent: f("canPasteWebContentForExample") }),
          (() => {
            let e = (o, a) =>
                L("a", {
                  textContent: o,
              ...
              i = (o) => (o === "" ? void 0 : L("span", { textContent: o })),
              [s, n, r] = f("exampleRichTextParagraph")
                .split("PLACEHOLDER")
                .map(i);
            return c({
              ...
              children: [
                s,
                e(f("exampleLink"), "https://www.example.com/one"),
                n,
                e(f("secondExampleLink"), "https://www.example.com/two"),
                r,
              ].filter((o) => o),
            });
          })(),
          c({
            ...
            textContent: f("plainTextLineFormat"),
          }),
          c({
            className: "linkImportExample",
            children: [
              c({
                textContent: `https://www.example.com/one | ${f("exampleLinkTitle")}`,
              }),
              c({
                textContent: `https://www.example.com/two | ${f("secondExampleLinkTitle")}`,
              }),
            ],
          }),
          c({
            style: { paddingTop: "8px" },
            textContent: f("alternatePlainTextFormat"),
          }),
          c({
            style: { "unicode-bidi": "plaintext" },
            className: "linkImportExample",
            children: [
              c({ textContent: f("exampleLinkTitleOptional") }),
              c({ textContent: "https://www.example.com/one" }),
              c({ textContent: f("notesAboutTheLinkOptional") }),
              c({ style: { paddingTop: "14px" } }),
              c({ textContent: f("secondExampleLinkTitleOptional") }),
              c({ textContent: "https://www.example.com/two" }),
              c({ textContent: f("notesAboutTheSecondLinkOptional") }),
            ],
          }),
          c({
            style: { paddingTop: "10px", paddingBottom: "14px" },
            textContent: f("canDragTextNote"),
          }),
        ],
      }),
    },
...
class kn {
  constructor({ Cc: e, cw: i, xn: s, pa: n, ma: r, wa: o }) {
    ((this.Cc = e),
      (this.pa = n),
      (this.ma = r),
      (this.wa = o),
    ...
    ((this.m ??= []).push(tt(this.o.be.Ze.i, "keydown", a, !0)),
      (this.m ??= []).push(
        tt(this.o.be.Ze.i, "input", (l) => {
          this.xn?.({ value: this.$i(), qc: this.o.vs.body.i, Ct: this });
        }),
      ),
      (this.m ??= []).push(
        tt(document, "keydown", (l) => {
          !(this.Cc && gt.Is) &&
            !l.isComposing &&
            l.key === "/" &&
            !Wa(l.target) &&
      ...
      if (this.ti?.length) {
        ...
        if (e.length) {
          ...
          this.Ct.o.vs.body.i.replaceChildren(
            c({ style: {}, textContent: f("noMatchesFound") }).i,
          );
        this.Ct.xa(!0);
      } else this.Ct.xa(!1);
  }
...
class xa {
  constructor({
    ...
    this.o = c({
      className: ["selectable-item", ...I(i, "on")].join(" "),
      style: {
        display: "inline-block",
        textIndent: 0,
        ...(r && { margin: r }),
...
class at {
  ...
  Ud({ e, $o: i }) {
    ...
    return (
      r.detach?.(),
      o.length || (o = [i.getBoundingClientRect()]),
  ...
  async st({ ta: e, ys: i, pinned: s, xe: n, wt: r, kn: o, h: a, ut: l }) {
    ((this.l = { ...e }),
      (this.ut = l),
      (this.ys = i),
      (this.pinned = s),
      ...
      (this.kn = o));
    let h = Gr(St(this.l.url), this.xo);
    if ((this.Qc(), this.J)) {
      this.nn = structuredClone(this.l);
      let b = await qs(this.X),
        p = Object.entries(b);
      p.length > 0 &&
        (p.forEach(([x, g]) => (this.l[x] = g)),
        (this.Rt = !0),
        this.It({ de: !0, pe: !1, X: this.X, Ui: this.yo }));
    }
    let u, d;
    if (this.gn) {
      let { o: b, Nd: p } = await this.Jc({ h: a });
      ((u = b), (d = p));
    }
    let w = this.o.i;
    ((this.o = c({
        ...
        ((this.m ??= []).push(
          Ze(b.i, (p) => {
            !G.Xr &&
              ...
              this.K &&
                this.it &&
                this.o.tab.i.insertBefore(is(), this.o.tab.i.children.item(0)));
          }),
        ),
          (this.m ??= []).push(
            Je(b.i, (p) => {
        ...
        tab: c({
          ...
          children: {
            zi: c({
              ...
              p: Vn(this.l.url, this.Ft && !this.ut ? "move" : "default"),
            }),
            ba: L("a", {
              draggable: !1,
              ...(!this.kn && { tabIndex: -1 }),
              ...
              children: {
                So: L("span", {
                  ...
                  textContent: Fi(this.l.title, "Untitled"),
                }),
              },
              href: h,
              onclick: (b) =>
                this.Zc({ e: b, $o: this.o.u.So.i, zd: !0, Wd: !0 }),
            }),
            ...(this.C && {
              xc: new wa({
                Rd: o && d > 0,
            ...
            ...(!this.C && {
              Ei: z(
                ...
                (b) => `images/vertical-ellipses${b ? "" : "-dark"}.png`,
              ),
            }),
            ...(!this.C && { flags: new wn({ view: this }) }),
          },
        }),
        ...(this.Mt !== "none" && {
          Wi: L("div", {
            ...
            children: {
              a: L("a", {
                ...
                href: h,
                onclick: (b) => this.Zc({ e: b, $o: this.o.u.Wi.a.i }),
                children: {
                  dw: L("span", {
                    textContent: fe(Ki(this.l.url), (b) =>
                      Nn(this.Mt === "domain" ? $i(b) : wr(b), Hn),
                    ),
                  }),
                },
              }),
      ...
      w?.parentNode && w.replaceWith(this.o.i),
  ...
  async Jc({ h: e }) {
    let i = "11px;",
      s;
    this.C && (s = f("otherCopiesColon"));
    let n = this.l.id;
    await e.ke();
    let r = await ot(n),
      o = await Promise.all(
        r.parentIds
          .filter((l) => rt(l) && !e.re.has(l))
          .map((l) => {
            let h = e.v(l);
            return {
              parentId: l,
      ...
      a;
    if (!o.length) a = c({});
    else if (o.length === 1) a = c({ p: o[0] });
    else {
      let l = () =>
        L("span", { style: { textAlign: "start" }, textContent: ",   " });
      a = c({
        style: { textAlign: "start", marginInlineEnd: "20px" },
        children: {
          Yd: (() => {
            let [h, u] = C("placeholderAndOtherLocations", o.length - 1).split(
                "PLACEHOLDER",
              ),
              d = [h, o[0], u].filter((w) => w);
            return (
              (d = d.map((w) =>
                typeof w == "string"
                  ? L("span", {
  ...
  us(e, i, s) {
    (qi({ label: oe(this.l.title), Ro: this.o.u.So.i, oe: e, ei: i, ii: s }),
      this.Y?.us(e, i, s),
      this.o.u.Wi &&
        qi({
          label: Ki(this.l.url),
  ...
  async Ge(e, i) {
    ...
    if (e.type === "update" && this.l.id === s) {
      if (
        (yt(e, "title", (n) => this.setTitle(n)),
        yt(e, "notes", (n) => this.wo(n)),
        yt(e, "rating", (n) => this.fi(n)),
        yt(e, "archived", (n) => this.Bi(n)),
        Be.some((n) => e.propChanges[n]))
      ) {
        let n = Object.fromEntries(
          Object.entries(e.propChanges)
            .filter(([r, o]) => Be.includes(r))
            .map(([r, o]) => [r, o.new]),
        );
        this.Ci(n);
      }
      ...
      (e.type === "copy" && _t(this.l.id, e.itemIds))
    ) {
      let n = await ot(this.l.id);
  ...
  setTitle(e) {
    ((this.l.title = e),
      (this.o.u.So.i.textContent = Fi(e, f("untitled"))),
      this.Je?.et(e));
  }
  wo(e) {
    ...
    (this.Yc(),
      this.Je ||
        ((this.Je = new Ie({
          ...
          ue: this.ue,
          value: oe(this.l.title),
          rs: "tabLinkText",
          Gi: f("title"),
          Qs: (e) => (this.o.u.So.i.textContent = Fi(e, f("untitled"))),
        })),
      ...
      !this.ie &&
        ...
        ((this.ie = new Ie({
          style: {
            display: "none",
            marginInlineStart: `${U() ? 49 : 10}px`,
            marginInlineEnd: `${U() ? 10 : 49}px`,
            marginBottom: "5px",
            direction: "ltr",
      ...
      ((this.it = z(
        {
          ...
          init: (e) => {
            ((this.m ??= []).push(
              tt(e.i, "click", (i) => this.lt(!this.Gt(), !1, $e(i))),
            ),
              (this.m ??= []).push(tt(e.i, "contextmenu", (i) => this.ya(i))));
          },
        },
        ...
        ns: async () => {
          ...
          if (this.hn)
            if (!this.ie.value) this.ie.et(this.l.url);
              ...
              let r = St(this.ie.value);
              if (r !== this.l.url) {
                ((n = !1), (this.tu = !0));
                let [o] = await T.Xo([
                    { id: await Si(r), kt: r, oh: [this.xe] },
                  ]),
                  a = o;
                ...
                let l = this.wt.k
                  ...
                  .map(([d, w]) => w);
                await T.In({ vn: [a], O: this.xe, N: this.index, An: [a.id] });
                let h = new ht();
                if (
                  (await h.ke(),
                  !(
                    this.l.parentIds.filter(
                      (d) => rt(d) && !h.re.has(d) && d !== this.xe,
                    ).length || l.length > 1
                  ) && this.l.parentIds.includes("quickList"))
                ) {
                  let w = (await ot("quickList")).childIds.indexOf(this.l.id);
                  await T.eu({ iu: [a.id], O: "quickList", N: w });
                }
                await T.move({ rt: [ze(this)], O: "delete" });
              }
            }
          if (n) {
            let r = {
            ...
            if (Object.entries(r).length > 0)
              if (this.J) {
                ...
                let o = await ge(this.X, r);
                ((this.Rt = Object.entries(o).length > 0),
                  this.It({ de: this.Rt, pe: !0, X: this.X, Ui: this.yo }));
              } else await T.Fi(this.l.id, r);
          }
        },
      }));
  }
  ...
  Jd(e) {
    ...
    if (
      ...
      new Set(s.map((l) => ls(l.l))).size > 1)
    )
      return (gt.Is || Pt(f("cannotMixTabsGroupsFoldersDuringDrag")), !1);
    S.ft.types = ["tab", ...I(this.C, "trash"), ...I(this.ut, "locked")];
    let r = [this.o.i];
    i.map((l) => l.o.i).forEach((l) => {
      r.includes(l) || r.push(l);
    });
    let o = i.map(ze);
    (i.includes(this) || o.push(ze(this)),
      (S.ft.Ae = {
        itemsMeta: o,
...
function is() {
  return (
    (Tn ??= c({
      ...
      style: {
        [U() ? "left" : "right"]: "-31px",
        boxShadow: `var(--tick-cross-box-shadow${U() ? "" : "-rtl"})`,
      },
    }).i),
    Tn
  );
...
class wa {
  constructor({ Zd: e, As: i, We: s, Ne: n, su: r, Qd: o, Rd: a }) {
    ((this.We = s),
      (this.Ne = n),
      (this.su = r),
      (this.o = c({
        ...
        children: {
          Qr: new Gt({
            ni: !0,
            label: f(a ? "deleteThisCopy" : "delete"),
            icon: { I: "cross-action", dimension: "10px" },
            onclick: this.Ne,
          }),
          Jr: new Gt({
...
class _e {
  ...
  async st({ h: e, ka: i, sf: s } = {}) {
    e ??= (await new ht().Te({ groupId: this.itemId })).h;
    let n = e.v(this.itemId);
    this.l = { ...n };
    let r = this.l.id === "trash" ? [] : [this.l.id];
    i ??= await T.pw(`treeItemsOpen:${this.q}`, r);
    let o = i.includes(this.l.id),
      a,
      l;
    if (this.l.type === "tab") a = this.l.title;
    else {
      let [x, g] = Ao({ h: e, l: this.l });
      ((a = x), (l = g));
    }
    let h = B(this.l) ? 1 : e.Xi(this.l.id),
      u = this.Ht && e.ll(this.l.id).cl,
      d = this.Ht ? u : h,
      w = Number(d).toLocaleString();
    this.Ht && !d && (w = "");
    let b = "none";
    (F(this.l) && (b = "folder"),
      It(this.l) && (b = "trash"),
    ...
    (p && this.De({ pi: !0 }),
      (this.o = c({
        ...
        children: {
          mw: new ya({ ot: this.ot, tf: this.au }),
          se: c({
                  ...
                  Ut: new Ie({
                    ...
                    Qs: async (x) => {
                      ...
                      let g = B(this.l) ? "title" : "label",
                        y = this.l[g];
                      if (((this.l[g] = x), y !== this.l[g])) {
                        let k = { [g]: this.l[g] };
                        await T.Fi(this.itemId, k);
                      }
                    },
                  }),
                  uu: c({
        ...
        ...S.ir({
          ...
          ar: (x) => {
            ...
            let g = (this.A?.nt ?? []).filter(
                (M) => M?.o?.i?.isConnected && M?.l,
              ),
              y = [this.o.i];
            g.map((M) => M.o.i).forEach((M) => {
              y.includes(M) || y.push(M);
            });
            let k = g.map(ze);
            g.includes(this) || k.push(ze(this));
            let m = [...g];
            m.includes(this) || m.push(this);
            let v = ga(m);
            if (new Set(m.map((M) => ls(M.l))).size > 1)
              return (
                gt.Is || Pt(f("cannotMixTabsGroupsFoldersDuringDrag")),
                !1
              );
            ((S.ft.types = v),
              (S.ft.Ae = {
            ...
            let D = B(this.l)
              ...
              : F(this.l)
                ...
                : "dragged-group";
            (m.length > 1 &&
              (m.every((M) => Y(M.l) && !F(M.l))
                ? (D = "multi-dragged-group")
                : m.every((M) => F(M.l))
                  ? (D = "multi-dragged-folder")
                  : m.every((M) => B(M.l))
                    ? (D = "multi-dragged-tab")
                    : (D = "multi-dragged-item")),
              hs({ e: x, Kr: D, ji: y, q: this.q }));
          },
          lr: () => {
            (wi(),
              this.qt &&
        ...
        ...S.hr({
          ...
          dr: (x) => {
            let g = this.o.u.body.Ut.i,
              ...
              v = Math.floor(m.height * 0.2);
            const A = (et) => (et ? [et.l.id, ...A(et.G)] : []);
            let D = A(this.G),
              M = [this.l.id, ...D],
              N = S.F ? (S.ft?.Ae?.itemsMeta ?? []) : [],
              Z = S.F ? (S.ft?.types ?? []) : ["tab"];
            if (S.F && (!N.length || !Z.length)) return !1;
            let dt = !(
                (this.ot && !this.S.length && this.ou) ||
                B(this.l) ||
                N.some((et) => M.includes(et.itemId))
              ),
              R = !(
                N.some((et) => D.includes(et.itemId)) ||
                (Z.includes("tab") && this.q !== "quickAccessCol-quickList") ||
                (this.B && de(["window", "tabGroup"], Z)) ||
                (this.Ot &&
                  de(["window", "tabGroup"], Z) &&
                  Z.includes("untitled")) ||
                (this.L.l.id === "trash" && this.l.id !== "trash")
              );
            if (!dt && !R) return !1;
            let J = dt ? "within" : "before";
            !this.ot &&
              R &&
              (x.clientY <= m.y + Math.max(9, v) && (J = "before"),
              this.isOpen
                ? x.clientY > k.y + k.height - 2 && (J = "after")
                : dt
                  ? x.clientY > m.y + m.height - Math.max(9, v) && (J = "after")
                  : x.clientY > m.y + m.height / 2 && (J = "after"));
            let V =
              this.ot &&
            ...
            if (V) {
              let et = this.Ke?.i,
                jt = this.S.map((nt) => nt?.o?.i)
                  .filter((nt) => nt?.parentElement === et)
                  .at(-1);
              if (jt) {
                let nt = jt.getBoundingClientRect();
                x.clientY > nt.bottom - 2 && (J = "after");
              }
            }
            let vt = V && J === "after";
            S.P.Le = J;
            let W = J === "within" || vt ? this : this.G;
            return !W ||
              !gi({
                Er: Z,
                Fr: W.l.groupType,
              ...
              di(x)
              ? !1
              : W.itemId === "quickList" && !S.F
                ? (delete he.Le, xt.remove(), !1)
                : W.q === "quickAccessCol-tasks" && W.itemId === "root"
                  ? (delete he.Le, xt.remove(), !1)
                  : !0;
          },
          pr: (x) => {
            let g = S.P.Le,
              ...
              m = this.o.se?.Ia;
            (m && this.ot && !this.S.length && g === "within"
              ? (m.i.appendChild(xt),
                Object.assign(xt.style, {
                  top: "3px",
                  bottom: "3px",
          ...
          mr: () => {
            (delete he.Le, xt.remove());
          },
          wr: async (x) => {
            if (this.j) return;
            let g = S.P.Le ?? he.Le;
            if ((delete he.Le, xt.remove(), !g)) return;
            let y =
              this.ot &&
              this.q === "quickAccessCol-quickList" &&
              this.itemId === "quickList" &&
              g === "after";
            (g !== "within" && !y && !this.G?.Ke?.i.contains(this.o.i)) ||
              (g === "within" && this.Os(!0),
              await yi({
                e: x,
                Hr: () => {
                  ...
                  if (!m) return;
                  let v = [...m.children],
                    A = y ? v.length : v.findIndex((J) => J === this.o.i);
                  if (A < 0) {
                    let J = k.S.filter((V) => V?.o?.i?.parentElement === m);
                    return J.length ? J.at(-1)?.index + 1 : void 0;
                  }
                  g === "after" && !y && A++;
                  let D = new Map();
                  k.S.forEach((J) => {
                    let V = J?.o?.i;
                    V && V.parentElement === m && !D.has(V) && D.set(V, J);
                  });
                  let M = v.map((J) => D.get(J)).filter(Boolean),
                    N = M[A]?.index,
                    Z = k?.l?.id;
                  (A === M.length && M.length && (N = M[A - 1]?.index + 1),
                    N === void 0 &&
                      A > M.length &&
                      M.length &&
                      (N = M.at(-1)?.index + 1));
                  let dt = S.F ? (S.ft?.types ?? []) : [],
                    R = S.F ? (S.ft?.Ae?.itemsMeta ?? []) : [];
                  if (
                    Number.isFinite(N) &&
                    S.F &&
                    Z !== "quickList" &&
                    ...
                    let J = new Set(R.map((V) => V.itemId));
                    if (J.size) {
                      let V = v.reduce((vt, W, et) => {
                        if (et >= A) return vt;
                        let q = D.get(W);
                        return vt + (J.has(q?.l?.id) ? 1 : 0);
                      }, 0);
                      V && (N = Math.max(0, N - V));
                    }
                  }
                  return (
                    N === void 0 && console.log("Warn: viewIndex not found"),
                    N
                  );
                },
                qr: () => (g === "within" || y ? this.itemId : this.G.l.id),
                Ur: () =>
                  g === "within" || y ? this.l.groupType : this.G.l.groupType,
              }));
          },
        }),
      ),
      ...
      this.fi(this.l.rating),
      (this.S = []),
      Y(n) && (await this.sync({ L: this.L, h: e, Hi: !0, ka: i })),
      p && p.replaceWith(this.i),
  ...
  Nn() {
    this.o.u.Pe &&
      ...
      (this.o.u.Pe.Nn(),
      (this.m ??= []).push(
        tt(this.o.u.Pe.o.i, "contextmenu", (e) => this.ya(e)),
      ));
  }
  af() {
    this.Ke ||
              ...
              let i = await ys({
                ...
                onChange: async (s) => {
                  (Object.hasOwn(s, "isTabGroup") &&
                    ...
                    delete s.isTabGroup),
                    Object.keys(s).length > 0 && (await T.Fi(this.l.id, s)));
                },
                xs: this.G && F(this.G.l),
              });
              this.Dn = new X({
                Z: this.Z,
                ca: this.qt.uf.i,
  ...
  setActive(e, i) {
    ...
    this.Mn && !Ga(r, this.Mn) && r.scrollIntoView();
  }
  async df(e, i) {
  ...
  async Ge(e, i) {
    ...
    if (
      ...
      (yt(e, "label", (r) => this.mo(r)),
      yt(e, "title", (r) => this.mo(r)),
      yt(e, "archived", (r) => this.Bi(r)),
      yt(e, "color", (r) => this.setColor(r)),
      yt(e, "groupType", (r) => this.ze(r)),
      yt(e, "rating", (r) => this.fi(r)),
      yt(e, "locked", (r) => (this.l.locked = r)),
      ["task", "done"].some((r) => e.propChanges[r]))
    ) {
      let r = Object.fromEntries(
        Object.entries(e.propChanges)
          .filter(([o, a]) => Be.includes(o))
          .map(([o, a]) => [o, a.new]),
      );
      this.Ci(r);
    }
    ...
    if (
      (((this.Ot &&
        e.type === "update" &&
        de(["label"], Object.keys(e.propChanges)) &&
        e.updatedItemParentIds.includes(this.itemId)) ||
        (this.On &&
          e.type === "update" &&
          de(["archived"], Object.keys(e.propChanges)) &&
          e.updatedItemParentIds.includes(this.itemId)) ||
        (this.Ht &&
          ((_t(e.type, ["store", "move", "copy"]) &&
            e.affectedAncestorIds.includes(this.itemId)) ||
            (e.type === "update" &&
              de(["archived", "task"], Object.keys(e.propChanges)) &&
              e.affectedAncestorIds.includes(this.itemId)))) ||
    ...
    if (
      e.type === "store" &&
      _t(this.itemId, ["trash", "quickList", e.targetParentId])
    ) {
      await this.sync({ L: this.L });
      let r = this.S.find((o) => o.itemId === i.$a);
      r && (await this.Os(!0), delete i.$a, r.du());
    }
    e.type === "pin" &&
      e.itemId === this.itemId &&
    ...
    (this.ot &&
      this.Ht &&
      e.type === "update" &&
      de(["archived", "task", "done"], Object.keys(e.propChanges)) &&
      (await st.ww.xw(n), await this.fu(n, e.updatedItemParentIds)),
      this.ot &&
        _t(e.type, ["store", "move", "copy", "removeFromQuickList"]) &&
        (await this.fu(n, e.storeMoveCopyAffectedParentIds)),
      !this.j &&
        (this.S.forEach((r) => r.Ge(e, i)),
  ...
  async sync({ L: e, h: i, Hi: s, ka: n }) {
    ...
    i ||
      ...
      this.Ht
        ? await i.tl()
        : this.Ss
          ? Y(this.l) && (await i.Te({ groupId: this.itemId }))
          : await i.ke());
    let r = i.v(this.itemId);
    if (!r) return;
    if (
      ((this.l = { ...r }),
      this.ze(r.groupType),
      !this.Ss && r.id !== "trash" && F(r))
    ) {
      let a = (r.childIds ?? []).filter((l) => !i.v(l));
      a.length && (await i.getItems(a), (r = i.v(this.itemId) ?? r));
    }
    let o = (r.childIds ?? [])
      ...
      .filter(({ id: a, index: l }) => {
        ...
        return !(
          !h ||
          (!this.Ss && !Y(h)) ||
          (this.Ot && Y(h) && !h.label && this.L.$a !== h.id) ||
          (this.B && !F(h)) ||
          (this.On && ae(h)) ||
          (this.Ht && !(ni(h) || i.Yu(h)))
        );
      });
    (Lt(this.o.u.Ia?.i, (a) => (a.style.display = o.length ? "none" : "block")),
      this.af(),
      !this.j &&
        (await os({
          Hi: s,
          ...
          pn: (a) => a?.i,
          sa: async (a, l) => {
            let h = this.yi && this.yi.$n === a && this.yi.Sn === this.q,
              u = this.hf(a);
            return (
              await u.st({ h: i, ka: n, sf: l }),
              h && u.setActive(!0, !1),
              u
            );
          },
  ...
  async fu(e, i) {
    if (!this.j && this.ot) {
      ...
      for (let r of i) s.get(r)?.forEach((a) => a.ff(e));
    }
  }
  va() {
    this.Ms ||
  ...
  ya(e) {
    (e.preventDefault(),
      ...
      (this.Tn = new X({
        ...
        la: c({
          style: { margin: "8px" },
          children: An({ view: this, Vc: this.G, Ni: () => this.Tn.destroy() }),
        }),
      })));
  }
  Rc() {
