interface OneTabCommonBundleHelperDependencies {
...
interface OneTabCommonBundleHelpers {
...
(globalThis as any).createOneTabCommonBundleHelpers =
  function createOneTabCommonBundleHelpers({
    extensionRootUrl,
    getCoreProxy,
