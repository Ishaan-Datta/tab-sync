export interface OneTabRuntimeHelpers {
  ...
  joinUniqueTrimmed(separator: string, ...values: string[]): string | undefined;
...
export function createOneTabRuntimeHelpers(): OneTabRuntimeHelpers {
  ...
  async function unsleepTab(tab: { id?: number; windowId: number }) {
