...
const pn = "2.14",
  ...
  na = !0,
  ra = !1,
  xn = chrome.runtime.getURL("onetab.html"),
...
function zi(i) {
  return i && i.indexOf(xn) === 0;
}
function la(i) {
  return i && i.indexOf(de) === 0;
}
function wn(i) {
  let t = i.toLowerCase();
...
async function ei(i) {
  let e = [...(await $n(i))]
    ...
    s = "";
  for (let n = 0; n < 22; n++)
    s += ti[parseInt(e.slice(n * 6, (n + 1) * 6), 2)];
  return s;
}
function ii(i) {
...
function da(i, t, e) {
  return Gn(i, t) && Ln(i, e);
}
const pa = globalThis.getOneTabDefaultSettings();
function Sn(i, t, e) {
    ...
    if ((e.p && ((e.children ??= []).p = e.p), e.children)) {
      ...
      for (const [u, c] of l)
        c instanceof HTMLElement
          ? n.appendChild(c)
          : (n.appendChild(c?.o?.i ?? c.i),
            c.u && (Object.assign(o, c.u), (o[u] = c)));
      for (const [u, c] of l) ((r[u] = c), (o[u] = c));
    }
  }
...
function At(i) {
  ...
  if (i.indexOf(Vi) === 0) return decodeURIComponent(i.substring(Vi.length));
  if (i.startsWith(`${de}placeholder.html?`)) {
...
function Dn(i, t, e) {
  return t && ((i || "").toLowerCase().startsWith("file:") || ns(i))
    ? e
      ? `data:text/html, <html><body><div id="placeholderUrl">${mt(i)}</div></body></html>`
      : `${de}placeholder.html?url=${encodeURIComponent(i)}`
    : i;
}
async function xa() {
  try {
...
const _i = [...new Array(30)].map((i, t) => parseInt(10 + Math.pow(1.6, t)));
function* En(i) {
  let t = 0;
  for (; _i.slice(0, t).reduce((e, s) => e + s, 0) < i; ) yield _i[t++];
}
...
function es(i) {
  ...
  return t > -60 && t < 0 ? w("justNow") : ts(t);
}
function Hn(i) {
  const t = (i - new Date()) / 1e3;
  return t < 60 && t > 0 ? w("soon") : ts(t);
}
function Be(i, t) {
  if (typeof i != typeof t) return !1;
  if (Array.isArray(i)) {
    if (!Array.isArray(t) || i.length !== t.length) return !1;
    for (let e = 0; e < i.length; e++) if (!Be(i[e], t[e])) return !1;
    return !0;
    ...
    for (let n = 0; n < e.length; n++) if (!Be(i[e[n]], t[e[n]])) return !1;
    return !0;
  } else return i === t;
}
function is(i) {
  if (Array.isArray(i)) return i.map((t) => is(t));
  if (typeof i == "object") {
    let t = [...Object.keys(i)].sort();
    return Object.fromEntries(t.map((e) => [e, is(i[e])]));
  } else return i;
}
function ss(i) {
  i.splice(0, i.length);
...
function Rn(i, t) {
  let e = i.map((s) => (Array.isArray(s) ? Rn(s, t) : s));
  return (
...
function ns(i) {
  if (!i || i === "") return !0;
  for (let t of Nn) if (i.startsWith(t) && !pr(i)) return !0;
  return !!isNewOrBlankTabPageUrl(i);
}
async function ie(i, t) {
  let e = (await A._e("uncommittedChangesStore")) ?? {},
    s = e[i] ?? {};
  return (
...
async function Fa(i) {
  let t = (await A._e("uncommittedChangesStore")) ?? {},
    e = !1;
  (i.forEach((s) => {
    t[s]
      ? (delete t[s], (e = !0))
    ...
    e && (await A.Ve("uncommittedChangesStore", t)));
}
async function rs(i) {
  return (
    ((await A._e("uncommittedChangesStore")) ?? {})?.[i]?.uncommittedChanges ??
    {}
  );
}
async function Da() {
  await A.Bu("uncommittedChangesStore");
}
async function Wn(i) {
  let t = new Date().getTime() - 12096e5,
    e = (await A._e("uncommittedChangesStore")) ?? {};
...
const Ba = (i) => i === void 0,
  ...
  V = (i) => i.id === "root",
  bt = (i) => i.id === "trash",
  G = (i) => i.groupType === "folder",
  Ct = (i) => i.archived,
  je = (i) => i.task,
  qa = (i) => G(i) && !bt(i),
  oi = (i) => i.groupType === "quickList",
  Ua = (i) => G(i) || $t(i),
  _ = (i) => i.type === "group",
  ct = (i) => i.groupType === "tabGroup",
  $t = (i) => i.groupType === "window",
  zt = (i) => ct(i) || $t(i),
  at = (i) => i !== "quickList",
...
function Ra(i, t) {
  ...
  return F("span", {
    children: {
      a: F("span", { textContent: e[0] }),
      b: t,
      c: F("span", { textContent: e[1] }),
    },
  });
}
function we(...i) {
...
`,
        ...
        qe !== void 0 && (clearTimeout(qe), (qe = void 0)),
        (qe = setTimeout(() => {
          (console.log(
            JSON.stringify(
              Object.fromEntries(
...
function Xa(i, t) {
  return i.length < 2
    ? i
    : i.flatMap((e, s) => [e, ...O(s === i.length - 1 ? void 0 : t())]);
}
function Vn({ text: i, ti: t, ei: e, ii: s }) {
  let n = [{ s: i, tt: 0 }];
  return (
    t.sort(_t((r) => r.length)).forEach((r) => {
      n = n.flatMap(({ s: o, tt: a }) =>
        a ? { s: o, tt: a } : _n(o, r, e, s),
      );
    }),
    n
  );
...
function ls({ label: i, oe: t, ei: e, ii: s, No: n = 300 }) {
  if (t?.length) {
    ...
    for (
      ...
      let c = [...r]
          .filter(({ tt: m }) => !m)
          .sort(we(_t(({ s: m }) => m.length))),
        d = c.filter(
          ({ s: m }, g, x) => g === 0 || x[g - 1].s.length === m.length,
        ),
        y = c[d.length],
        b = Math.ceil(a / d.length),
        p = d[0].s.length;
      (y && (b = Math.min(p - y.s.length, b)),
        p - b < 5 && (b = Math.max(0, p - 5)),
        (a -= b * d.length),
        b > 0 &&
          d.forEach((m, g) => {
            m.Ki ??= Math.floor(m.s.length / 2);
            let x = Math.floor(b / 2),
              T = Math.ceil(b / 2);
            ((m.s = m.s.substring(0, m.Ki - x) + m.s.substring(m.Ki + T)),
              (m.Ki = m.Ki - x),
              (m.Hu = !0));
          }));
    }
    return r.flatMap((u) =>
      u.tt
        ...
        : u.Hu
          ? [
              F("span", { textContent: u.s.substring(0, u.Ki) }).i,
              F("span", {
                style: { color: "var(--text-color-extra-weak)" },
                textContent: "…",
              }).i,
              F("span", { textContent: u.s.substring(u.Ki) }).i,
            ]
          : F("span", { textContent: u.s }).i,
    );
  } else {
    let r = document.createElement("span");
    return ((r.textContent = Ks(i, n)), [r]);
  }
}
function di(i) {
...
function pi({ label: i, Ro: t, oe: e, ei: s, ii: n, No: r }) {
  t.replaceChildren(...ls({ label: i, oe: e, ei: s, ii: n, No: r }));
}
function Ue(i, t) {
  return t(i);
}
...
function hs(i) {
  ...
  let e = t.includes("://") ? t : `https://${t}`,
    s = At(e);
  return (s.endsWith("/") && (s = s.substring(0, s.length - 1)), jt(s));
}
function us(i, t) {
  let e = Yt(i),
    s = Yt(t);
  return !e || !s ? !1 : Re(e, s) ? !0 : hs(e) === hs(s);
}
function ur(i) {
  try {
...
function cr(i, t, e) {
  ...
  return !n || us(n, t)
    ? !0
    : ur(t) && n.toLowerCase() === "youtube"
      ? s.toLowerCase() !== "youtube" && !us(s, t)
      : !1;
}
function se(i) {
  let t = At(i);
...
async function xi(i) {
    ...
    n;
  {
    ...
    [...e.querySelectorAll("a")].forEach((a) => {
      let l = a.href,
        u = se(a.href),
        c = Wt(s.get(l) ?? a.textContent);
      (Re(c, u) && (c = jt(c)), u && c && r.push({ url: l, kt: u, title: c }));
    });
    ...
    n = Object.values(o).map(
      (a) =>
        a.sort(
          we(
            os((l) => Re(l.title, l.url)),
            _t((l) => l.title.length),
          ),
        )[0],
    );
  }
  if (n.some((r) => !Re(r.url, r.title))) return [n];
  {
    let r = [
      "address",
      "article",
      ...
      [...p.childNodes].reduce(
        (m, g) =>
          g.nodeType === 3
            ? `${m}${g.textContent}`
            : `${m}${
                r.some((x) => x.toUpperCase() === g.tagName?.toUpperCase())
                  ? `
${o(g)}`
                  : o(g)
              }`,
...
`,
          ...
          .map((m) => Wt(m))
          .forEach((m) => {
            if (!m.trim()) p[p.length - 1].length && p.push([]);
            else {
              let g = m.match(l);
              if (g) {
                let x = se(g.groups.url);
                if (x) {
                  let T = g.groups.title || s.get(g.groups.url) || jt(x),
                    h = { kt: x, title: T };
                  p[p.length - 1].push(h);
                }
              }
    ...
    for (let p = 0; p < u.length; p++) {
      ...
      if (c.test(m)) {
        ...
        T && !c.test(T)
          ? ((x.title = T), g?.Zo.pop())
          : (x.title = s.get(m) || jt(x.kt));
      } else g?.Zo.push(m);
    }
    d.forEach((p) => {
      ((p.Ja = p.Zo.filter((m) => m).join(`
`)),
        p.Ja || delete p.Ja);
    });
    let y = /(?<url>(?![A-Za-z]:[\\/])[a-zA-Z][a-zA-Z0-9+.-]*:(?:\/\/)?\S+)/g,
      b = u
        .flatMap((p) => [...p.matchAll(y)].map((m) => se(lr(m.groups.url))))
        .filter((p) => p);
    return (
      (b = [...new Set(b)]),
      b.length > d.length ? [b.map((p) => ({ kt: p, title: jt(p) }))] : [d]
    );
  }
}
function mt(i) {
...
function pr(i) {
  return i?.startsWith(`${de}placeholder.html?`);
}
function ll({ tab: i, Uu: t, excludedDomains: e = [] }) {
  let s = At(i.url ?? i.pendingUrl);
  return zi(s) || (i.pinned && !t) || e.includes(Ee(s));
}
function hl(i, t = (e) => e) {
  let e = t(i[0]);
...
let ms = !1;
ms && globalThis.document && (document.documentElement.dir = "rtl");
function yr() {
  return ms || ["ar", "he", "fa", "ps", "ur"].indexOf(wi()) >= 0
    ? "rtl"
    : "ltr";
}
let ys = yr();
...
function br() {
  document.getElementsByTagName("html")[0].dir = ys;
}
const bs = {};
function Ft(i, t) {
  let e = wi(),
    s = bs[e];
  s || ((s = new Intl.PluralRules(e)), (bs[e] = s));
  const n = s.select(t);
...
async function ml({ h: i, itemId: t, Qo: e }) {
  return (await i.Hn(t, e))
    .slice(1)
    .map((n) => be({ groupId: n.id, h: i, l: n }))
    .join(`  ${K() ? "➝" : "⭠"}  `);
}
function gr({ groupId: i, h: t, l: e }) {
  i ??= e?.id;
  let s = e || t.v(i);
  return [yi({ h: t, l: s }), mi({ h: t, l: s })];
}
function be({ groupId: i, h: t, l: e }) {
  i ??= e?.id;
  let s = e || t.v(i);
  return yi({ h: t, l: s }) || mi({ h: t, l: s });
}
function mi({ groupId: i, h: t, l: e }) {
  i ??= e?.id;
  let s = e || t.v(i);
  if (V(s)) return w("all");
  if (bt(s)) return w("trash");
  if (G(s)) return w("untitled");
  {
    let n = t.Xi(s.id);
    return di(n);
  }
...
function yi({ groupId: i, h: t, l: e }) {
  i ??= e?.id;
  let s = e || t.v(i);
  return V(s) ? w("all") : bt(s) ? w("trash") : s.label;
}
let bi = {};
function kr({ type: i, zu: t, Xa: e, Wu: s }) {
  s
    ? (delete bi[i], e())
    : bi[i] ||
      ((bi[i] = !0),
      setTimeout(() => kr({ type: i, zu: t, Xa: e, Wu: !0 }), t));
}
function Tr() {
  return Ar();
}
...
function $r(i) {
  if (i.startsWith("data:")) {
    let h = i.indexOf("/");
    return h ? i.substring(0, h + 1) : "data:";
  }
  const t = String(i);
  let e = t,
    s = "",
  ...
  if (!s) return e + n;
  const y = s.split("&").filter((h) => h.length > 0),
    b = [];
  for (const h of y) {
    const k = h.indexOf("="),
      $ = k === -1 ? h : h.slice(0, k),
    ...
    if (x(a, M) || d.has(M)) continue;
    (u.has(M) || !T(H, M, c)) && b.push(h);
  }
  return b.length ? e + "?" + b.join("&") + n : e + n;
  function m(h) {
    if (h == null) return "";
  ...
  function g(h) {
    if (!h) return null;
    const k = (h.hostname || "").toLowerCase(),
      $ = (h.pathname || "").toLowerCase();
    return /(^|\.)google\./.test(k) &&
      $.startsWith("/search") &&
      k !== "scholar.google.com"
      ? new Set(["q", "tbm", "start", "hl"])
      : k === "scholar.google.com" && $.startsWith("/scholar")
        ? new Set(["q", "hl", "as_sdt"])
        : k === "www.bing.com" && $.startsWith("/search")
          ? new Set(["q", "first"])
          : /(^|\.)yandex\./.test(k) && $.includes("/search")
            ? new Set(["text", "lr", "win"])
            : k === "search.yahoo.com" && $.startsWith("/search")
              ? new Set(["p"])
              : null;
  }
  function x(h, k) {
    ...
    return !!(k === "spm" && ($ === "sohu.com" || $.endsWith(".sohu.com")));
  }
  function T(h, k, $) {
    if (h.length <= 12 || /[^\x00-\x7F]/.test(h) || /^\d+$/.test(h)) return !1;
    const L =
        /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(
          h,
        ),
      M = /^[0-9a-f]{16,}$/i.test(h),
      H = /^[A-Za-z0-9+/]{24,}={0,2}$/.test(h),
      Q = /^[A-Za-z0-9\-_]{24,}={0,2}$/.test(h),
      lt =
    ...
    if (
      ...
      Q ||
      lt ||
      (/[A-Za-z0-9+/_\-]{24,}={0,2}/.test(h) && $.has(k))
    )
      return !0;
    if (/^[A-Za-z0-9._\-]+$/.test(h) && !/\s/.test(h) && h.length >= 20) {
      const Z = h.match(/[A-Za-z]/g) || [],
        Tt = h.match(/[AEIOUYaeiouy]/g) || [],
        q = Z.length ? Tt.length / Z.length : 0;
      let et = 0;
      for (let yt = 1; yt < h.length; yt++)
        (/[A-Z]/.test(h[yt - 1]) && /[a-z]/.test(h[yt]) && et++,
          /[a-z]/.test(h[yt - 1]) && /[A-Z]/.test(h[yt]) && et++);
      const wt = h.split(/[-_.]/).filter((yt) => yt.length > 0),
        Gt = wt.length >= 6 && wt.every((yt) => yt.length <= 12),
        X = wt.some((yt) => /[A-Za-z]{3,}/.test(yt));
      if (
        (q < 0.25 && et >= 3 && !Gt && !X) ||
        ($.has(k) && q < 0.35 && !Gt && !X)
      )
    ...
    return (
      /\s/.test(h) ||
        (/[-_.]/.test(h) &&
          h.split(/[-_.]/).some((Z) => /[A-Za-z]{3,}/.test(Z))),
      !1
    );
  }
}
...
function Ur({ fontSize: i, label: t, isSelected: e, St: s }) {
  return f({
      ...
      children: {
        heading: f({
          ...
          children: {
            ...
            text: f({ textContent: t }),
          },
        }),
        ...(e && { Dd: f({ style: { fontSize: "12px" }, textContent: e }) }),
        sw: f({ style: { paddingTop: "16px" } }),
        body: f({}),
        ...(n && {
          note: f({
            style: {
...
class Il extends Rr {
  constructor({ To: t, heading: e, options: s, note: n, icon: r, style: o }) {
    (super({ heading: e, icon: r, note: n, style: o }),
      (this.To = t),
      (this.options = s),
      (this.mn = this.options.map((a) => new Nr({ aa: this, mi: a }))),
      this.Pd(
        f({
          style: {
            display: "flex",
  ...
  async Lt() {
    let t = await A.ks(this.To);
    await this.wn(t);
  }
  async wn(t, e) {
    (this.mn.forEach((s) => s.wn(t)), e && (await A.Ve(this.To, t)));
  }
}
class Nr {
  wn(t) {
    ...
    this.o = f({
      ...
      children: {
        ...
        ow: f({
          ...
          children: {
            label: f({ style: { fontSize: "14px" }, textContent: e.title }),
            ...(e.xi && {
              xi: f({
                style: {
                  color: "var(--text-color-weak)",
            ...
            ...(e.Fc && { Fc: f({ style: { marginTop: "8px" }, p: e.Fc }) }),
          },
        }),
      },
    });
...
class dt {
  constructor({
    ...
    ((this.ua = []),
      (this.o = f({
        ...
        style: {
          fontSize: 0,
          position: "absolute",
          zIndex: It.Is ? It.zIndex + 1 : 1e3,
          borderRadius: s,
        },
        p:
          t ??
          Mi({ style: { marginInline: "4px 14px", marginBlock: "10px 10px" } }),
      })),
      (this.m ??= []).push(J(this.o.i, "click", (c) => c.stopPropagation())));
    ...
    ((this.o.i.style.left = ""),
      ...
      (this.m ??= []).push(J(n, "click", (c) => this.destroy())),
      (this.m ??= []).push(J(n, "contextmenu", (c) => this.destroy(), !0)),
      (dt.rn = () => this.destroy()),
      o &&
        this.m.push(
...
class vl {
  constructor({ onChange: t, lw: e, options: s }) {
    ((this.onChange = t),
      (this.value = e),
      (this.mn = s.map(
        ({ label: n, value: r }) => new Wr({ aa: this, label: n, value: r }),
      )),
      (this.o = f({
        ...
        t
          ? ((this.o.i.style.maxWidth = `${this.zs}px`),
            ...
            (this.fa = J(document, "keydown", (e) => {
              le(e) && (this.da(), document.activeElement?.blur());
            })),
            (this.m ??= []).push(this.fa),
            ut?.destroy(),
...
function Gs({ style: i }) {
  return f({
    ...
    children: {
      Bc: f({
        children: {
          info: F("span", { textContent: w("pasteRichOrPlainTextBelow") }),
          Bd: F("span", {
            textContent: w("seePasteInstructions"),
            style: {
              marginInlineStart: "1ex",
              color: "var(--link-color)",
              cursor: "pointer",
      ...
      Cd: f({
        style: { display: "none" },
        children: [
          f({ textContent: w("canPasteWebContentForExample") }),
          (() => {
            let t = (o, a) =>
                F("a", {
                  textContent: o,
              ...
              e = (o) => (o === "" ? void 0 : F("span", { textContent: o })),
              [s, n, r] = w("exampleRichTextParagraph")
                .split("PLACEHOLDER")
                .map(e);
            return f({
              ...
              children: [
                s,
                t(w("exampleLink"), "https://www.example.com/one"),
                n,
                t(w("secondExampleLink"), "https://www.example.com/two"),
                r,
              ].filter((o) => o),
            });
          })(),
          f({
            ...
            textContent: w("plainTextLineFormat"),
          }),
          f({
            className: "linkImportExample",
            children: [
              f({
                textContent: `https://www.example.com/one | ${w("exampleLinkTitle")}`,
              }),
              f({
                textContent: `https://www.example.com/two | ${w("secondExampleLinkTitle")}`,
              }),
            ],
          }),
          f({
            style: { paddingTop: "8px" },
            textContent: w("alternatePlainTextFormat"),
          }),
          f({
            style: { "unicode-bidi": "plaintext" },
            className: "linkImportExample",
            children: [
              f({ textContent: w("exampleLinkTitleOptional") }),
              f({ textContent: "https://www.example.com/one" }),
              f({ textContent: w("notesAboutTheLinkOptional") }),
              f({ style: { paddingTop: "14px" } }),
              f({ textContent: w("secondExampleLinkTitleOptional") }),
              f({ textContent: "https://www.example.com/two" }),
              f({ textContent: w("notesAboutTheSecondLinkOptional") }),
            ],
          }),
          f({
            style: { paddingTop: "10px", paddingBottom: "14px" },
            textContent: w("canDragTextNote"),
          }),
        ],
      }),
    },
      ...
      if (this.ti?.length) {
        ...
        if (t.length) {
          ...
          this.Ct.o.vs.body.i.replaceChildren(
            f({ style: {}, textContent: w("noMatchesFound") }).i,
          );
        this.Ct.xa(!0);
      } else this.Ct.xa(!1);
  }
...
class Y {
  ...
  async st({ ta: t, ys: e, pinned: s, xe: n, wt: r, kn: o, h: a, ut: l }) {
    ((this.l = { ...t }),
      ...
      (this.kn = o));
    let u = Dn(At(this.l.url), this.xo);
    if ((this.Qc(), this.J)) {
      this.nn = structuredClone(this.l);
      let b = await rs(this.X),
        p = Object.entries(b);
      p.length > 0 &&
        (p.forEach(([m, g]) => (this.l[m] = g)),
        (this.Rt = !0),
    ...
    ((this.o = f({
        ...
        ((this.m ??= []).push(
          Oe(b.i, (p) => {
            !D.Xr &&
              ...
              this.K &&
                this.it &&
                this.o.tab.i.insertBefore(vi(), this.o.tab.i.children.item(0)));
          }),
        ),
          (this.m ??= []).push(
            Me(b.i, (p) => {
        ...
        tab: f({
          ...
          children: {
            zi: f({
              ...
              p: ln(this.l.url, this.Ft && !this.ut ? "move" : "default"),
            }),
            ba: F("a", {
              draggable: !1,
              ...(!this.kn && { tabIndex: -1 }),
              ...
              children: {
                So: F("span", {
                  ...
                  textContent: si(this.l.title, "Untitled"),
                }),
              },
              href: u,
              onclick: (b) =>
          ...
          Wi: F("div", {
            ...
            children: {
              a: F("a", {
                ...
                children: {
                  dw: F("span", {
                    textContent: Ue(prettyPrintUrl(this.l.url), (b) =>
                      Ks(this.Mt === "domain" ? Zi(b) : wn(b), Qs),
                    ),
                  }),
                },
              }),
      ...
      y?.parentNode && y.replaceWith(this.o.i),
  ...
  async Jc({ h: t }) {
    let e = "11px;",
      s;
    this.C && (s = w("otherCopiesColon"));
    let n = this.l.id;
    await t.ke();
    let r = await rt(n),
      o = await Promise.all(
        r.parentIds
          .filter((l) => at(l) && !t.re.has(l))
          .map((l) => {
            let u = t.v(l);
            return {
              parentId: l,
      ...
      a;
    if (!o.length) a = f({});
    else if (o.length === 1) a = f({ p: o[0] });
    else {
      let l = () =>
        F("span", { style: { textAlign: "start" }, textContent: ",   " });
      a = f({
        style: { textAlign: "start", marginInlineEnd: "20px" },
        children: {
          Yd: (() => {
            let [u, c] = Ft("placeholderAndOtherLocations", o.length - 1).split(
                "PLACEHOLDER",
              ),
              d = [u, o[0], c].filter((y) => y);
            return (
              (d = d.map((y) =>
                typeof y == "string"
                  ? F("span", {
  ...
  us(t, e, s) {
    (pi({ label: Wt(this.l.title), Ro: this.o.u.So.i, oe: t, ei: e, ii: s }),
      this.Y?.us(t, e, s),
      this.o.u.Wi &&
        pi({
  ...
  async Ge(t, e) {
    ...
    if (t.type === "update" && this.l.id === s) {
      if (
        ...
        ye.some((n) => t.propChanges[n]))
      ) {
        let n = Object.fromEntries(
          Object.entries(t.propChanges)
            .filter(([r, o]) => ye.includes(r))
            .map(([r, o]) => [r, o.new]),
        );
        this.Ci(n);
      }
      ...
      (t.type === "copy" && Ht(this.l.id, t.itemIds))
    ) {
      let n = await rt(this.l.id);
  ...
  setTitle(t) {
    ((this.l.title = t),
      (this.o.u.So.i.textContent = si(t, w("untitled"))),
      this.Je?.et(t));
  }
  wo(t) {
    ...
    (this.Yc(),
      this.Je ||
        ((this.Je = new re({
          ...
          ue: this.ue,
          value: Wt(this.l.title),
          rs: "tabLinkText",
          Gi: w("title"),
          Qs: (t) => (this.o.u.So.i.textContent = si(t, w("untitled"))),
        })),
                ...
                if (
                  ...
                  !(
                    this.l.parentIds.filter(
                      (d) => at(d) && !u.re.has(d) && d !== this.xe,
                    ).length || l.length > 1
                  ) && this.l.parentIds.includes("quickList"))
                ) {
                  let y = (await rt("quickList")).childIds.indexOf(this.l.id);
                  await A.eu({ iu: [a.id], O: "quickList", N: y });
                }
                await A.move({ rt: [Te(this)], O: "delete" });
              }
            }
          if (n) {
            let r = {
  ...
  Jd(t) {
    ...
    if (
      ...
      new Set(s.map((l) => Si(l.l))).size > 1)
    )
      return (It.Is || Qt(w("cannotMixTabsGroupsFoldersDuringDrag")), !1);
    ...
    ((this.We = s),
      ...
      (this.o = f({
        ...
        children: {
          Qr: new Mt({
            ni: !0,
            label: w(a ? "deleteThisCopy" : "delete"),
            icon: { I: "cross-action", dimension: "10px" },
            onclick: this.Ne,
          }),
          Jr: new Mt({
...
class Ri {
  ...
  async st({ h: t, ka: e, sf: s } = {}) {
    ...
    (p && this.De({ pi: !0 }),
      (this.o = f({
        ...
        children: {
          mw: new Xr({ ot: this.ot, tf: this.au }),
          se: f({
                  ...
                  Ut: new re({
                    ...
                    Qs: async (m) => {
                      ...
                      let g = j(this.l) ? "title" : "label",
                        x = this.l[g];
                      if (((this.l[g] = m), x !== this.l[g])) {
                        let T = { [g]: this.l[g] };
                        await A.Fi(this.itemId, T);
                      }
                    },
                  }),
                  uu: f({
      ...
      (this.m ??= []).push(
        ...dnd.ir({
          ...
          ar: (m) => {
            ...
            let h = [...g];
            h.includes(this) || h.push(this);
            let k = Vr(h);
            if (new Set(h.map((M) => Si(M.l))).size > 1)
              return (
                It.Is || Qt(w("cannotMixTabsGroupsFoldersDuringDrag")),
                !1
              );
            ((dnd.ft.types = k),
              (dnd.ft.Ae = {
        ...
        ...dnd.hr({
          ...
          dr: (m) => {
            let g = this.o.u.body.Ut.i,
              ...
              k = Math.floor(h.height * 0.2);
            const $ = (et) => (et ? [et.l.id, ...$(et.G)] : []);
            let L = $(this.G),
              M = [this.l.id, ...L],
            ...
            let lt = !(
                ...
                j(this.l) ||
                H.some((et) => M.includes(et.itemId))
              ),
              U = !(
            ...
            if (!lt && !U) return !1;
            let z = lt ? "within" : "before";
            !this.ot &&
              U &&
              (m.clientY <= h.y + Math.max(9, k) && (z = "before"),
              this.isOpen
                ? m.clientY > T.y + T.height - 2 && (z = "after")
                : lt
                  ? m.clientY > h.y + h.height - Math.max(9, k) && (z = "after")
                  : m.clientY > h.y + h.height / 2 && (z = "after"));
            let Z =
              this.ot &&
            ...
            if (Z) {
              let et = this.Ke?.i,
                Gt = this.S.map((X) => X?.o?.i)
                  .filter((X) => X?.parentElement === et)
                  .at(-1);
              if (Gt) {
                let X = Gt.getBoundingClientRect();
                m.clientY > X.bottom - 2 && (z = "after");
              }
            }
            let Tt = Z && z === "after";
            dnd.P.Le = z;
            let q = z === "within" || Tt ? this : this.G;
            return !q ||
              !Ei({
                Er: Q,
                Fr: q.l.groupType,
              ...
              Ti(m)
              ? !1
              : q.itemId === "quickList" && !dnd.F
                ? (delete Jt.Le, xt.remove(), !1)
                : q.q === "quickAccessCol-tasks" && q.itemId === "root"
                  ? (delete Jt.Le, xt.remove(), !1)
                  : !0;
          },
          pr: (m) => {
            let g = dnd.P.Le,
              ...
              h = this.o.se?.Ia;
            (h && this.ot && !this.S.length && g === "within"
              ? (h.i.appendChild(xt),
                Object.assign(xt.style, {
                  top: "3px",
                  bottom: "3px",
          ...
          mr: () => {
            (delete Jt.Le, xt.remove());
          },
          wr: async (m) => {
            if (this.j) return;
            let g = dnd.P.Le ?? Jt.Le;
            if ((delete Jt.Le, xt.remove(), !g)) return;
            let x =
              this.ot &&
              this.q === "quickAccessCol-quickList" &&
              this.itemId === "quickList" &&
              g === "after";
            (g !== "within" && !x && !this.G?.Ke?.i.contains(this.o.i)) ||
              (g === "within" && this.Os(!0),
              await Fi({
                e: m,
                Hr: () => {
                  ...
                  if (!h) return;
                  let k = [...h.children],
                    $ = x ? k.length : k.findIndex((z) => z === this.o.i);
                  if ($ < 0) {
                    let z = T.S.filter((Z) => Z?.o?.i?.parentElement === h);
                  ...
                  T.S.forEach((z) => {
                    let Z = z?.o?.i;
                    Z && Z.parentElement === h && !L.has(Z) && L.set(Z, z);
                  });
                  let M = k.map((z) => L.get(z)).filter(Boolean),
                    H = M[$]?.index,
                    Q = T?.l?.id;
                  ($ === M.length && M.length && (H = M[$ - 1]?.index + 1),
                    H === void 0 &&
                      $ > M.length &&
                      M.length &&
                      (H = M.at(-1)?.index + 1));
                  let lt = dnd.F ? (dnd.ft?.types ?? []) : [],
                    U = dnd.F ? (dnd.ft?.Ae?.itemsMeta ?? []) : [];
                  if (
                    Number.isFinite(H) &&
                    dnd.F &&
                    Q !== "quickList" &&
                    ...
                    let z = new Set(U.map((Z) => Z.itemId));
                    if (z.size) {
                      let Z = k.reduce((Tt, q, et) => {
                        if (et >= $) return Tt;
                        let wt = L.get(q);
                ...
                qr: () => (g === "within" || x ? this.itemId : this.G.l.id),
                Ur: () =>
                  g === "within" || x ? this.l.groupType : this.G.l.groupType,
              }));
          },
        }),
      ),
  ...
  setActive(t, e) {
    ...
    this.Mn && !wo(r, this.Mn) && r.scrollIntoView();
  }
  async df(t, e) {
  ...
  async Ge(t, e) {
    ...
    if (
      t.type === "store" &&
      Ht(this.itemId, ["trash", "quickList", t.targetParentId])
    ) {
      await this.sync({ L: this.L });
    ...
    (this.ot &&
      ...
      this.ot &&
        Ht(t.type, ["store", "move", "copy", "removeFromQuickList"]) &&
  ...
  async sync({ L: t, h: e, Hi: s, ka: n }) {
    ...
    (vt(this.o.u.Ia?.i, (a) => (a.style.display = o.length ? "none" : "block")),
      this.af(),
      !this.j &&
        (await Cs({
          Hi: s,
  ...
  ya(t) {
    (t.preventDefault(),
      ...
      (this.Tn = new dt({
        ...
        la: f({
          style: { margin: "8px" },
          children: Ps({ view: this, Vc: this.G, Ni: () => this.Tn.destroy() }),
        }),
      })));
  }
  Rc() {
